(function() {
    ...
    $("html").niceScroll({styler:"fb",cursorcolor:"#F2B33F", cursorwidth: '12', cursorborderradius: '10px', background: '#424f63', spacebarenabled:false, cursorborder: '0',  zindex: '1000'});
