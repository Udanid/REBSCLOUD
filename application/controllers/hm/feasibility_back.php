...
class feasibility extends CI_Controller {
	...
	function calculate_monthcashflow($prj_id){
		...
		'thiskey'=>'sales');
		$mynames[1]=array('name'=>'O/R Sales',
		'thiskey'=>'outright');
		$mynames[2]=array('name'=>'E/P D/P',
		'thiskey'=>'epdp');
		$mynames[3]=array('name'=>'E/P sales',
		'thiskey'=>'epsales');
		$mynames[4]=array('name'=>'Sales Tax',
		'thiskey'=>'salestax');
		$mynames[5]=array('name'=>'Rental 12M',
		'thiskey'=>'12rental');
		$mynames[6]=array('name'=>'Rental 24M',
		'thiskey'=>'24rental');
		$mynames[7]=array('name'=>'Rental 36M',
		'thiskey'=>'36rental');
		$mynames[8]=array('name'=>'Rental 48M',
		'thiskey'=>'48rental');
		$mynames[9]=array('name'=>'Rental 60M',
		'thiskey'=>'60rental');
		$mynames[9]=array('name'=>'Rental 60M',
		'thiskey'=>'60rental');
		$mynames[10]=array('name'=>'Total',
		'thiskey'=>'rentaltot');
		
		//epcbalf,epccurrentdue,epccurrentcollecr,epcdrcollecr,epctot,epcbalc
		$mynames[11]=array('name'=>'Bal B/F',
		'thiskey'=>'epcbalf');
		$mynames[12]=array('name'=>'Current Due',
		'thiskey'=>'epccurrentdue');
		$mynames[13]=array('name'=>'Curr. Collection',
		'thiskey'=>'epccurrentcollecr');
		$mynames[14]=array('name'=>'DrCollection',
		'thiskey'=>'epcdrcollecr');
		$mynames[15]=array('name'=>'Total Collection',
		'thiskey'=>'epctot');
		$mynames[16]=array('name'=>'Bal C/F',
		'thiskey'=>'epcbalc');
		//epsbalf,epsinv,epsdeple,epsbalc
		$mynames[17]=array('name'=>'Bal B/F',
		'thiskey'=>'epsbalf');
		$mynames[18]=array('name'=>'E/P Investment',
		'thiskey'=>'epsinv');
		$mynames[19]=array('name'=>'E/P Stock Depletion',
		'thiskey'=>'epsdeple');
		$mynames[20]=array('name'=>'Bal C/F',
		'thiskey'=>'epsbalc');
//epinterest*****************************************

		$mynames[21]=array('name'=>'E/P Int 12M',
		'thiskey'=>'12interest');
		$mynames[22]=array('name'=>'E/P Int 24M',
		'thiskey'=>'24interest');
		$mynames[23]=array('name'=>'E/P Int 36M',
		'thiskey'=>'36interest');
		$mynames[24]=array('name'=>'E/P Int 48M',
		'thiskey'=>'48interest');
		$mynames[25]=array('name'=>'E/P Int 60M',
		'thiskey'=>'60interest');
		$mynames[26]=array('name'=>'Total',
		'thiskey'=>'interesttot');
		
		$mynames[27]=array('name'=>'Bal B/F',
		'thiskey'=>'fundbalf');
		$mynames[28]=array('name'=>'Receipts',
		'thiskey'=>'fundrecipt');
		$mynames[29]=array('name'=>'Repayments',
		'thiskey'=>'fundrepayment');
		$mynames[30]=array('name'=>'Bal C/F',
		'thiskey'=>'fundbalc');
		
		$mynames[31]=array('name'=>'L/B Loans',
		'thiskey'=>'inflowlbloans');
		$mynames[32]=array('name'=>'O/R Sales',
		'thiskey'=>'infloworsales');
		$mynames[33]=array('name'=>'E/P D/P',
		'thiskey'=>'inflowepdp');
		$mynames[34]=array('name'=>'Rentals',
		'thiskey'=>'inflowrental');
		$mynames[35]=array('name'=>'Other',
		'thiskey'=>'inflowother');
		$mynames[36]=array('name'=>'Total',
		'thiskey'=>'inflowtot');
		//outflowprjx,,,,,outflowtot,cashflowbalf,cashnetflow,cashbalc

		$mynames[37]=array('name'=>'Project Ex',
		'thiskey'=>'outflowprjx');
		$mynames[38]=array('name'=>'L/B Loan Settl',
		'thiskey'=>'outflowbloanset');
		$mynames[39]=array('name'=>'L/B Loan Int. - (LBLI)',
		'thiskey'=>'outflowlbloanint');
		$mynames[40]=array('name'=>'Sales Tax',
		'thiskey'=>'outflowsalestax');
		$mynames[41]=array('name'=>'Other',
		'thiskey'=>'outflowother');
		$mynames[42]=array('name'=>'Total',
		'thiskey'=>'outflowtot');
		//outflowprjx,,,,,outflowtot,,,
		$mynames[43]=array('name'=>'Bal B/F',
		'thiskey'=>'cashflowbalf');
		$mynames[44]=array('name'=>'Net  Inflow',
		'thiskey'=>'cashnetflow');
		$mynames[45]=array('name'=>'Bal C/F',
		'thiskey'=>'cashbalc');
		
		//,
		$mynames[46]=array('name'=>'L/B Interest - (LBLI)',
		'thiskey'=>'intexpLB');
		$mynames[47]=array('name'=>'Br Fund Interest - (BFI)',
		'thiskey'=>'intexpBR');	
		// //inalblbal,inabfbal,inarepay
		$mynames[48]=array('name'=>'L/B Loan Balance (LBL Bal)',
		'thiskey'=>'inalblbal');
		$mynames[49]=array('name'=>'Br.Fund Balance  (BF Bal)',
		'thiskey'=>'inabfbal');
		$mynames[50]=array('name'=>'BFBal.Net of LBL Repayt.   ',
		'thiskey'=>'inarepay');
		$mynames[51]=array('name'=>'E/P Stock Balance   ',
		'thiskey'=>'inastockbal');
		$mynames[52]=array('name'=>'E/P Stock Funded by LBL   ',
		'thiskey'=>'inasfundedLBL');
		$mynames[53]=array('name'=>'E/P Stock Funded by BR  ',
		'thiskey'=>'inasfundedBF');
		$mynames[54]=array('name'=>'RED Funded by LBL',
		'thiskey'=>'inasfundedRED');
		$mynames[55]=array('name'=>'LBLI on E/P',
		'thiskey'=>'lbliEP');
		$mynames[56]=array('name'=>'LBLI on RED',
		'thiskey'=>'lbliRED');
		$mynames[57]=array('name'=>'BFI on E/P',
		'thiskey'=>'lbliBFI');
		...
		//	Interest Expenses
			...
			$yeardataset[$count]['intexpLB'][$t.'M']= $month['intexpBR'][$i];
		//
