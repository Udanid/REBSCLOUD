            ...
            <div class="navbar-collapse"  >
				...
				<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1" >
					...
					<ul class="nav" id="side-menu" >
						<li>
							<a href="<?=base_url()?>hm/home" class="active"><i class="fa fa-home nav_icon"></i>Dashboard</a>
						</li>
						<li>
							...
							<ul class="nav nav-second-level collapse">
                                ...
                                <li>
                                 ...
                                 <li>
									<a href="<?=base_url()?>config/rates/hm_ledgers">Real Estate Ledgers</a>
								</li>
						...
						<li class="">
							...
							<ul class="nav nav-second-level collapse">
								<li>
									<a href="<?=base_url()?>hm/introducer/showall">Introducer Data</a>
								</li>
                                
								<li>
									<a href="<?=base_url()?>hm/land/showall">Land Details</a>
								</li>
                                <li>
									<a href="<?=base_url()?>hm/project/showall">Project Report Creation</a>
								</li>
                                <li style="display:none">
									<a href="<?=base_url()?>hm/feasibility/showall">Project Report Creation</a>
								</li>
                                 <li>
									<a href="<?=base_url()?>hm/feasibility/evaluation">Project Reports</a>
								</li>
                               
								<li>
									<a href="<?=base_url()?>hm/lotdata/showall">Price List</a>
								</li>
                                <li>
									<a href="<?=base_url()?>hm/lotdata/lot_inquiry">Block Inquiry</a>
								</li>
                                 <li>
									<a href="<?=base_url()?>hm/lotdata/edit_lot">Reserved Block Edit</a>
								</li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level collapse">
                             <li>
									<a href="<?=base_url()?>hm/sales/po">Project Officers</a>
								</li>
								 <li>
									<a href="<?=base_url()?>hm/salesmen/showall">Sales Officers</a>
								</li>
                                 <li>
									<a href="<?=base_url()?>hm/sales/showall">Sales Forcast</a>
								</li>
                                </ul>
                                </li>	
						...
						<li>
                          <li>
                            ...
                            <ul class="nav nav-second-level collapse">
								<li>
									<a href="<?=base_url()?>hm/customer/showall">Create Customer </a>
								</li>
                                <li>
									<a href="<?=base_url()?>hm/customerletter/showall">Customer Letters </a>
								</li>
                                 <li>
									<a href="<?=base_url()?>hm/deedtransfer/">Deed Transfer </a>
								</li>
                                </ul>
                                </li>	
						...
						<li>
                            ...
                            <ul class="nav nav-second-level collapse">
                                ...
                                <li>
									<a href="<?=base_url()?>hm/reservation/newreservation">New Reservation </a>
								</li>
                                 <li>
									<a href="<?=base_url()?>hm/reservation/showall">Payment Plan</a>
								</li>
                               
                                 <li>
									<a href="<?=base_url()?>hm/reservation/resale">Reservation Resale </a>
								</li>
                                 <li>
									<a href="<?=base_url()?>hm/reservation/sold">Outright Settlments </a>
								</li>
                                <li>
									<a href="<?=base_url()?>hm/reservation/eploans">Ep Loans </a>
								</li>
                          ...
                          <li class="">
							...
							<ul class="nav nav-second-level collapse">
								 <li>
									<a href="<?=base_url()?>hm/reservation/payments">Advance Payments</a>
								</li>
                                 <li>
									<a href="<?=base_url()?>hm/reservation/chargers">Other Charges</a>
								</li>
                                 <li>
									<a href="<?=base_url()?>hm/eploan/monthly_rental">Rental Payments </a>
								</li>
						...
						<li>
							<a href="<?=base_url()?>hm/eploan/showall" ><i class="fa fa-money nav_icon"></i>Credit<span class="fa arrow"></span></a>
                             <ul class="nav nav-second-level collapse">
								<li>
									<a href="<?=base_url()?>hm/eploan/showall">Loan Details</a>
								</li>
                                <li>
									<a href="<?=base_url()?>hm/eploan/loan_inquarymain">Loan Inquery</a>
								</li>
                                <li>
									<a href="<?=base_url()?>hm/eploan/follow_up">Follow Ups </a>
								</li>
                                 <li>
									<a href="<?=base_url()?>hm/eploan/reschedule">Reshedule </a>
								</li>
                                <li>
									<a href="<?=base_url()?>hm/eploan/rebate">Rebate (Early Settlements )</a>
								</li>
                                 <li>
									<a href="<?=base_url()?>hm/eploan/resale">Reprocess </a>
								</li>
                        ...
                        <li>
							<a href="<?=base_url()?>hm/documents/showall" class="chart-nav"><i class="fa fa-file nav_icon"></i>Documents </a>
						</li>
						<li>
							<a href="#" class="chart-nav"><i class="fa fa-bar-chart nav_icon"></i>Reports <span class="fa arrow"></span></a>
                              <ul class="nav nav-second-level collapse">
                              <li>
									<a href="<?=base_url()?>hm/report/profit">Profit Realization</a>
								</li>
                                 <li>
									<a href="<?=base_url()?>hm/report/stock">Stock Report</a>
								</li>
                                 <li>
									<a href="<?=base_url()?>hm/report/collection">Collection Report</a>
								</li>
                                 <li>
									<a href="<?=base_url()?>hm/report/provition">Cost  Report</a>
								</li>
                                 <li>
									<a href="<?=base_url()?>hm/report/sales">Sales  Report</a>
								</li>
                                </ul>
						</li>
					</ul>
