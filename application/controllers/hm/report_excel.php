...
class Report_excel extends CI_Controller {
	...
	function get_profit()
	{
		...
		$this->load->view('hm/report/excel/profit_summery',$data);	
	}
...
//	echo $yeararr[0]."ssss".$this->session->userdata('fy_end');
		...
		$this->load->view('hm/report/excel/profit_summery_all',$data);	
	}
...
//	echo $yeararr[0]."ssss".$this->session->userdata('fy_end');
		...
		$lastmonthstenddate=date('Y-m-d',strtotime('-1 months',strtotime($enddate)));
			...
			$lastmont[$prj_id]=$this->hm_report_model->lastmonth_reservation_count($prj_id,$lastmonthstdate,$lastmonthstenddate);
		...
		$this->load->view('hm/report/excel/stock_report_prj',$data);
	}
...
//	echo $yeararr[0]."ssss".$this->session->userdata('fy_end');
		...
		$this->load->view('hm/report/excel/stock_report',$data);	
	}
...
//	echo $yeararr[0]."ssss".$this->session->userdata('fy_end');
		...
		foreach($prjlist as $prjraw)
		{
			$pendinglot[$prjraw->prj_id]=$this->hm_report_model->pending_lotdata_count($prjraw->prj_id);
			$fulllot[$prjraw->prj_id]=$this->hm_report_model->full_lotdata_count($prjraw->prj_id);
			$lastmont[$prjraw->prj_id]=$this->hm_report_model->lastmonth_reservation_count($prjraw->prj_id,$stdate);
			
			$lotdata[$prjraw->prj_id]=$this->hm_report_model->pending_lotdata($prjraw->prj_id);
			$reslots[$prjraw->prj_id]=$this->hm_report_model->thismonth_reservation_lots($prjraw->prj_id,$stdate);
			$details[$prjraw->prj_id]=$this->hm_project_model->get_project_bycode($prjraw->prj_id)	;
		}
		}
		//print_r($lotlist);
...
public function collection()
	...
	function get_collection_all()
	{
		...
		//	echo $yeararr[0]."ssss".$this->session->userdata('fy_end');
			...
			$this->load->view('hm/report/excel/collection_dp_all',$data);	
			}
			//print_r($lotlist);
		...
		//	echo $yeararr[0]."ssss".$this->session->userdata('fy_end');
			...
			if($prjlist){
				...
				$data['settlepayment']=$settlepayment;
					...
					$this->load->view('hm/report/excel/collection_ep_all',$data);	
		...
		//	echo $yeararr[0]."ssss".$this->session->userdata('fy_end');
			...
			if($prjlist){
				foreach($prjlist as $prjraw)
				{
					...
					$this->load->view('hm/report/excel/collection_epb_all',$data);	
	...
	function get_collection()
	{
		...
		if($this->uri->segment(5)=='01' || $this->uri->segment(5)=='04')
		{
			...
			$colelction=0;
				while($start<=$end)
				{
					...
					$sales[$counter]=$this->hm_report_model->project_sales_month($prj_id,$stdate,$enddate);
					$dpcollect[$counter]=$this->hm_report_model->project_dpcollection_month($prj_id,$stdate,$enddate);
					$start=date('Y-m-d',strtotime('+1 months',strtotime($start)));
		...
		//	echo $yeararr[0]."ssss".$this->session->userdata('fy_end');
			...
			//$details=NULL;
					...
					$reservation[$prj_id]=$this->hm_report_model->reservation_lots_befor($prj_id,$enddate,$stdate);
					if($reservation[$prj_id])
					{
						...
						$zepreservation[$prj_id]=$this->hm_report_model->zepploans_befor($prj_id,$enddate);
			...
			$this->load->view('hm/report/excel/collection_dp_prj',$data);	
		}
		...
		//	echo $yeararr[0]."ssss".$this->session->userdata('fy_end');
			...
			$settlepayment=NULL;
					...
					$reservation[$prj_id]=$this->hm_report_model->eploans_befor($prj_id,$enddate);
					if($reservation[$prj_id])
					{
						foreach($reservation[$prj_id] as $resraw)
						{
				...
				$data['settlepayment']=$settlepayment;
					...
					$this->load->view('hm/report/excel/collection_ep_prj',$data);	
		...
		//	echo $yeararr[0]."ssss".$this->session->userdata('fy_end');
			...
			$details=NULL;
					...
					$reservation[$prj_id]=$this->hm_report_model->epbloans_befor($prj_id,$enddate);
					if($reservation[$prj_id])
					{
						foreach($reservation[$prj_id] as $resraw)
						{
					...
					$this->load->view('hm/report/excel/collection_epb_prj',$data);	
	...
	function get_budget()
	{
		...
		//	echo $yeararr[0]."ssss".$this->session->userdata('fy_end');
			...
			$this->load->view('hm/report/excel/provition_budget.php',$data);	
	...
	function get_unbudget()
	{
		...
		//	echo $yeararr[0]."ssss".$this->session->userdata('fy_end');
			...
			$this->load->view('hm/report/excel/provition_unbudget.php',$data);	
	...
	//	create_branchaccluntlist();
	 ...
	 function get_forcast_report()
	 {
		...
		$this->load->view('hm/report/excel/sales_forcast',$data);
	  ...
	  function get_posummery()
	 {
		...
		$this->load->view('hm/report/excel/sales_posummery',$data);
		...
		if($prjlist)
		{
			...
			{ $end=$todate;
				...
				while($start<=$end)
				{
					...
					$year=$yeararr[0];
					$month2=$yeararr[1];
					$prjtarget=$prjtarget+$this->hm_report_model->get_month_target($prjraw->prj_id,$month2,$year,$prjraw->officer_code);
					$start=date('Y-m-d',strtotime('+1 months',strtotime($start)));
	...
	{ 
		...
		$this->load->view('hm/report/excel/branchrpt_data',$data);
	}
			...
			foreach($prjlist as $prjraw)
			{
				...
				if($transferlist[$prjraw->prj_id]){
					...
					foreach($transferlist[$prjraw->prj_id] as $raw)
					{
							...
							$arrearspay[$raw->res_code]=$this->hm_report_model->get_eploan_arrears_tot($raw->loan_code,$stdate);
						$credtipay[$raw->res_code]=$this->hm_report_model->get_eploan_credit_tot($raw->loan_code,$stdate);
	...
	function get_finance()
	{
		...
		$dpcollect=NULL;
			...
			$this->load->view('hm/report/excel/provition_finance.php',$data);	
	...
	function get_provition_summery_budget()
	{
		...
		$dpcollect=NULL;
			...
			$this->load->view('hm/report/excel/provition_prov_summery_budget.php',$data);	
	...
	function get_provition_summery_expence()
	{
		...
		$dpcollect=NULL;
			...
			$this->load->view('hm/report/excel/provition_prov_summery_expence.php',$data);	
	...
	function get_provition_summery_balance()
	{
		...
		$dpcollect=NULL;
			...
			$this->load->view('hm/report/excel/provition_prov_summery_balance.php',$data);	
	...
	function get_provition()
	{
		...
		//	echo $yeararr[0]."ssss".$this->session->userdata('fy_end');
			...
			$this->load->view('hm/report/excel/provition_prov.php',$data);	
...
//	echo $yeararr[0]."ssss".$this->session->userdata('fy_end');
		...
		$this->load->view('hm/report/excel/profitshedule_summery',$data);	
	}
	...
	//	$data['prjlist']=$prjlist=$this->hm_report_model->get_all_project_summery($this->session->userdata('branchid'));
		...
		$details=NULL;	
			...
			$this->load->view('hm/report/excel/provition_finance_summery.php',$data);	
