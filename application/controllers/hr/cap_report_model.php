...
class Cap_report_model extends CI_Model {
    ...
    function get_turn_over_date_range($fromdate,$todate){
        $this->db->select('cm_customerms.full_name,re_prjaclotdata.lot_number,re_prjaclotdata.extend_perch,re_resevation.discounted_price,re_resevation.res_code,re_unrealized.full_cost,re_eploan.loan_code,re_eploan.loan_type');
