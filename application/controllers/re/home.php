...
class Home extends CI_Controller {
	...
	//	create_branchaccluntlist();
		...
		$currentproject=$maxid;
				$outflolist=$this->projectpayment_model->get_project_paymeny_task($currentproject);
				if($outflolist){
		...
		$data['ongingprojects']=$this->redashboard_model->ongoing_projects($this->session->userdata('branchid'));
		$data['outflow']=$this->redashboard_model->today_payments($this->session->userdata('shortcode'));
		$data['inflow']=$this->redashboard_model->today_income($this->session->userdata('branchid'));
