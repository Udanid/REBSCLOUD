...
class Additional_development extends CI_Controller {
	 ...
	 */
	 function __construct() {
		...
		$this->load->model("Additional_development");
...
public function showall_reservation()
	{
		...
		$data['datalist']=$data['searchdata']=$inventory=$this->Additional_development->get_all_housing_reservation_summery($this->session->userdata('branchid'));
				$courseSelectList="";
				 $count=0;
				...
				$this->load->view('re/additional_development/reservation_list',$data);
