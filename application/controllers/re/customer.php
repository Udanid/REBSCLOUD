...
class Customer extends CI_Controller {
	...
	public function showall()
	{
		...
		$data['searchdata']=$inventory=$this->customer_model->get_all_customer_summery();
				...
				$data['searchpath']='re/customer/edit';
				...
				$this->load->view('re/customer/customer_data',$data);
	...
	public function excel_cusdata()
	{
		...
		$data['searchdata']=$inventory=$this->customer_model->get_all_customer_summery();
				...
				$this->load->view('re/customer/customer_excel',$data);
	...
	public function search()
	{
		...
		$this->load->view('re/customer/search',$data);
