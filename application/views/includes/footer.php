   ...
   <script>
			...
			success: function(data) {
				if (data) {
					...
					$.each($(arr),function(key,value){
						//localStorage.removeItem(value[1]+value[3]);
						var NotifyShowed = localStorage.getItem(value[1]+value[3]);
						/*setTimeout(function(){
							localStorage.removeItem(value[1]+value[3]);
						},5000);*/
						if (Notification.permission !== "granted"){
							...
							localStorage.setItem(value[1]+value[3], true);
    ...
    <script src="<?=base_url()?>media/js/number-separator.js"></script>
    <script>
