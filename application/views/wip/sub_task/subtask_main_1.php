          ...
          <table class="table"> 
            <thead> 
              <tr> 
                ...
                <th>Task Name</th>
                <th>Duration</th> 
                <th>Progress</th><th>Status</th><th></th><th></th><th></th>
              </tr> 
            </thead> 
              ...
              <?foreach ($subtaskdetalist as $subtask) {
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <a  href="javascript:call_delete('')" title="Delete"><i class="fa fa-times nav_icon icon_red"></i></a>
