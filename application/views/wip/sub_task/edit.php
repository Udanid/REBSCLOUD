<script type="text/javascript">
  ...
  $("#addSubtaskforedit").click(function(){
    $("#tblSubtaskforedit").append('<div class="col-md-12" id="divrow'+rowCount+'">\
      ...
      <div class="col-md-1 form_padding">\
        <div class="form-group has-feedback">\
          <label for="chkHoldIdedit'+rowCount+'">Hold</label>\
    ...
    <div class="row">
      ...
      <? $checkuser=$this->session->userdata('userid');
        ...
        <div class="form-group" id="fromdatediv">
          ...
          <input type="text" name="task_start_date" id="task_start_date" placeholder="Task Start Date"  class="form-control" required onchange="settaskenddate(this)" value="<?=$details->task_sdate?>" <?if($flag==0){ ?> readonly <? } ?>>
        </div>
      </div>
      ...
      <div class="col-md-6 form_padding" id="showenddatediv">
        <div class="form-group">
          ...
          <input type="text" name="showenddate" id="showenddate" class="form-control" readonly placeholder="Task End Date" value="<?=$details->task_edate?>" <?if($flag==0){ ?> readonly <? } ?>>
        </div>
      </div>
        ...
        <? if($subtaskdetails){
          ...
          foreach ($subtaskdetails as $mainraw){
            ...
            <div class="col-md-3 form_padding">
             ...
             <div class="col-md-2 form_padding">
                <div class="form-group has-feedback">
                <select class="form-control" placeholder="Qick Search.." name="subtaskedit[<?= $count ?>][assign]" <?if($subflag==1){ ?> readonly <? } ?>>
                  <? foreach ($allemployees as $raw){?>
            ...
            <div class="col-md-1 form_padding">
              <div class="form-group has-feedback">
                <label for="chkHoldIdedit<?= $count ?>">Hold</label>
