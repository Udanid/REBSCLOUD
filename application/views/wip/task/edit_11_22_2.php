          ...
          foreach ($subtaskdetails as $mainraw){
            ...
            <div class="col-md-2 form_padding">
              <div class="form-group has-feedback">
               ...
               <? }else{ ?> 
                <input type="text" class="form-control editholddate<?= $count ?> resumedate" name="subtaskedit[<?= $count ?>][holdenddate]" placeholder="Resum Date" data-error="" id="editIddate<?= $count ?>" style="display: none;" <?if($subflag==1){ ?> readonly <? } ?>>
