...
function call_delete_task_attachment(id){
    ...
    $.ajax({
      cache: false,
      type: 'POST',
      url: '<?=base_url()?>wip/task/delete_task_attachment/'+id,
      dataType: 'JSON',
      success: function(data) {            
      }
    }); 
...
function call_delete_sub_task_attachment(id){

    $("#sub_divrow"+id).remove();

    $.ajax({
      cache: false,
      type: 'POST',
      url: '<?=base_url()?>wip/subtask/delete_sub_task_attachment/'+id,
      dataType: 'JSON',
      success: function(data) {            
      }
    }); 
          ...
          <div class="col-md-12 widget-shadow" data-example-id="basic-forms"> 
            <div class="form-body">
              ...
              <div class="col-md-4 form_padding" id="showenddatediv">
               ...
               <div class="col-md-4 form_padding">
                <div class="form-group" id="attachment-block">                        
                  <input type="file" name="files[]" id="gallery-photo-add" multiple class="btn btn-primary">Attachments
                  <div class="gallery"></div>
