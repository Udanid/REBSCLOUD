...
<? 
?>
<h4>Pettycash Direct Payments <span  style="float:right; color:#FFF" ><!--<a href="javascript:load_printscrean1('')"><i class="fa fa-print nav_icon"></i></a>-->&nbsp;&nbsp;<a href="javascript:closepo()"><i class="fa fa-times-circle "></i></a></span></h4>
...
<div  style=" width:90% ; margin-left:5%">
 ...
 <th width="15%"> Supplier Name</th><td width="2%">:</td><td><?=$settledata->sup_name?></td>
 </tr>
 <tr>
 <th width="15%">Paid Date</th><td width="2%">:</td><td> <?=$settledata->paid_date?></td>
  <th width="15%"> Amount</th><td width="2%">:</td><td><?=number_format($settledata->pay_amount,2)?></td>
 </tr>
