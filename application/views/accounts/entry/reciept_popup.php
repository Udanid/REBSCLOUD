...
<h4>View Receipt <span  style="float:right; color:#FFF" ><a href="javascript:closepo()"><i class="fa fa-times-circle "></i></a></span></h4>
...
{// print_r($row);
    ...
    <div id="receipt" style="text-align:left; padding-left:-30px; font-size:14px;">
            ...
            <p style="padding-top:30px;" style="text-align:center"><h2>Receipt Details</h2></p><span style="top:-15px; position:relative" ></span>
            <hr>
             </div>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" style="line-height:18px;">
        	<tr>
                ...
                <td> <?=$cusdata->title?>. <?=$row->rcvname?></td>
                <td></td>
                <td></td>
