<h4>View Journal - Entry No <?php echo full_entry_number($entry_type_id, $cur_entry->number); ?><span  style="float:right; color:#FFF" ><a href="javascript:closepo()"><i class="fa fa-times-circle "></i></a></span></h4>
            <h3 class="title1"></h3>
