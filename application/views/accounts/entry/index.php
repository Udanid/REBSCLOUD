...
<? if ($this->uri->segment(4)=='cancel') $heading ='Cancellations';
else $heading='Journal'?>
                    ...
                    <div class="  widget-shadow" data-example-id="basic-forms">
                        ...
                        <ul id="myTabs" class="nav nav-tabs" role="tablist">
                            <li role="presentation"   class="active" >
                                <a href="#main" role="tab" id="main-tab" data-toggle="tab" aria-controls="main" aria-expanded="true"><?=$heading?> Entries</a></li>
...
<!--                            <li role="presentation">-->
<!--                                <a href="#budget" id="budget-tab" role="tab" data-toggle="tab" aria-controls="budget" aria-expanded="false">Receipt Printer Queue</a></li>-->

                        </ul>

                        <div id="myTabContent" class="tab-content scrollbar1" style="padding:5px;">
                            <div role="tabpanel" class="tab-pane fade active in" id="main" aria-labelledby="main-tab">
                                <p><?  $this->load->view("accounts/entry/get_journal");?> </p>
                            </div>
                            <!--                            <div role="tabpanel" class="tab-pane fade " id="home" aria-labelledby="home-tab">-->
                            <!--                                <p>--><?//  $this->load->view("accounts/entrymaster/add");?><!-- </p>-->
                            <!--                            </div>-->
                            <div role="tabpanel" class="tab-pane fade " id="value" aria-labelledby="value-tab" >
                                c <?   //$this->load->view("re/feasibility/evereport_rental");?>
                            </div>

                            <div role="tabpanel" class="tab-pane fade" id="budget" aria-labelledby="budget-tab">
                                <p>	 <?  //$this->load->view("accounts/entrymaster/printqueue");?> </p>
                            </div>
