...
//                    maxDate: new Date('<?php //echo $fy_end; ?>//')
    ...
    <div id="page-wrapper">
        <div class="main-page">
            <div class="table">
                <h3 class="title1">Edit Journal Entry</h3>
                <?php $this->load->view("includes/flashmessage");?>
                <div class="widget-shadow">
                    <div class="  widget-shadow" data-example-id="basic-forms">
                        <form name="inputform" action="<?=base_url()?>accounts/entry/edit/<?=$current_entry_type['label']?>/<?=$entry_id;?>" method="post">
                            <div class="row">
                                    ...
                                    <div class="form-body">
                                        <div class="form-inline">
                                            ...
                                            <table class="entry-table">
                                                <tr>
                                                    <td>
                                                        <div class="form-group col-md-4" style="width: 30%;">Entry Number<br/>
                                                            <div class="col-sm-3 has-feedback">
                                                                <?=($current_entry_type['prefix'] . form_input($entry_number) . $current_entry_type['suffix'])?>
                                                            </div>
                                                        </div>
                                                        <div class="form-group col-md-4" style="width: 30%;">Entry Date<br/>
                                                            <div class="col-sm-3 has-feedback">
                                           ...
                                           ?>
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-3" style="width: 15%;"><a class="btn btn-refresh " href=<?echo base_url().'accounts/entry/edit/'.$current_entry_type['label'].'/'.$entry_id;?>><i
