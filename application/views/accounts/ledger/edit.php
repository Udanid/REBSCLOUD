...
<head>
    ...
    <div id="page-wrapper">
        <div class="main-page">
            <div class="table">
                <h3 class="title1">Edit Ledger</h3>
                <?php $this->load->view("includes/flashmessage");?>
                <div class="widget-shadow">
                    <div class="  widget-shadow" data-example-id="basic-forms">
                        <form data-toggle="validator" method="post" action="<?=base_url()?>accounts/ledger/edit/<?=$ledger_id?>"  enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-12 validation-grids widget-shadow" data-example-id="basic-forms" style="width: 100%; background-color: #ffffff;">
                                    <div class="form-body">
                      				 ...
                      				 <div class="form-group col-md-4" >Reference Code
                                            ...
                                            <div class="form-group col-md-6">
                                                <?php
                                                echo "<span id=\"tooltip-target-3\">";
                                                echo form_checkbox('active', 1, $active) . " Active";
                                                echo "</span>";
                                                echo "<br/>";
                                                echo "<span id=\"tooltip-content-3\">If deselect, cannot add any new transactions.</span>";
                                    ...
                                    <select name="bank1" id="bank1" class="form-control" placeholder="Bank" onChange="loadbranchlist(this.value,'2')">
                                    <option value="">Bank</option>
                                     <? foreach ($banklist as $raw){?>
                    <option value="<?=$raw->BANKCODE?>" <? if(get_account_bank_code($ledger_id)==$raw->BANKCODE){?> selected <? }?>><?=$raw->BANKNAME?></option>
                    <? }?>
