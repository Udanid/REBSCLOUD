...
$divname2='subtasklist1'.$tag.$counter;?>
                     ...
                     <div class="col-md-4"><input type="text"  name="dis_<?=$tag?><?=$counter?>" id="dis_<?=$tag?><?=$counter?>"  value="" class="form-control" placeholder="Description" />
                     </div> <div id="rawremove<?=$tag?><?=$counter?>"><a href="#" class="remove_field btn btn-danger">-</a></div>
