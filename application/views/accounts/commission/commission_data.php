...
//alert(runid);
				...
				//	alert("<?=base_url()?>accounts/commission/get_commision_staff/"+runid+"/"+projecid);
					$( "#popupform" ).load( "<?=base_url()?>accounts/commission/get_commision_staff/"+runid+"/"+projecid );
...
function expoet_excel(month,year)
{
				...
				window.open( "<?=base_url()?>accounts/commission/commission_details_excel/"+month+'/'+year);
}
function expoet_excel2(month,year)
{
		
		
				window.open( "<?=base_url()?>accounts/commission/commission_details_staff_excel/"+month+'/'+year);
}
</script>                
<br /><br />
