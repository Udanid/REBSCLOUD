...
<head>
    ...
    <div id="page-wrapper">
        <div class="main-page">
            <div class="table">
                <h3 class="title1">View Receipt - Entry No <?echo full_entry_number($entry_type_id, $cur_entry->number);?></h3>
                                ...
                                <div class="form-body">
                                    <div class="form-inline">
                                        ...
                                        <table class="entry-table">
                                            <tr>
                                                <td>
                                                <? $projectarr=get_project_name_and_lot_bymodule($cur_entry->module,$cur_entry->prj_id,$cur_entry->lot_id);?>
                                            ...
                                            <? }?>
                                             ...
                                             <td>
                                            <? if($lotdata){?>
                                                <div class="form-group col-md-12">Lot Number<br/>
                                                    <div class="col-sm-12 has-feedback">
                                                        <?php echo $projectarr[1]; ?>
                                                    </div>
                                                </div>
                                            <? }?>
                                            </td>
                                        ...
                                        <a class="btn btn-primary " style="width: 10%;" href=<?echo base_url().'accounts/entrymaster/show/'.$current_entry_type['label'];?>>Back</a>
                                    </div>
                                </div>
                            </div>
                        </div>
