...
<?php
echo form_open('payments/cancelation/' . $entry_id);
echo "<p>";
echo form_label('Cheque No', 'entry_number');
echo " ";
...
echo "<thead><tr><th>Type</th><th>Ledger Account</th><th>Dr Amount</th><th>Cr Amount</th></tr></thead>";
...
echo " | ";
echo anchor('entry/show/' . $current_entry_type['label'], 'Back', array('title' => 'Back to ' . $current_entry_type['name'] . ' ac_entries'));
echo "</p>";
