...
<?
$arr = Array();
$chqequedate=$chqequedata->date;

for($i=0;$i<strlen($chqequedate);$i++){
    $arr[$i]=substr($chqequedate,$i,1).'&nbsp;&nbsp;';
}
?>



<div id="receipt" style="width:900px; margin-top:-25px; "><table><tr><td style=" font-size:14px; padding-left:10px;" width="200"><?=$chqequedata->CHQNAME?><br /><br /><?=number_format($chqequedata->dr_total, 2, '.', ',')?><br /><br /><?=$chqequedata->date;?><br /><br />
                <?=$chqequedata->narration;?></td><td valign="top">
                <table width="640" cellpadding="0" cellspacing="0"  style="margin-top:0"><tr><td align="right" style="font-size:18px" colspan="4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<? echo  $arr[8].'&nbsp;'.$arr[9].'&nbsp;'.$arr[5].'&nbsp;'.$arr[6].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$arr[2].'&nbsp;&nbsp;'.$arr[3];
                    ...
                    <tr><td width="20">&nbsp;</td><td colspan="2" height="55">&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; <?=$chqequedata->CHQNAME?></td></tr><br />
                    <tr><td width="20">&nbsp;</td><td width="410" style="line-height:25px;">&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;  <?=$value?></td><td valign="middle" style="font-size:16px; padding-top:10px"> &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;<?=number_format($chqequedata->dr_total, 2, '.', ',')?></td></tr></table></td></tr></table>
</div>
</body>
</html>
