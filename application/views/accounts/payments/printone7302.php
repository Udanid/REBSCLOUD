...
<body onload="printfunction()" style="margin-left:230px;">
...
{// print_r($row);
    ...
    <? if(strtoupper(trim($chqequedata->ac_pay))=="YES"){?>
       <div style="width:100px; font-size:10px; position:absolute; margin-top:290px; margin-left:170px; transform: rotate(-90deg);
...
-----------------------------
     ...
     <div style="width:250px; font-size:13px; position:absolute; margin-top:70px; margin-left:95px; transform: rotate(-90deg);
  ...
  /* Internet Explorer */
  filter: progid:DXImageTransform.Microsoft.BasicImage(rotation=3);">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;HOME LANDS HOLDING (PVT) LTD<br><br><br>
...
<? }?>
     ...
     <div style="width:200px; font-size:13px; position:absolute; margin-top:660px; margin-left:-90px; transform: rotate(-90deg);
  ...
  filter: progid:DXImageTransform.Microsoft.BasicImage(rotation=3);">
    ...
    <div style="width:200px; font-size:12px; position:absolute; margin-top:675px; margin-left:-38px; transform: rotate(-90deg);
  ...
  filter: progid:DXImageTransform.Microsoft.BasicImage(rotation=3);">
	<span style="line-height:20px;"><?=wordwrap($chqequedata->CHQNAME,20,"<br>\n")?></span>
     ...
     <div style="width:170px; font-size:12px; position:absolute; margin-top:695px; margin-left:30px; transform: rotate(-90deg);
  ...
  filter: progid:DXImageTransform.Microsoft.BasicImage(rotation=3);">
	...
	<span style="line-height:20px;"><?=$voucher_ncode;?></span>
     ...
     <div style="width:200px; font-size:12px; position:absolute; margin-top:630px; margin-left:140px; transform: rotate(-90deg);
  ...
  filter: progid:DXImageTransform.Microsoft.BasicImage(rotation=3);">
    ...
    <div id="receipt" style="margin-top:238px; position:absolute; margin-left:-272px;
  ...
  filter: progid:DXImageTransform.Microsoft.BasicImage(rotation=3);">	
    ...
    <td valign="top"style="padding-left:10px; ">
                <table cellpadding="0" cellspacing="0"  style="margin-top:0; width:6in;"><tr><td align="right" style="font-size:18px; padding-right:7px;" colspan="4"><? echo '&nbsp;'. $arr[8].'&nbsp;'.$arr[9].'&nbsp;&nbsp;'.$arr[5].'&nbsp;&nbsp;'.$arr[6].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$arr[2].'&nbsp;&nbsp;'.$arr[3];
                    ...
                    <tr><td colspan="2"  height="40" ><div style="position:absolute; margin-top:-6px; margin-left:-15px;"><?=$chqequedata->CHQNAME?></div></td></tr><br />
                    <tr><td style="line-height:25px; width:3.5in" ><div style="position:absolute; margin-top:-10px; margin-left:-15px; max-width:350px;"><?=$value?></div></td><td valign="bottom" style="font-size:16px; padding-top:30px; padding-left:.6in;"><div style="position:absolute; margin-top:5px;"><?=number_format($chqequedata->dr_total, 2, '.', ',')?></div></td></tr></table></td></tr></table>
</div>
