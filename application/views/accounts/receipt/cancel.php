...
//alert(document.testform.deletekey.value);
    ...
    <div id="page-wrapper">
        <div class="main-page">
            <div class="table">
                <h3 class="title1">Receipt Bundles </h3>
                    ...
                    <div class="  widget-shadow" data-example-id="basic-forms">
                        <ul id="myTabs" class="nav nav-tabs" role="tablist">
                            ...
                            <li role="presentation" class="active"  >
                                <a href="#home" role="tab" id="home-tab" data-toggle="tab" aria-controls="home" aria-expanded="true">Cancel Blank Receipt</a></li>
                                  <li role="presentation"  >
                                <a href="#list" role="tab" id="list-tab" data-toggle="tab" aria-controls="list" aria-expanded="true">Cancel List</a></li>
                         </ul>
                        ...
                        <div id="myTabContent" class="tab-content scrollbar1" style="padding:5px;">
                            ...
                            <div role="tabpanel" class="tab-pane fade " id="list" aria-labelledby="list-tab">
                                <p><? $this->load->view("accounts/receipt/cancel_list");?> </p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <script>
                $("#complexConfirm").confirm({
                    ...
                    confirm: function(button) {
                        ...
                        var code=1
                        window.location="<?=base_url()?>accounts/receipt/delete/"+document.deletekeyform.deletekey.value;
                    },
