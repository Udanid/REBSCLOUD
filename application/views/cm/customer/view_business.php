                     ...
                     <form data-toggle="validator" name="editform" id="editform" method="post" action="" enctype="multipart/form-data">
                        <div class="row">
							...
							<div class="form-body editform">
                                    ...
                                    <strong class="redtext">Business Name :</strong> <?=$details->last_name?>
									<div class="form-group has-feedback">
                                    	<strong class="redtext">Type of Business :</strong> <?=$details->occupation?>
									</div>
                                    <div class="form-group has-feedback">
                                    	<strong class="redtext">Business Name in Sinhala Unicode :</strong> <?=$details->unicode_name?>
									</div>
                                    <div class="form-group">
                                    	<strong class="redtext">Tax Identification Number (TIN) :</strong> <?=$details->tin?>
                                    </div>
                                    <div class="form-group">
                                    	<strong class="redtext">VAT Registration Number :</strong> <?=$details->vat?>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-inline">
                                        <div class="form-group has-feedback">
                                            <strong class="redtext">Business Registration Number :</strong> <?=$details->id_number?>
                                        </div>
                                        <div class="form-group has-feedback">
									...
									<div class="form-group">
                                    	<strong class="redtext">BR Front</strong>
                                        <br /><br />
                                        <span id="oldfiles">
                                       ...
                                       <br /><br />
                                        <span id="documentback">
                                            <strong class="redtext">BR Back</strong>
                                            <br /><br />
                                            <span id="oldfiles2">
