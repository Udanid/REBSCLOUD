  ...
  <div class="main-page">
    ...
    <div class="modal-content">
	  <div class="modal-body">
        ...
        <div class="table">
          <h3 class="title1">Incentive</h3>
          <div class="widget-shadow">
            <ul id="myTabs" class="nav nav-tabs" role="tablist">
              <li role="presentation" class="active">
                <a href="#home" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="false">Incentive</a>
              </li>
...
<!--							      <a  href="javascript:call_delete('<?php echo $row->id;?>')" title="Delete"><i class="fa fa-times nav_icon icon_red"></i></a>-->
              ...
              <div role="tabpanel" class="tab-pane fade " id="profile" aria-labelledby="profile-tab">
                <p>
                  <div class="row">
                    <form data-toggle="validator" method="post" action="<?php echo base_url();?>hr/insentive/add_incentive">
					    ...
					    <div class="" data-example-id="basic-forms">
					      <div class="form-body">
						    <div class="form-group has-feedback">
						      <input type="text" class="form-control" name="incentive" id="incentive" placeholder="Incentive" required>
							  <span class="help-block with-errors" >Incentive</span>
						    </div>
...
<script>
	...
	function call_edit(id){
		...
		$('#popupform').load("<?php echo base_url();?>hr/insentive/edit_incentive/"+id );
	}
