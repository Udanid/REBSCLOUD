...
<script>
	$(document).ready(function(){
		$("form#inputform").submit(function(e){
			...
			if(transaction_type == 'transfer_transaction'){
				var submit_url = siteUrl + 'hr/employee/employee_transfer_update';
			}else if(transaction_type == 'promotion_transaction'){
				var submit_url = siteUrl + 'hr/employee/employee_promotion_update';
			}else if(transaction_type == 'leave_category_transaction'){
				var submit_url = siteUrl + 'hr/employee/employee_leave_category_update';
			}else if(transaction_type == 'employment_type_transaction'){
				var submit_url = siteUrl + 'hr/employee/employee_employment_type_update';
			}else if(transaction_type == 'resignation_transaction'){
				var submit_url = siteUrl + 'hr/employee/employee_resignation_update';
			}
			$.ajax({      
				url: submit_url,
				type: "POST",
							...
							<div class="" data-example-id="basic-forms">
							  <div class="form-body">
								<div class="form-group">
								  ...
								  <input type="text" class="form-control" id="resignation_trans_date" name="resignation_trans_date" value="" placeholder="DD/MM/YYYY" readonly />
								  <span class="add-on"><i class="icon-calendar"></i></span>
								</div>
							  </div>
							</div>
