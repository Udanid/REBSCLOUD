			  ...
			  <input type="hidden" name="employeeMasterID" id="employeeMasterID" value="<?php echo $employee_details['id']; ?>" />
				...
				<div class="panel-body">
				  ...
				  <div class="form-group">
					...
					<div class="col-xs-5">
					  <input type="text" class="form-control" id="system_dis_name" name="system_dis_name" value="<?php echo $employee_details['display_name']; ?>" placeholder="System Display Name">
					</div>
				  </div>
				  ...
				  <div class="form-group">
					...
					<div class="col-xs-2">
					  <input type="file" id="profile_pic" accept=".jpg,.jpeg,.png" name="profile_pic">
					  <p class="help-block">JPG & PNG formats are allowed. Maximum file size allowed is 1MB.</p>
					</div>
					<?php
