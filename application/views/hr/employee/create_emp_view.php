			...
			<form enctype="multipart/form-data" class="userRegForm form-horizontal" id="inputform" name="inputform" action="<?=base_url()?>hr/employee/submission" method="post">
			  <div class="panel panel-default">
				...
				<div class="panel-body">
					<span class="red-800">**Marked Feilds are required</span>
				   ...
				   <div class="form-group">
					...
					<div class="col-xs-5">
					  <input type="text" class="form-control" id="emp_no" name="emp_no" value="" placeholder="Employee No">
					</div>
				  </div>
				  <div class="form-group">
					<label for="title" class="control-label col-xs-2">Title<span class="red-800">**</span></label>
					<div class="col-xs-5">
				  ...
				  <div class="form-group">
					<label for="initials" class="control-label col-xs-2">Initials<span class="red-800">**</span></label>
					<div class="col-xs-5">
				  ...
				  <div class="form-group">
					<label for="surname" class="control-label col-xs-2">Surname<span class="red-800">**</span></label>
					<div class="col-xs-5">
				  ...
				  <div class="form-group">
					<label for="inifull" class="control-label col-xs-2">Initials in Full<span class="red-800">**</span></label>
					<div class="col-xs-5">
				  ...
				  <div class="form-group">
					...
					<div class="col-xs-5">
					  <input type="text" class="form-control" id="system_dis_name" name="system_dis_name" value="" placeholder="System Display Name">
					</div>
				  </div>
				 ...
				 <!-- end ticket 2839 -->
				  ...
				  <div class="form-group">
					<label for="nic" class="control-label col-xs-2">NIC No.<span class="red-800">**</span></label>
					<div class="col-xs-5">
				  ...
				  <div class="form-group">
					<label for="dobDatepicker" class="control-label col-xs-2">Date of Birth<span class="red-800">**</span></label>
					<div class="col-xs-5">
			  ...
			  <div class="panel panel-default">
				...
				<div class="panel-body">
				  ...
				  <div class="form-group">
					...
					<div class="col-xs-5">
					  <select class="form-control" id="employment_type" name="employment_type" onchange="get_contarct()">
						<?php
					...
					<div id="contract_data">
						<div class="col-xs-5">
					<input type="text" class="form-control" id="contrac_start_date" name="contrac_start_date" value="" placeholder="Start Date" readonly />
					</div>
					<div class="col-xs-5">
					<input type="text" class="form-control" id="contrac_end_date" name="contrac_end_date" value="" placeholder="End Date" readonly />
				</div>
				</div>
					</div>
					<div class="form-group">
				  ...
				  <div class="form-group">
					<label for="emp_joining_date" class="control-label col-xs-2">Joining Date<span class="red-800">**</span></label>
					<div class="col-xs-5">
				  ...
				  <div class="form-group">
					<label for="immediate_manager_1" class="control-label col-xs-2">Immediate Manager 1<span class="red-800">**</span></label>
					<div class="col-xs-5">
					...
					<input type="hidden" value="<?=count($employee_list)?>" name="mangercount" id="mangercount">
					<!-- this is get for count previous employee list. If count more than 1 this immediate manager is required -->
				  </div>
				  ...
				  <div class="form-group">
					<label for="user_privilege" class="control-label col-xs-2">User Privilege Level<span class="red-800">**</span></label>
					<div class="col-xs-5">
				  ...
				  <div class="form-group">
					<label for="app_permission" class="control-label col-xs-2">Android App Permission<span class="red-800">**</span></label>
					<div class="col-xs-5">
					...
					<div class="form-group">
						...
						<div class="col-xs-5">
						  <input type="number" step="0.01" class="form-control" id="emp_phone_charges" name="emp_phone_charges" value="0.00" placeholder="0.00">
						</div>
					  </div>
  	...
  	$.validator.setDefaults({ ignore: ":hidden:not(.chosen-select)" });
        ...
        messages: {
            title: "Required",
						...
						system_dis_name:"Required",
						app_permission:"Required",

        }
});
var mangerlist=$('#mangercount').val();
if(mangerlist>0){
	//alert(mangerlist)
	console.log(mangerlist);

	$('#immediate_manager_1').each(function() {
		//     $(this).rules( "add", "Required"); // value is not 0
		$(this).rules('add', {
