			...
			<div class="widget-shadow">
			  ...
			  <div id="myTabContent" class="tab-content scrollbar1" style="padding:5px;">
				...
				<div role="tabpanel" class="tab-pane fade " id="profile" aria-labelledby="profile-tab"> 
				  <div class="row">
					<form enctype="multipart/form-data" data-toggle="validator" method="post" id="inputform1"  action="<?=base_url()?>hr/employee/submit_attendance_sheet"name="inputform">
...
<script>
	$(document).ready(function(){
		$("form#inputform").submit(function(e){
			...
			$.ajax({      
				url: siteUrl + 'hr/employee/submit_attendance_sheet',
			type: "POST",
				cache: false,
				contentType: false,
				processData: false,
				...
				success: function(data) {
	                ...
	                if($.isEmptyObject(data.error)){
	                	window.location.replace(siteUrl+'hr/employee/upload_attendance');
	                }else{
