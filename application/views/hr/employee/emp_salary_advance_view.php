...
<script>
	$(document).ready(function(){
		$("form#inputform").submit(function(e){
			...
			$.ajax({      
				url: siteUrl + 'hr/employee/submit_salary_advance_list',
				type: "POST",
				async: false,
				dataType: 'json',
				data: dats,
...
<script>
	...
	function call_edit(id){
		...
		$('#popupform').load("<?php echo base_url();?>hr/employee/emp_salary_advance_list/"+id );
	}
	...
	function call_confirm(id){
		var siteUrl = '<?php echo base_url(); ?>';
		$.ajax({      
			url: siteUrl + 'hr/employee/employee_salary_advance_confirm',
			type: "POST",
			async: false,
			dataType: 'json',
			data: {record_id:id},
