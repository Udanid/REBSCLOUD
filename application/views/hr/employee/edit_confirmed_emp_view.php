<script>
	$(document).ready(function() {
		...
		$("#fuel_allowance_status").change(function(){
  		...
  		$(document).on('click','#close-btn', function(){
			...
			$("#contrac_start_date").datepicker({
      		dateFormat: 'yy-mm-dd',
      		changeMonth: true,
      		changeYear: true,
      		yearRange: '-50' + ':' + '+1'
  		});
			$("#contrac_end_date").datepicker({
					dateFormat: 'yy-mm-dd',
					changeMonth: true,
					changeYear: true,
					yearRange: '-50' + ':' + '+1'
	...
	function get_contarct()
	{
		var getname=$('#employment_type').find(":selected").text();
		if(getname=="Contract")
		{
			$('#contract_data').show();
		}else{
			...
			<form enctype="multipart/form-data" class="userRegForm form-horizontal" id="inputform" name="inputform" method="post" action="<?=base_url()?>hr/employee/update_submit">
			  <input type="hidden" name="employeeMasterID" id="employeeMasterID" value="<?php echo $employee_details['id']; ?>" />
				<div class="form-group">
					<div class="col-xs-1" style="float: right;">
						<a href="<?php echo base_url();?>hr/employee/add_emp_other_data/<?php echo $employee_details['id'];?>"><button type="button" class="btn btn-danger btn-lg " data-loading-text="<i class='fa fa-spinner fa-spin'></i> Processing Request" style="float: right;">Skip</button></a>
					</div>

			    <div class="col-xs-10" style="float: right;">
		          <?php
			      if($get_user_data['active_flag'] == 1){ ?>
				    <button type="button" onclick="call_flag_function('<?php echo $employee_details['id'];?>', 'flag')" class="btn btn-danger btn-lg " style="float: right;">Flag User</button>
				    <?php
				  }else if($get_user_data['active_flag'] == 0){ ?>
				    <button type="button" onclick="call_flag_function('<?php echo $employee_details['id'];?>', 'unflag')" class="btn btn-success btn-lg" style="float: right;">Unflag User</button>
				  <?php
				  } ?>
			  ...
			  <div class="panel panel-default">
				...
				<div class="panel-body">
				   ...
				   <div class="form-group">
					<label for="inifull" class="control-label col-xs-2">Employee No<span class="red-800">**</span></label>
					<div class="col-xs-5">
					  <input type="text" class="form-control" id="emp_no" name="emp_no" value="<?php echo $employee_details['emp_no']; ?>" placeholder="Employee No">
					</div>
				  </div>
				  ...
				  <div class="form-group">
					...
					<div class="col-xs-5">
					  <input type="text" class="form-control" id="surname" name="surname" value="<?php echo $employee_details['surname']; ?>" placeholder="Surname" readonly>
					</div>
				  </div>
				  ...
				  <div class="form-group">
					...
					<div class="col-xs-5">
					  <input type="text" class="form-control" id="inifull" name="inifull" value="<?php echo $employee_details['initials_full']; ?>" placeholder="Intials in Full" readonly>
					</div>
				  </div>

				  <div class="form-group">
					<label for="inifull" class="control-label col-xs-2">System Display Name<span class="red-800">**</span></label>
					<div class="col-xs-5">
				  ...
				  <div class="form-group">
					...
					<div class="col-xs-5">
						...
						<option value="Male" <? if($employee_details['gender']=="Male"){echo "selected";}?>>Male</option>
						<option value="Female" <? if($employee_details['gender']=="Female"){echo "selected";}?>>Female</option>
						</select>
				  ...
				  <div class="form-group">
					...
					<div class="col-xs-5">
					  <input type="text" class="form-control" id="nic" name="nic" value="<?php echo $employee_details['nic_no']; ?>" placeholder="NIC #" readonly>
					</div>
				  </div>
			  ...
			  <div class="panel panel-default">
				...
				<div class="panel-body">
				  ...
				  <div class="form-group">
					...
					<div class="col-xs-5">
					  <select class="form-control" id="employment_type" name="employment_type" readonly onchange="get_contarct()">
						<?php
						$selected_name="";
				  ...
				  <div class="form-group">
					...
					<div class="col-xs-5">
					  <input type="number" class="form-control" id="duration" name="duration" value="<?php echo $employee_details['duration']; ?>" placeholder="Duration (Months)" readonly>
					</div>
				  </div>
				  ...
				  <div class="form-group">
					...
					<div class="col-xs-5">
					  <input type="text" class="form-control" id="epf_no" name="epf_no" value="<?php echo $employee_details['epf_no']; ?>" placeholder="EPF #" readonly>
					</div>
				  </div>
				  ...
				  <div class="form-group">
					...
					<div class="col-xs-5">
					  <select class="form-control" id="designation" name="designation" readonly>
						<?php
				  ...
				  <div class="form-group">
					...
					<div class="col-xs-5">
					  <select class="form-control" id="leave_category" name="leave_category" readonly>
						<?php
				  ...
				  <div class="form-group">
				   ...
				   <div class="form-group">
					...
					<div class="col-xs-5">
					  <select class="form-control" id="app_permission" name="app_permission">
					...
					<div class="form-group">
						...
						<div class="col-xs-5">
						  <input type="number" step="0.01" class="form-control" id="emp_phone_charges" name="emp_phone_charges" value="<?php echo $employee_details['phone_bill']; ?>" placeholder="0.00">
						</div>
					  </div>
...
<script>
	function call_flag_function(id, flag_status){
		var siteUrl = '<?php echo base_url(); ?>';

		$.ajax({
			url: siteUrl + 'hr/employee/employee_flag_unflag',
			type: "POST",
			cache: false,
			data: {user_id:id, flag_status:flag_status},
...
<script>
	...
	// 		$.ajax({
	// 			url: siteUrl + 'hr/employee/confirmed_employee_update',
	// 			type: "POST",
	// 			cache: false,
	// 			contentType: false,
	// 			processData: false,
