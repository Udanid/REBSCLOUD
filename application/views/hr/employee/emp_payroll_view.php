...
<script>
	$(document).ready(function(){
		$("form#inputform").submit(function(e){
			...
			$.ajax({
				url: siteUrl + 'hr/employee/run_monthly_payroll',
				type: "POST",
				async: false,
				dataType: 'json',
				data: dats,
...
<script>
	...
	function call_edit(id){
		...
		$('#popupform').load("<?php echo base_url();?>hr/employee/emp_payroll_list/"+id );
	}
	...
	function call_confirm(id){
		var siteUrl = '<?php echo base_url(); ?>';
		$.ajax({
			url: siteUrl + 'hr/employee/employee_payroll_list_confirm',
			type: "POST",
			async: false,
			dataType: 'json',
			data: {record_id:id},
  ...
  function call_print(id){
	...
	$("#complexConfirm").confirm({
        ...
        confirm: function(button) {
            ...
            window.location="<?php echo base_url();?>hr/employee/decline_monthly_payroll/"+document.deletekeyform.deletekey.value;
        },
