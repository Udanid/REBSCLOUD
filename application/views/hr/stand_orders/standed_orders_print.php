...
<script>
	$(document).ready(function(){
		$("form#inputform").submit(function(e){
			...
			if(id!='' && emp!=''){
				var win = window.open("<?=base_url()?>hr/Salary_standed_order/print_stand_orders/"+id, '_blank');
		    win.focus();
			}
	...
	<div class="modal-content">
	  <div class="modal-body">
		...
		<div id="messageBoard">
		  ...
		  <div class="table">
			<h3 class="title1">Print Standed Orders</h3>
			<div class="widget-shadow">
			  <ul id="myTabs" class="nav nav-tabs" role="tablist">
					<li role="presentation" class="active">
				  <a href="#profile" role="tab" id="profile-tab" data-toggle="tab" aria-controls="profile" aria-expanded="true">Print Staned Orders</a>
				</li>
			  </ul>
							...
							<div class="" data-example-id="basic-forms">
							  <div class="form-body">
								<div class="form-group">
								  <button type="submit" class="btn btn-primary btn-lg " id="load" data-loading-text="<i class='fa fa-spinner fa-spin'></i> Processing Request">Print</button>
								</div>
							  </div>
							</div>
						  </div>
