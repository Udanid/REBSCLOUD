	...
	<div class="modal-content">
	  <div class="modal-body">
		...
		<div id="messageBoard">
		  ...
		  <div class="table">
			<h3 class="title1">Offdays Report</h3>
			<div class="widget-shadow">
			  <ul id="myTabs" class="nav nav-tabs" role="tablist">
				<li role="presentation" class="active">
				  <a href="#home" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="false">Offdays Report</a>
				</li>
			  </ul>
...
<script>
	$(document).ready(function(){
		$("form#inputform").submit(function(e){
			...
			$.ajax({
				url: siteUrl + 'hr/HrReport/view_offday_report',
				type: "POST",
				async: false,
				dataType: 'json',
				data: dats,
