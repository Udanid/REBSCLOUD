...
<script>
	$(document).ready(function(){
		$("form#inputform").submit(function(e){
			...
			$.ajax({
				url: siteUrl + 'hr/emp_attendance/submit_attendance_manual',
			type: "POST",
				cache: false,
				contentType: false,
				processData: false,
				...
				success: function(data) {
	                ...
	                if($.isEmptyObject(data.error)){
	                	window.location.replace(siteUrl+'hr/emp_attendance/attendance_update');
	                }else{
	...
	$("#complexConfirm").confirm({
		...
		confirm: function(button) {
			...
			window.location="<?=base_url()?>hr/emp_attendance/attendence_confirm/"+document.deletekeyform.deletekey.value;
		},
	...
	$("#complexConfirm_confirm").confirm({
		...
		confirm: function(button) {
			...
			window.location="<?=base_url()?>hr/emp_attendance/attendence_cancel/"+document.deletekeyform.deletekey.value;
		},
		cancel: function(button) {
			button.fadeOut(2000).fadeIn(2000);
			// alert("You aborted the operation.");
