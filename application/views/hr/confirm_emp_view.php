			  ...
			  <div class="panel panel-default">
				...
				<div class="panel-body">
				  ...
				  <div class="form-group">
					...
					<div class="col-xs-5">
					  <select class="form-control" id="employment_working_days" name="employment_working_days" disabled>
			  ...
			  <div class="panel panel-default">
				...
				<div class="panel-body">
				  ...
				  <div class="form-group">
					...
					<div class="col-xs-5">
					  <input type="text" class="form-control" id="name_emg_person" name="name_emg_person" value="<?php echo $emergnecy_contact_details['person_name']; ?>" placeholder="Contact Person Name" disabled>
					</div>
				  </div>
				  ...
				  <div class="form-group">
					...
					<div class="col-xs-5">
					  <input type="text" class="form-control" id="relationship_emg" name="relationship_emg" value="<?php echo $emergnecy_contact_details['relationship']; ?>" placeholder="Relationship Ex:wife" disabled>
					</div>
				  </div>
				  ...
				  <div class="form-group">
					...
					<div class="col-xs-5">
					  <input type="text" class="form-control" id="contact_mob_emg" name="contact_mob_emg" value="<?php echo $emergnecy_contact_details['tel_mobile']; ?>" placeholder="Mobile #" disabled>
					</div>

					<div class="col-xs-5">
					  <input type="text" class="form-control" id="contact_tel_emg" name="contact_tel_emg" value="<?php echo $emergnecy_contact_details['tel_home']; ?>" placeholder="Telephone #" disabled>
					</div>
				  </div>
				  ...
				  <div class="form-group">
					...
					<div class="col-xs-5">
					  <input type="text" class="form-control" id="addr1_emg" name="addr1_emg" value="<?php echo $emergnecy_contact_details['add_1']; ?>" placeholder="Address line 1" disabled>
					</div>
					<div class="col-xs-5">
					  <input type="text" class="form-control" id="addr2_emg" name="addr2_emg" value="<?php echo $emergnecy_contact_details['addr_2']; ?>" placeholder="Address line 2 (optional)" disabled>
					</div>
				  </div>
				  ...
				  <div class="form-group">
					...
					<div class="col-xs-5">
					  <input type="text" class="form-control" id="town_emg" name="town_emg" value="<?php echo $emergnecy_contact_details['town']; ?>" placeholder="Town" disabled>
					</div>
				  </div>
			  ...
			  <div class="panel panel-default">
				...
				<div class="panel-body">
				  <div class="form-group">
					...
					<div class="col-xs-5">
					  <input type="text" class="form-control" id="bank_given_name" name="bank_given_name" value="<?php echo $bank_details['name_in_account']; ?>" placeholder="Name with initials" disabled>
					</div>
				  </div>
				  ...
				  <div class="form-group">
					...
					<div class="col-xs-5">
					  <select class="form-control" id="bank_code" name="bank_code" onChange="loadbranchlist(this.value); document.getElementById('bank_name').value=this.options[this.selectedIndex].text;" disabled>
				  ...
				  <div class="form-group">
					...
					<div class="col-xs-5">
					  <input type="text" class="form-control" id="account_no" name="account_no" value="<?php echo $bank_details['account_no']; ?>" placeholder="Account #" disabled>
					</div>
				  </div>
				  ...
				  <div class="form-group">
					...
					<div class="col-xs-5">
					  <input type="text" class="form-control" id="account_type" name="account_type" value="<?php echo $bank_details['account_type']; ?>" placeholder="Account type" disabled>
					</div>
				  </div>
			  ...
			  <div class="panel panel-default">
				...
				<div class="panel-body">
				  <div class="form-group">
					...
					<div class="col-xs-5">
					  <input type="text" class="form-control" id="insCompany" name="insCompany" value="<?php echo $insurance_details['company_name']; ?>" placeholder="Name of insurance company" disabled>
					</div>
				  </div>
				  ...
				  <div class="form-group">
					...
					<div class="col-xs-5">
					  <input type="text" class="form-control" id="insScheme" name="insScheme" value="<?php echo $insurance_details['shcheme_name']; ?>" placeholder="Insurance scheme" disabled>
					</div>
				  </div>
				  ...
				  <div class="form-group">
					...
					<div class="col-xs-5">
					  <input type="text" class="form-control" id="policynumber" name="policynumber" value="<?php echo $insurance_details['policy_no']; ?>" placeholder="Insurance policy" disabled>
					</div>
				  </div>
				</div>
			  </div>
				...
				<div class="panel-body">
				  ...
				  <div class="form-group ol_input_fields_wrap">
					<div class="emp_rows col-xs-12">
					  <div class="col-xs-4">
						<input type="text" class="form-control" name="olschoolname" value="<?php echo $ol_details['school']; ?>" placeholder="School name" disabled>
					  </div>
					</div>
					...
					if(sizeof($ol_results) > 0){
						foreach($ol_results as $ol_result_row){ ?>
							<div class="emp_rows col-xs-12">
							  <div class="col-xs-4">
								<input type="text" class="form-control" name="ordinary_level[<?php echo $ol_counter; ?>][subject]" value="<?php echo $ol_result_row['subject']; ?>" placeholder="O/L Subject" disabled>
							  </div>
							  <div class="col-xs-4">
								<input type="text" class="form-control" name="ordinary_level[<?php echo $ol_counter; ?>][grade]" value="<?php echo $ol_result_row['grade']; ?>" placeholder="Grade" disabled>
							  </div>
							</div>
							<?php
							$ol_counter++;
						...
						<div class="emp_rows col-xs-12">
						  <div class="col-xs-4">
							<input type="text" class="form-control" name="ordinary_level[0][subject]" value="" placeholder="O/L Subject" disabled>
						  </div>
						  <div class="col-xs-4">
							<input type="text" class="form-control" name="ordinary_level[0][grade]" value="" placeholder="Grade" disabled>
						  </div>
						</div>
					<?php
					} ?>
				  ...
				  <div class="form-group al_input_fields_wrap">
					<div class="emp_rows col-xs-12">
					  <div class="col-xs-4">
						<input type="text" class="form-control" value="<?php echo $al_details['school']; ?>" placeholder="School name" name="alschoolname" disabled>
					  </div>
					</div>
					...
					if(sizeof($al_results) > 0){
						foreach($al_results as $al_result_row){ ?>
							<div class="emp_rows col-xs-12">
							  <div class="col-xs-4">
								<input type="text" class="form-control" name="advance_level[<?php echo $al_counter; ?>][subject]" value="<?php echo $al_result_row['subject']; ?>" placeholder="A/L Subject" disabled>
							  </div>
							  <div class="col-xs-4">
								<input type="text" class="form-control" name="advance_level[<?php echo $al_counter; ?>][grade]" value="<?php echo $al_result_row['grade']; ?>" placeholder="Grade" disabled>
							  </div>
							</div>
							<?php
							$al_counter++;
						...
						<div class="emp_rows col-xs-12">
						  <div class="col-xs-4">
							<input type="text" class="form-control" name="advance_level[0][subject]" value="" placeholder="A/L Subject" disabled>
						  </div>
						  <div class="col-xs-4">
							<input type="text" class="form-control" name="advance_level[0][grade]" value="" placeholder="Grade" disabled>
						  </div>
						</div>
					<?php
					} ?>
					...
					if(sizeof($higher_education_details) > 0){
						foreach($higher_education_details as $higher_education_details_row){ ?>
							<div class="emp_rows col-xs-12">
							  <div class="emp_rows col-xs-12">
								<div class="col-xs-8">
								  <input type="text" class="form-control" name="higher_education[<?php echo $hq_counter; ?>][name]" value="<?php echo $higher_education_details_row['name']; ?>" placeholder="Qualification / certification name" disabled/>
								</div>
							  </div>
							  <div class="emp_rows col-xs-12">
								<div class="col-xs-4">
								  <input type="text" class="form-control" name="higher_education[<?php echo $hq_counter; ?>][institute]" value="<?php echo $higher_education_details_row['institute']; ?>" placeholder="Institute name" disabled/>
								</div>
								<div class="col-xs-4">
								  <input type="text" class="form-control" name="higher_education[<?php echo $hq_counter; ?>][grade]" value="<?php echo $higher_education_details_row['grade']; ?>" placeholder="Grade/Result" disabled/>
								</div>
							  </div>
							  <div class="emp_rows col-xs-12">
								<div class="col-xs-4">
								  <input type="text" readonly class="form-control qualificationDatepicker" name="higher_education[<?php echo $hq_counter; ?>][from]" value="<?php echo $higher_education_details_row['from']; ?>" placeholder="From" disabled/>
								</div>
								<div class="col-xs-4">
								  <input type="text" readonly class="form-control qualificationDatepicker" name="higher_education[<?php echo $hq_counter; ?>][to]" value="<?php echo $higher_education_details_row['to']; ?>" placeholder="To" disabled/>
								</div>
							  </div>
							  <div class="emp_rows col-xs-12">
								<div class="col-xs-8">
								  <textarea style="resize:none" class="form-control" rows="5" name="higher_education[<?php echo $hq_counter; ?>][additionalInfo]" placeholder="Additional Info" disabled><?php echo $higher_education_details_row['additionalInfo']; ?></textarea>
								</div>
							  </div>
							  <div class="emp_rows col-xs-12">
								<hr/>
						...
						<div class="emp_rows col-xs-12">
						  <div class="emp_rows col-xs-12">
							<div class="col-xs-8">
							  <input type="text" class="form-control" name="higher_education[0][name]" value="" placeholder="Qualification / certification name" disabled/>
							</div>
						  </div>
						  <div class="emp_rows col-xs-12">
							<div class="col-xs-4">
							  <input type="text" class="form-control" name="higher_education[0][institute]" value="" placeholder="Institute name" disabled/>
							</div>
							<div class="col-xs-4">
							  <input type="text" class="form-control" name="higher_education[0][grade]" value="" placeholder="Grade/Result" disabled/>
							</div>
						  </div>
						  <div class="emp_rows col-xs-12">
							<div class="col-xs-4">
							  <input type="text" readonly class="form-control qualificationDatepicker" name="higher_education[0][from]" value="" placeholder="From" disabled/>
							</div>
							<div class="col-xs-4">
							  <input type="text" readonly class="form-control qualificationDatepicker" name="higher_education[0][to]" value="" placeholder="To" disabled/>
							</div>
						  </div>
						  <div class="emp_rows col-xs-12">
							<div class="col-xs-8">
							  <textarea style="resize:none" class="form-control" rows="5" name="higher_education[0][additionalInfo]" placeholder="Additional Info" accesskey="disabled"></textarea>
							</div>
						  </div>
						  <div class="emp_rows col-xs-12">
							<hr/>
...
<script>
	$(document).ready(function(){
		$("form#inputform").submit(function(e){
			...
			$.ajax({
				url: siteUrl + 'hr/employee/employee_confirm_submit',
				type: "POST",
				async: false,
				dataType: 'json',
				data: dats,
				success: function(data) {
	                if($.isEmptyObject(data.error)){
	                	window.location.replace(siteUrl+'hr/employee/employee_confirmation_list');
	                }else{
