<script>
	$(document).ready(function(){
		var salary_status = '<?php echo $epf_etf_paye_changes['status']; ?>';
		if(salary_status == 'Y'){
				...
				success: function(data) {
					...
					$.ajax({
						...
						success: function(data) {
							...
							if(data.employee_salary.gratuity>0){
...
<script>
	$(document).ready(function(){
		...
		$("form#edit_sal_inputform").submit(function(e){
			...
			$.ajax({
				cache: false,
				url: siteUrl + 'hr/emp_payroll/confirm_emp_epf_etf_paye',
				type: "POST",
				async: false,
				dataType: 'json',
				data: dats,
...
<div class="table widget-shadow">
  ...
  <div class="row">
    <form data-toggle="validator" id="edit_sal_inputform" name="edit_sal_inputform" method="post">
	  ...
	  <input type="hidden" id="epf_etf_paye_change_id" name="epf_etf_paye_change_id" value="<?php echo $epf_etf_paye_changes['id']; ?>">
	  ...
	  <div class="col-md-6 validation-grids validation-grids-right">
	    <div class="" data-example-id="basic-forms">
		  ...
		  <div class="form-body">
		    <label class="control-label" style="font-size: 120%;">EPF/ETF - Current state</label>
		  </div>
		  <?php
		  foreach($epf_etf as $epf_etf_row){ ?>
			<div class="form-body">
			  ...
			  <div class="col-xs-6">
				<input type="checkbox" name="<?php echo $epf_etf_row->type; ?>" value="<?php echo $epf_etf_row->type; ?>" disabled >
			  </div>
			</div>
		  <?php
		  }  ?>
			...
			<div class="form-body">
				<hr>
	<label class="control-label" style="font-size: 120%;">Gratuity - Current state</label>
	</div>
	<div class="form-body">
		<div class="col-xs-6">
		  ...
		  <div class="form-body">
			...
			<div class="col-xs-6">
			  <input type="checkbox" name="paye" value="paye" disabled >
			</div>
		  </div>
	  ...
	  <div class="col-md-6 validation-grids validation-grids-left">
	    <div class="" data-example-id="basic-forms">
		  ...
		  <div class="form-body">
		    <label class="control-label" style="font-size: 120%;">EPF/ETF - Changes</label>
		  </div>
		  <?php
		  foreach($epf_etf as $epf_etf_row){ ?>
			<div class="form-body">
			  ...
			  <div class="col-xs-6">
				<input type="checkbox" name="epf_etf_changes" value="<?php echo $epf_etf_row->type; ?>" <?php if(($epf_etf_row->type == "EPF" && $epf_etf_paye_changes['epf'] == "Y") || ($epf_etf_row->type == "ETF" && $epf_etf_paye_changes['etf'] == "Y")){ echo "checked"; } ?> disabled >
			  </div>
			</div>
		  <?php
		  }  ?>
			...
			<div class="form-body">
				<hr>
	<label class="control-label" style="font-size: 120%;">Gratuity - Changes</label>
	</div>
	<div class="form-body">
		<div class="col-xs-6">
			<input type="number" class="form-control" id="gratuity" name="gratuity" placeholder="Gratuity %" required value="<?=$epf_etf_paye_changes['gratuity'];?>">
			</div></div>

          <div class="form-body">
          	<hr>
			<label class="control-label" style="font-size: 120%;">Paye Tax - Changes</label>
		  </div>
		  <div class="form-body">
		    <div class="col-xs-6">
			  Paye Tax
			...
			<div class="col-xs-6">
			  <input type="checkbox" name="paye_changes" value="paye" <?php if($epf_etf_paye_changes['payee_tax'] == "Y"){ echo "checked"; } ?> disabled >
			</div>
		  </div>
