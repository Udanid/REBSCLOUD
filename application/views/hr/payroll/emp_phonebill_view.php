...
<script>
	$(document).ready(function(){
		$("form#inputform").submit(function(e){
			...
			$.ajax({
				url: siteUrl + 'hr/emp_payroll/submit_phonebill_list',
				type: "POST",
				async: false,
				dataType: 'json',
				data: dats,
	...
	<div class="modal-content">
	  <div class="modal-body">
		...
		<div id="messageBoard">
		  ...
		  <div class="table">
			<h3 class="title1">Employee Phone Bills</h3>
			<div class="widget-shadow">
			  <ul id="myTabs" class="nav nav-tabs" role="tablist">
				<li role="presentation" class="active">
				  <a href="#home" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="false">Employee Phone Bills</a>
				</li>
				<li role="presentation" class="">
				  <a href="#profile" role="tab" id="profile-tab" data-toggle="tab" aria-controls="profile" aria-expanded="true">Submit Monthly Phone Bill Payments</a>
				</li>
			  </ul>
					...
					<div class="row">
					  <form data-toggle="validator" id="inputform" name="inputform" method="post">
						<div class="form-title">
						  <h4>Submit Monthly Phone Bill Payments</h4>
						</div>
						...
						<div class="col-md-4">
						  <div class="col-md-6 validation-grids validation-grids-right">
							<div class="" data-example-id="basic-forms">
							  <div class="form-body">
								<div class="form-group has-feedback">
								  <label for="year" class="control-label" >Amount - Apply All</label>
								  ...
								  <div class="form-body">
									<div class="form-group">
								      <div class="col-md-5">
										...
										<input type="text" class="form-control" id="salary_phone_<?php echo $employee->id; ?>" name="salary_phone_<?php echo $employee->id; ?>" placeholder="Phone Number" value="<?=$employee->tel_mob?>" readonly>
										</div>
										<div class="col-md-2">
										<label class="control-label">Bill Amount</label>
										<input type="text" class="form-control" id="salary_amount_<?php echo $employee->id; ?>" name="salary_amount_<?php echo $employee->id; ?>" placeholder="Bill Amount" value="<?=$employee->phone_bill?>" readonly>
									  </div>
									  <div class="col-md-3">
										<label class="control-label">Bill Exceed Amount</label>
										<input type="text" class="form-control" id="salary_phonebill_amount_<?php echo $employee->id; ?>" name="salary_phonebill_amount_<?php echo $employee->id; ?>" value="" placeholder="Exceed Amount">
									  </div>
									</div>
								  </div>
								</div>
...
<script>
	...
	function call_edit(id){
		...
		$('#popupform').load("<?php echo base_url();?>hr/emp_payroll/emp_phonebill_paymentlist/"+id );
	}
	...
	function call_confirm(id){
		var siteUrl = '<?php echo base_url(); ?>';
		$.ajax({
			url: siteUrl + 'hr/emp_payroll/employee_phonebill_confirm',
			type: "POST",
			async: false,
			dataType: 'json',
			data: {record_id:id},
		...
		headerClass:"modal-header",
				confirm: function(button) {
					button.fadeOut(2000).fadeIn(2000);
						window.location="<?php echo base_url();?>hr/emp_payroll/decline_monthly_phonebill/"+document.deletekeyform.deletekey.value;
				},
