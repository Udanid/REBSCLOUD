...
?>
<h4>Incentive Payment Details: <?php echo $month."/".$details['year']; ?><span style="float:right; color:#FFF" ><a href="javascript:close_edit('<?php echo $details['id']; ?>')"><i class="fa fa-times-circle"></i></a></span></h4>
...
<table class="table">
                  ...
                  <tbody>
                    <?php
				    if($incentive_advance_list){
				  	  $c = 0;
					  $count = 1;
				  	  $ci =&get_instance();
					  $ci->load->model('employee_model');
                  	  foreach($incentive_advance_list as $row){
