							...
							<tr class="<?php echo ($c<0) ? 0 : ($c++ % 2 == 1) ? 'info' : ''; ?>">
							  ...
							  <td>
								...
								if($row->change_type == "salary_increment_decrement_update"){
									...
									$change_type = "EPF/ETF/Paye/Gratuity";
							  ...
							  <div class="form-body">
								<div class="form-group">
								  ...
								  <select class="form-control" id="salary_change_type" name="salary_change_type" onChange="load_salary_change_type(this.value);" required>
									...
									<option value="epf_etf_paye_update">EPF/ETF/Paye/Gratuity</option>
						  ...
						  <div class="" data-example-id="basic-forms">
							...
							<div id="epf_etf_paye_div" style="display: none;">
							  ...
							  <?php
								...
								<hr>
								<div class="form-body">
							  <label class="control-label" style="font-size: 120%;">Gratuity %</label>
								</div>
								<div class="form-body">
...
<script>
	...
	function call_edit(id, type){
		...
		$('#popupform').load("<?php echo base_url();?>hr/emp_payroll/edit_emp_salary_changes/"+type+"/"+id );
	}
