...
$b=$b.'
                        ...
                        <table  border="1" > <thead> <tr bgcolor="#d5dace"> <th>Reservation Code</th><th>Branch Name</th><th>Project Name</th><th>Lot Number</th> <th>Customer Name </th><th>Reserve Date</th><th>Estimated Price</th><th>Discount</th><th>Sale Value</th><th>MDP</th><th>Paid Amount</th><th>BMDP</th></tr> </thead>';
                    $prjes=0;$prjdis=0;$prjsale=0; $prjmdp=0;$prjpaid=0;$prjbmdp=0;
                      ...
                      $b=$b.'  <td align="right">'.number_format($row->down_payment,2).'</td>';
                       $b=$b.' <td align="right">'.number_format($row->min_down-$row->down_payment,2).'</td>';
                       $b=$b.'  </tr> ';
