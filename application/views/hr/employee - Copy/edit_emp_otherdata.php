			  ...
			  <div class="form-group">
				<div class="col-xs-10">
				  <button type="submit" class="btn btn-primary btn-lg " id="load" data-loading-text="<i class='fa fa-spinner fa-spin'></i> Processing Request">Update Employee</button>
					<a href="<?php echo base_url();?>hr/employee/add_emp_edu_data/<?php echo $employee_details['id'];?>"><button type="button" class="btn btn-danger btn-lg " data-loading-text="<i class='fa fa-spinner fa-spin'></i> Processing Request">Skip</button></a>
				</div>
			  </div>
			</form>
		  </div>
