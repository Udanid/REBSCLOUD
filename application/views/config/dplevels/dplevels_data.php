...
<div id="page-wrapper">
 <div class="main-page">
  ...
  <div class="table">
      ...
      <h3 class="title1">Down Payment Levels</h3>
              ...
              <? if($this->session->flashdata('msg')){?>
               ...
               <div class="alert alert-danger" role="alert">
                    ...
                    <div class=" widget-shadow bs-example" data-example-id="contextual-table" > 
                        ...
                        <table class="table table-bordered"> <thead> <tr> <th rowspan="2">ID</th> <th rowspan="2">Down Payment Percentage</th> <th rowspan="2">Project Ratio</th><th colspan="8" align="center">Interest Rates </th></tr>
