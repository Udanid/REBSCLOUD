 <h4>Details of <?=$details->document_name ?> <span  style="float:right; color:#FFF" ><a href="javascript:close_edit('<?=$details->doctype_id 	?>')"><i class="fa fa-times-circle "></i></a></span></h4>
						...
						<div class="col-md-6 validation-grids " data-example-id="basic-forms"> 
							...
							<div class="form-body">
								<? $catlist=explode(',',DOCUMENTCAT);?>
                                    ...
                                    <select class="form-control" placeholder="Document Category"  <? if($details->status=='CONFIRMED'){?>  disabled="disabled"<? }?> id="category" name="category"   required >
