 <h4>Branch Details of <?=$details->branch_name?> Branch<span  style="float:right; color:#FFF" ><a href="javascript:close_edit('<?=$details->branch_code?>')"><i class="fa fa-times-circle "></i></a></span></h4>
<div class="table widget-shadow">
 <div class="row">
                    <form data-toggle="validator" method="post" action="<?=base_url()?>config/branch/editdata">
						<div class="col-md-6 validation-grids widget-shadow" data-example-id="basic-forms"> 
							...
							<div class="form-body">
                                    ...
                                    <input type="hidden"  value="<?=$details->branch_code?>"name="branch_code" id="branch_code"  />
										<input type="text" class="form-control" value="<?=$details->shortcode?>"name="shortcode" id="shortcode" readonly="readonly" maxlength="3"   pattern="[A-Za-z]{3}" placeholder="Short Code" data-error="" onChange="check_is_exsit(this)" required>
