			...
			<div class="main-page">
				...
				<div class="row">
					<div class="col-md-8 map widget-shadow">
						...
						<!--map js-->
						<link href="<?=base_url()?>media/css/jqvmap.css" rel='stylesheet' type='text/css' />
						<script src="<?=base_url()?>media/js/jquery.vmap.js"></script>
						<script src="<?=base_url()?>media/js/jquery.vmap.sampledata.js" type="text/javascript"></script>
						<script src="<?=base_url()?>media/js/jquery.vmap.world.js" type="text/javascript"></script>
