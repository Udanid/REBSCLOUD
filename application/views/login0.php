      ...
      -->
		...
		<div id="page-wrapper2">
			<div class="main-page login-page " style="margin-top:100px; margin-bottom:100px;" >
				<h3 class="title1"><img src="<?=base_url()?>media/images/logo.png"> </h3>
					...
					<div class="login-body">
					  <div id="messageBoard">
						...
						<form action="<?=base_url()?>login/login_check" method="post">
							<input type="text" class="user" id="username" name="username" placeholder="User name" required autocomplete="off">
		...
		<div class="footer"  style="background-color:#000; height:100px;" >
		   <p>&copy; <?=date('Y')?> <?=solutionname?> <?=solutionfull?>. All Rights Reserved |&nbsp;&nbsp;&nbsp;Developed by <a href="#" target="_blank"><?=provider?></a> </p>
		</div>
        <!--//footer-->
	</div>
	<!-- Classie -->
