      ...
      -->
		...
		<div id="page-wrapper2">
			<div class="main-page login-page " style="margin-top:100px; margin-bottom:100px;" >
				<h3 class="title1"><img src="<?=base_url()?>media/images/logo.jpg" style="width:250px;"> </h3>
				<div class="widget-shadow">
					<div class="login-body">
					  <div id="messageBoard">
						...
						<form action="<?=base_url()?>login/login_check" style="font-size:15px;" method="post" id="login-form">
