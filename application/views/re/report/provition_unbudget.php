...
function load_printscrean2(id,month)
{
				...
				window.open( "<?=base_url()?>re/report_excel/get_budget/"+month+"/"+branch );
			}
function load_printscrean3(id,fromdate,todate)
{
			window.open( "<?=base_url()?>re/report_excel/get_unbudget_daterange/"+fromdate+"/"+todate+"/"+id );
...
<div class="row">
   ...
   <div class="form-title">
     ...
     <div class="table-responsive bs-example widget-shadow"  >
      ...
      <th >Description</th><th>Payee Name</th><th>Narration</th><th >Payment Date </th><th>CHQ / Voucher No</th>
       <? $fulltot=0;?>
        </tr>
       <? if($prjlist){foreach($prjlist  as $prraw){ ?> 
       
    <tr><td><?=$details[$prraw->prj_id]->project_name?></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr>
