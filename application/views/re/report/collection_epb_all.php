...
<div class="row">
   ...
   <div class="form-title">
       ...
       <a href="javascript:load_printscrean2('<?=$branchid?>','03','<?=$fromdate?>','<?=$todate?>')"> <i class="fa fa-file-excel-o nav_icon"></i></a>
       <? }else{?>
          <a href="javascript:load_printscrean1('<?=$branchid?>','03','<?=$month?>')"><i class="fa fa-file-excel-o nav_icon"></i></a>
     ...
     <div class="table-responsive bs-example widget-shadow">
      ...
      <table class="table table-bordered"><thead><tr class="success"><th  rowspan="2">Project Name</th><th rowspan="2" >Lot Number</th><th rowspan="2" >Agreement Date</th>
	...
	if($prjlist){$fprjrental=0;$fprjlandval=0;$fprjdownpay=0;
		...
		foreach($prjlist as $prjraw){
			...
			?>
        <tr class="active"><td colspan="17"><?=$prjraw->project_name?></td><td></td>
