...
{
			window.open( "<?=base_url()?>re/summeryreport/balance_summery_excel/"+year+'/'+branch+'/'+month);
...
<div class="row">
   ...
   <div class="form-title">
     ...
     <div class="table-responsive bs-example widget-shadow"  >
      ...
      <table class="table table-bordered"><thead><tr class="success"><th >Project Name</th><th>Inventory</th><th >DP Debtor</th><th >ZEP Debtor</th>
