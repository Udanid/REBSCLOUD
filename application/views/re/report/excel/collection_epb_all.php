...
$b=$b.'
	  ...
	  <tr bgcolor="#dad1cb"><th  rowspan="2">Project Name</th><th  rowspan="2">Loan Code</th><th rowspan="2" >Lot Number</th><th rowspan="2" >Agreement Date</th>
	...
	if($prjlist){$fprjrental=0;$fprjlandval=0;$fprjdownpay=0;
		...
		if($thispyament>0)
		$flag=true;
		if($flag){	$prjlandval=$prjlandval+$raw->discounted_price;
						...
						$fprjlandval=$fprjlandval+$raw->discounted_price;
					
						$fprjdownpay=$fprjdownpay+$raw->down_payment;
						$fprjloanval=$fprjloanval+$raw->loan_amount;
						$fprjint=$fprjint+$inttots[$raw->loan_code];
						$fprjagreed=$fprjagreed+$paidtots;
						$fprjopbalint=$fprjopbalint+$opbalint;
						$fprjopbalcap=$fprjopbalcap+$opbalcap;
						$fprjopbaltot=$fprjopbaltot+$opbal;
						$fprjpayint=$fprjpayint+$thispayment[$raw->loan_code]->sum_int;
						$fprjpaycap=$fprjpaycap+$thispaidcap;
						$fprjpaydi=$fprjpaydi+$thispayment[$raw->loan_code]->sum_di;
						
						$fprjclbaltot=$fprjclbaltot+$clbal;
						
						
	
	   $b=$b.' <tr><td>'.$prjraw->project_name.'</td>';			
       $b=$b.' <td>'.$raw->loan_code.'</td>';
      ...
      $b=$b.'   <tr bgcolor="#c3c4be" style="font-weight:bold"><td colspan="2">Project Total</td><td></td><td></td>';
       ...
       $b=$b.' </tr>';}
	     ...
	     $b=$b.'   <tr bgcolor="#c3c4be" style="font-weight:bold"><td colspan="2"> Total</td><td></td><td></td>';
