				...
				<?  }?>
                 <h3> </h3>
                        ...
                        <th scope="row">Customer Name</th><td> <?=$details->first_name ?> &nbsp; <?=$details->last_name ?></td><th  align="right">NIC Number</th><td><?=$details->id_number ?></td> 
                          ...
                          <tr> 
                        <th scope="row">Loan Number</th><td> <?=$details->loan_code ?>-<?=$details->reschdue_sqn ?> &nbsp; </td><th  align="right">Article Value</th><td><?=number_format($details->discounted_price,2) ?></td> <th  align="right">Contract Date</th><td><?=$details->start_date ?></td>
                         </tr> 
...
<tr><th>Paid percentage </th><td> <div class="task-info">
                          ...
                          <tr class="warning"> 
                        <th scope="row">Arrears Rental</th><td> <?=number_format($arreascap+$arreasint,2)  ?> &nbsp; </td><th  align="right">Delay Interest</th><td><?=number_format(get_loan_date_di($details->loan_code,date('Y-m-d')),2)?></td> <th  align="right">Arrears Instalments</th><td><?=$arieasins  ?></td>
                         </tr> 
                           <tr class="success"> 
