     ...
     if(type != ""){
        ...
        if(month!='')
        {
             $('#fulldata').delay(1).fadeIn(600);
              ...
              $( "#fulldata").load( "<?=base_url()?>re/report/arrears_data/"+month+'/'+branchid+'/'+year);

         }
         else if(todate!='')
            {
              if(type=="04")
              {//updated by nadee 2021-07-02
                $('#fulldata').delay(1).fadeIn(600);
                   document.getElementById("fulldata").innerHTML='<img src="<?=base_url()?>media/images/loading.gif"  class="loadinggif">';
                 $( "#fulldata").load( "<?=base_url()?>re/report/arrears_data_advance/"+todate+'/'+branchid+'/'+prj_id);


              }else{
                $('#fulldata').delay(1).fadeIn(600);
                 document.getElementById("fulldata").innerHTML='<img src="<?=base_url()?>media/images/loading.gif"  class="loadinggif">';
                 $( "#fulldata").load( "<?=base_url()?>re/report/arrears_data_date/"+todate+'/'+branchid+'/'+type+'/'+prj_id);
        ...
        <div class="col-md-12 validation-grids widget-shadow" data-example-id="basic-forms" style="width: 100%; margin-top:-40px; background-color: #eaeaea;">
            <div class="form-body">
                <div class="form-inline">
                    ...
                    <div class="form-group">
                        <select class="form-control" placeholder="Qick Search.."    id="report_type" name="report_type" >
                        <option value="">Report Type</option>
                        <option value="01">Easy Payment</option>
                        <option value="02">Bank Loans</option>
                        <option value="03">ZEP Loans</option>
                        <option value="04">Down Payment</option>
                    </select>  </div>
                    ...
                    <div class="form-group" id="blocklist" style="display:none">
                    ...
                    <div class="form-group" >
                      ...
                      <input type="text" name="todate" id="todate" placeholder="As at Date"  class="form-control" autocomplete="off">
                    </div>
                    <div class="form-group">
