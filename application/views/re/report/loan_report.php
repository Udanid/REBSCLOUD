	 ...
	 if(prj_id!=""){
		...
		if(fromdate!='' & todate!='')
		{
			$('#fulldata').delay(1).fadeIn(600);
		 	...
		 	$( "#fulldata").load( "<?=base_url()?>re/report_daterange/get_loan_report_with_date/"+loan_type+'/'+branchid+'/'+fromdate+'/'+todate+'/'+prj_id);
		}else{
		  
	 		$('#fulldata').delay(1).fadeIn(600);
    		  document.getElementById("fulldata").innerHTML='<img src="<?=base_url()?>media/images/loading.gif"  class="loadinggif">'; 
		 	$( "#fulldata").load( "<?=base_url()?>re/report_daterange/get_loan_report_with_date/"+branchid+'/'+prj_id);
		 }
		...
		if (fromdate!='' & todate!=''){
		  ...
		  document.getElementById("fulldata").innerHTML='<img src="<?=base_url()?>media/images/loading.gif"  class="loadinggif">';
	 	  ...
	 	  $( "#fulldata").load( "<?=base_url()?>re/report_daterange/get_loan_report_with_date/"+loan_type+'/'+branchid+'/'+fromdate+'/'+todate+'/'+prj_id);
		  	...
		  	document.getElementById("checkflagmessage").innerHTML='Please Select Date Rage'; 
		   $('#flagchertbtn').click(); 
		}			  	 	  
	}
}
