		...
		if(code=='01')
		 {
    		...
    		document.getElementById("fulldata").innerHTML='<img src="<?=base_url()?>media/images/loading.gif"  class="loadinggif">'; 
		 	if (fromdate!='' & todate!='')
			{
				$( "#fulldata").load( "<?=base_url()?>re/cap_report/get_cost_date_range/"+fromdate+'/'+todate);
			}
			else
			$( "#fulldata").load( "<?=base_url()?>re/cap_report/get_cost_month/"+month+'/'+year);
	 	}
	 	...
	 	if(code=='02')
		 {
    		...
    		document.getElementById("fulldata").innerHTML='<img src="<?=base_url()?>media/images/loading.gif"  class="loadinggif">'; 
		 	if (fromdate!='' & todate!='')
			{
				$( "#fulldata").load( "<?=base_url()?>re/cap_report/get_turn_over_date_range/"+fromdate+'/'+todate);
			}
			else
			$( "#fulldata").load( "<?=base_url()?>re/cap_report/get_turn_over_month/"+month+'/'+year);
	 	}
	}	
	else
	{ 
                  ...
                  <div class="form-group" id="blocklist">
                        <select  name="collection" id="collection" class="form-control" onChange="load_projectdata(this.value)">
                         <option value="">Report Type</option>
                          <option value="01">Cost Report</option>
                            <option value="02">Turn over Report</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group" id="blocklist">
                        <select  name="month" id="month" class="form-control" onchange="hide_date_range(this.value)">
