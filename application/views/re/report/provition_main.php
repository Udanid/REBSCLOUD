	  ...
	  if(code!='')
	  {
			  ...
			  if(prj_id!="")
				...
				$('#fulldata').delay(1).fadeIn(600);
    			  document.getElementById("fulldata").innerHTML='<img src="<?=base_url()?>media/images/loading.gif"  class="loadinggif">'; 
				   ...
				   if (fromdate!='' & todate!='')
				   {
					    $( "#fulldata").load( "<?=base_url()?>re/report_daterange/get_provition/"+prj_id+'/'+fromdate+'/'+todate);
				   }
				   else
				    $( "#fulldata").load( "<?=base_url()?>re/report/get_provition/"+prj_id+'/'+month);
		 ...
		 if(code=='02')
		 {
				 ...
				 if(prj_id!="")
				 {
    				  ...
    				  document.getElementById("fulldata").innerHTML='<img src="<?=base_url()?>media/images/loading.gif"  class="loadinggif">'; 
		 			  	 if (fromdate!='' & todate!='')
				  		 {
						    $( "#fulldata").load( "<?=base_url()?>re/report_daterange/get_budget/"+prj_id+'/'+fromdate+'/'+todate);
				  		 }
				  		 else
				  		  $( "#fulldata").load( "<?=base_url()?>re/report/get_budget/"+prj_id+'/'+month);
		 ...
		 if(code=='04')
		 {
				 ...
				 if(prj_id!="")
				 {
						$('#fulldata').delay(1).fadeIn(600);
    				  document.getElementById("fulldata").innerHTML='<img src="<?=base_url()?>media/images/loading.gif"  class="loadinggif">'; 
		 			  $( "#fulldata").load( "<?=base_url()?>re/report/get_finance/"+prj_id);
		 ...
		 if(code=='03'){
			// var prj_id= document.getElementById("prj_id").value;
    		  ...
    		  document.getElementById("fulldata").innerHTML='<img src="<?=base_url()?>media/images/loading.gif"  class="loadinggif">';
			   if (fromdate!='' & todate!='')
				  		 {
						    $( "#fulldata").load( "<?=base_url()?>re/report_daterange/get_unbudget/"+fromdate+'/'+todate+'/'+branchid);
				  		 }
				  		 else
				  		   $( "#fulldata").load( "<?=base_url()?>re/report/get_unbudget/"+month+'/'+branchid);
		  ...
		  if(code=='05'){
			...
			// var prj_id= document.getElementById("prj_id").value;
				$('#fulldata').delay(1).fadeIn(600);
    		  document.getElementById("fulldata").innerHTML='<img src="<?=base_url()?>media/images/loading.gif"  class="loadinggif">'; 
		 	  $( "#fulldata").load( "<?=base_url()?>re/report/get_finance_summery/"+branchid+'/'+branchid);
		 }
		  if(code=='06'){
			  //alert(branchid)
			// var prj_id= document.getElementById("prj_id").value;
				$('#fulldata').delay(1).fadeIn(600);
    		  document.getElementById("fulldata").innerHTML='<img src="<?=base_url()?>media/images/loading.gif"  class="loadinggif">'; 
		 	  $( "#fulldata").load( "<?=base_url()?>re/report/get_provition_summery/"+branchid+'/'+branchid);
		 }
	  }
	  else
	  { 
...
function load_branchproject(id)
{
			 document.getElementById("projectdata").innerHTML='<img src="<?=base_url()?>media/images/loading.gif"  class="loadinggif">'; 
			  $( "#projectdata").load( "<?=base_url()?>re/report/get_branch_projectlist/"+id);
