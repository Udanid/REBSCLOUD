          ...
          <a href="#external" id="external-tab" role="tab" data-toggle="tab" aria-controls="external" aria-expanded="false">External</a></li> 
           ...
           <div id="myTabContent" class="tab-content scrollbar1" style="padding:5px;">
             ...
             <div role="tabpanel" class="tab-pane fade " id="in" aria-labelledby="in-tab" >
               <br>
               <? $this->load->view("re/fundtransfers/inproject");?>
               </div>
               ...
               <br>
               <? $this->load->view("re/fundtransfers/external");?>
               </div>
...
<form name="deletekeyform">  <input name="deletekey" id="deletekey" value="0" type="hidden">
            ...
            $("#complexConfirm").confirm({
                ...
                confirm: function(button) {
					...
					var code=1
                    window.location="<?=base_url()?>re/fundtransfers/delete/"+document.deletekeyform.deletekey.value;
                },
