...
$reportdata=$date->format('Y-m-d');
 ...
 $b='';
$b=$b.'      <table  border="1"> <tr><td  align="center"  colspan="15"><h2>'.$heading2.'</h2></td></tr>
 ...
 <th>Total Due</th>
	  ...
	  $flag=true;
        ...
        $b=$b.' <tr><td></td>';
           ...
           $b=$b.' <td>'.$raw->lot_number.'</td>';
            ...
            $b=$b.' <td align="right">'.$rental_date.'</td>';
            $b=$b.'  <td align="right">'.number_format($debtordue,2).'</td>';
              $b=$b.'    <td  align="right">'.number_format($paiddebt,2).'</td>';
          $b=$b.'<td  align="right" class="success">'.number_format($debtorpr,2).'%</td>';
           $b=$b.' <td  align="right">'.number_format($currentdue,2).'</td>';
             $b=$b.'   <td  align="right">'.number_format($paidcurrent,2).'</td>';
              $b=$b.'   <td  align="right" class="success">'.number_format($curentpr,2).'%</td>';
           $b=$b.'  <td  align="right">'.number_format($totdue,2).'</td>';
           $b=$b.'  <td  align="right">'.number_format($this_collection,2).'</td>';
           $b=$b.'  <td  align="right" class="success">'.number_format($totpr,2).'%</td>';
      ...
      $b=$b.' <tr style="font-weight:bold" class="info"><td colspan="4">Project Total</td>
  			
           <td></td>
           
            <td align="right"></td>';
            $b=$b.'  <td align="right">'.number_format($debtorduepr,2).'</td>';
                $b=$b.'  <td  align="right">'.number_format($paiddebtpr,2).'</td>';
       $b=$b.'   <td  align="right"></td>';
           $b=$b.' <td  align="right">'.number_format($currentduepr,2).'</td>';
              $b=$b.'  <td  align="right">'.number_format($paidcurrentpr,2).'</td>';
             $b=$b.'    <td  align="right"></td>';
           $b=$b.'  <td  align="right">'.number_format($totduepr,2).'</td>';
  ...
  $b=$b.' <tr style="font-weight:bold"  class="active"><td colspan="4">Total</td>
   
           <td></td>
             <td align="right"></td>';
        
              $b=$b.'<td align="right">'.number_format($debtordueall,2).'</td>';
                $b=$b.'  <td  align="right">'.number_format($paiddebtall,2).'</td>';
        $b=$b.'  <td  align="right"></td>';
           $b=$b.' <td  align="right">'.number_format($currentdueall,2).'</td>';
               $b=$b.' <td  align="right">'.number_format($paidcurrentall,2).'</td>';
                $b=$b.' <td  align="right"></td>';
           $b=$b.'  <td  align="right">'.number_format($totdueall,2).'</td>';
	...
	header("Content-Disposition: attachment;Filename=".$enddate.$reName."-Report.xls");
	echo $b;