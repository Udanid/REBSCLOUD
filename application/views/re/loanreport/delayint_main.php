...
function load_fulldetails()
{
	 ...
	 //var month=document.getElementById("month").value;
	  ...
	  if(collection=='03' || collection=='04'  || collection=='05')
	  {
       ...
       if(fromdate!='' & todate!='')
			  {
			//	alert( "<?=base_url()?>re/loanreport/get_delayint/"+prj_id+'/'+collection+'/'+fromdate+'/'+todate)
          $('#fulldata').delay(1).fadeIn(600);
          document.getElementById("fulldata").innerHTML='<img src="<?=base_url()?>media/images/loading.gif"  class="loadinggif">';
		 	  $( "#fulldata").load( "<?=base_url()?>re/loanreport/get_delayint/"+prj_id+'/'+collection+'/'+fromdate+'/'+todate);
		...
		// alert(collection)
          ...
          $('#fulldata').delay(1).fadeIn(600);
          document.getElementById("fulldata").innerHTML='<img src="<?=base_url()?>media/images/loading.gif"  class="loadinggif">';
		 	  $( "#fulldata").load( "<?=base_url()?>re/loanreport/get_delayint_all/"+branchid+'/'+collection+'/'+fromdate+'/'+todate);
