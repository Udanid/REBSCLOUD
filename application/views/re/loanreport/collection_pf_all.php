...
<div class="row">
     ...
     <div class="table-responsive bs-example widget-shadow"   style="max-height:400px; overflow:scroll" >
      ...
      <table class="table table-bordered">
        ...
        <tr   class="active"><th  rowspan="2"> Project Name </th>
          ...
          <th  rowspan="2">Finance Amount</th>
 ...
 <th>Total Due</th>
  ...
  ?>
  <tr style="font-weight:bold"  class="active"><td colspan="4">Total</td>
   
           <td></td>
           <td></td>
           
        
             <td align="right"><?=number_format($debtordueall,2)?></td>
                 <td  align="right"><?=number_format($paiddebtall,2)?></td>
           <td  align="right"><?=number_format(($paiddebtall/$debtordueall)*100,2)?></td>
           <td  align="right"><?=number_format($currentdueall,2)?></td>
               <td  align="right"><?=number_format($paidcurrentall,2)?></td>
                <td  align="right"><?=number_format(($paidcurrentall/$currentdueall)*100,2)?></td>
            <td  align="right"><?=number_format($totdueall,2)?></td>
            <td  align="right"><?=number_format($this_collectionall,2)?></td>
            <td  align="right"><?=number_format(($this_collectionall/$totdueall)*100,2)?></td>
