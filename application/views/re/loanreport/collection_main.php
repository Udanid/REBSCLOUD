...
function load_fulldetails()
{
	 ...
	 //var month=document.getElementById("month").value;
	  ...
	  if(collection=='03' || collection=='04'  || collection=='05')
	  {
		 if(prj_id!="")
		 {
       if(fromdate!='' & todate!='')
          ...
          document.getElementById("fulldata").innerHTML='<img src="<?=base_url()?>media/images/loading.gif"  class="loadinggif">';
		 	  $( "#fulldata").load( "<?=base_url()?>re/loanreport/get_collection/"+prj_id+'/'+collection+'/'+fromdate+'/'+todate);
		 ...
		 prj_id=0;
		// alert(collection)
 alert("<?=base_url()?>re/loanreport/get_collection_all/"+branchid+'/'+collection+'/'+fromdate+'/'+todate)
          ...
          $('#fulldata').delay(1).fadeIn(600);
          document.getElementById("fulldata").innerHTML='<img src="<?=base_url()?>media/images/loading.gif"  class="loadinggif">';
		 	  $( "#fulldata").load( "<?=base_url()?>re/loanreport/get_collection_all/"+branchid+'/'+collection+'/'+fromdate+'/'+todate);
	 ...
	 //	 document.getElementById("checkflagmessage").innerHTML='Please Select Project to generate report';
	  ...
	  else if(collection=='06')
	  {
		  	if(fromdate!='' & todate!='')
			  {
          $('#fulldata').delay(1).fadeIn(600);
          document.getElementById("fulldata").innerHTML='<img src="<?=base_url()?>media/images/loading.gif"  class="loadinggif">';
		 	  $( "#fulldata").load( "<?=base_url()?>re/loanreport/get_summery_all/"+branchid+'/'+collection+'/'+fromdate+'/'+todate);
    ...
    <div class="row">
        <div class="col-md-12 validation-grids widget-shadow" data-example-id="basic-forms" style="width: 100%; margin-top:-40px; background-color: #eaeaea;">
          ...
          <div class="form-group" id="blocklist">
              ...
              <option value="04">Personal Fund</option>
              <option value="05">NEP</option>
               <option value="06">Summery Report</option>
