...
function load_fulldetails()
{
	 ...
	 if(prj_id!="" & month!="" & year!='')
	 {
		 $('#fulldata').delay(1).fadeIn(600);
    		  document.getElementById("fulldata").innerHTML='<img src="<?=base_url()?>media/images/loading.gif"  class="loadinggif">'; 
		 	  $( "#fulldata").load( "<?=base_url()?>re/sales/get_target/"+prj_id+'/'+month+'/'+year);
...
function check_this_market()
{
	...
	return true;
       ...
       <form data-toggle="validator" method="post" action="<?=base_url()?>re/sales/add_target"  enctype="multipart/form-data">
