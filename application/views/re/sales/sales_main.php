  ...
  <div class="table">
      ...
      <div class="widget-shadow">
          <ul id="myTabs" class="nav nav-tabs" role="tablist"> 
           <li role="presentation" class="active"><a href="#profile" role="tab" id="profile-tab" data-toggle="tab" aria-controls="profile" aria-expanded="true">Sales Forcast</a></li>  <li role="presentation" >
        <a href="#printed" role="tab" id="printed-tab" data-toggle="tab" aria-controls="printed" aria-expanded="true">Collection Forcast</a></li>
          ...
          <? $this->load->view("includes/flashmessage");?>
                ...
                <div role="tabpanel" class="tab-pane fade active in " id="profile" aria-labelledby="profile-tab"> 
                    <p>	  
                  <?  $this->load->view("re/sales/sales_target"); ?>
                   </p> 
                </div>
                <div role="tabpanel" class="tab-pane fade " id="printed" aria-labelledby="printed-tab"> 
                    <p>	  
                  <?    $this->load->view("re/sales/collection_forcast"); ?>
                   </p> 
                </div>
            </div>
         </div>
