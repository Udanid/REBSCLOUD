...
$( function() {
	...
	//Temporily allow back date Ticket No:3348 updated by madushan 2021-08-27
    
    $( "#settldate" ).datepicker({dateFormat: 'yy-mm-dd',minDate: '1990-01-01',
			maxDate: '<?=$this->session->userdata("current_end")?>'});
	 $( "#due_date" ).datepicker({dateFormat: 'yy-mm-dd',minDate: '1990-01-01'});
...
function load_epdata(value)
{
    ...
    $('#epbbankdata').delay(1).fadeIn(600);
		}else  $('#epbbankdata').delay(1).fadeOut(600);
...
function instalment_cal()
{
	...
	var principle=parseFloat(<?=$resdata->discounted_price-$resdata->down_payment?>)- parseFloat(final_amount);
				 ...
				 if($row->type=='Outright'){?>
                   ...
                   <?
                    ...
                    <? }?>
                                       ...
                                       <div id="finalinsatalment" style="display:none">
                                       	 <div class="form-group">
                                           <label class="col-sm-3 control-label" >Final 10% Amount</label>
                                            <div class="col-sm-3" id="subtaskdata"><input type="number" class="form-control" name="final_amount" id="final_amount"value="0"  onchange="instalment_cal()" >
                                            </div>
                                            <label class="col-sm-3 control-label" >Final 10% Date</label>
                                            <div class="col-sm-3" id="subtaskdata"><input type="text" class="form-control" name="final_date" id="final_date"value=""  >
                                            </div>
                                         </div>
									 ...
									 <div class="form-group">
                                      ...
                                      <label class="col-sm-3 control-label" >Interest Rate (Annual)</label>
										<div class="col-sm-3" id="subtaskdata"><input  type="number" class="form-control" step="0.0001" name="interest" id="interest"  onblur=" instalment_cal()"   required value="0"  >
										</div>
                                     ...
                                     <label class="col-sm-3 control-label">Repayment Period (Months)</label>
                                        ...
                                        <input type="number" step="1" name="period" id="period" onchange="enableInsedit();" class="form-control" onblur=" instalment_cal()" required="required"/>
                                            	...
                                            	<select name="collection_officer" id="collection_officer" class="form-control" placeholder="Sales Officer" >
                                    				<option value="">Collection officer</option>
                                     				<? foreach ($loan_officer as $raw){?>
                    									<option value="<?=$raw->user_id?>" ><?=$raw->emp_no?> &nbsp; <?=$raw->initial?> &nbsp; <?=$raw->surname?></option>
                    								<? }?>

                                    			</select>
  											</div>
                                            <label class="col-sm-3 control-label">Agreement Date</label>
											<div class="col-sm-3 has-feedback" id="paymentdateid"><input  type="text" class="form-control" id="settldate" autocomplete="off" onchange="enableInsedit();" value="<?=date('Y-m-d')?>"  name="settldate"    data-error="" required="required" readonly="readonly" >
                                     	...
                                     	<div class="form-group ">
                                        	...
                                        	<span id="monthlyinst">
                                        	 ...
                                        	 <label class="col-sm-3 control-label">First Due Date</label>
											<div class="col-sm-3 has-feedback" id="paymentdateid"><input  type="text" class="form-control" id="due_date" autocomplete="off"  name="due_date" readonly="readonly"   data-error="" >
											<span class="glyphicon form-control-feedback" aria-hidden="true"></span>
											<span class="help-block with-errors" ></span></div>
                                      </div>
                    ...
                    <div id="epbbankdata" style="display:none">

              <div class="form-group">
                <label class="col-sm-3 control-label" >EPB Bank Data</label>
                <div class="col-sm-8"> <table  class="table"><tr><td>
                ...
                <td> <div id="branch-1"><select name="branch1" id="branch1" class="form-control" placeholder="Bank" >
                ...
                <td><input type="text" class="form-control" name="contact_name" id="contact_name"   placeholder="contact_person" data-error="" >
                </td>
              </tr></table></div>
