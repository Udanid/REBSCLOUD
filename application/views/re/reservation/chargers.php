...
<div id="page-wrapper">
 <div class="main-page">
  ...
  <div class="table">
      ...
      <h3 class="title1">Other Chargers </h3>
     			
      <div class="widget-shadow">
          <ul id="myTabs" class="nav nav-tabs" role="tablist"> 
            <li role="presentation" class="active"><a href="#charges" role="tab" id="charges-tab" data-toggle="tab" aria-controls="charges" aria-expanded="true">Other Charges</a></li> 
            <li role="presentation"><a href="#transfers" role="tab" id="transfers-tab" data-toggle="tab" aria-controls="transfers" aria-expanded="true">Transfer</a></li> 
            <li role="presentation"><a href="#transfer_list" role="tab" id="transfer_list-tab" data-toggle="tab" aria-controls="transfer_list" aria-expanded="true">Transfer List</a></li> 
          ...
          <? $this->load->view("includes/flashmessage");?>
               ...
               <br>
                  ...
                  <div role="tabpanel" class="tab-pane fade active in " id="charges" aria-labelledby="charges-tab"> 
                    <p>	  
                 ...
                 <div role="tabpanel" class="tab-pane fade" id="transfers" aria-labelledby="transfers-tab"> 
                    <p>	  
                  <? $this->load->view("re/reservation/reservation_chargers_transfer"); ?>
                   </p> 
                </div>
                 <div role="tabpanel" class="tab-pane fade" id="transfer_list" aria-labelledby="transfer_list-tab"> 
                    <p>   
                  <? $this->load->view("re/reservation/chargers_transfer_list"); ?>
                   </p> 
                </div>
            </div>
         </div>
