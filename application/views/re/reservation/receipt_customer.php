...
function load_charges(id)
{
 ...
 if(id!=""){
					...
					$( "#plandata_charges" ).load( "<?=base_url()?>re/reservation/get_customer_list/"+id );
...
<div id="page-wrapper">
 <div class="main-page">
  ...
  <div class="table">
      ...
      <h3 class="title1">Receipting Customer </h3>
     			
      <div class="widget-shadow">
          <ul id="myTabs" class="nav nav-tabs" role="tablist"> 
            <li role="presentation" class="active"><a href="#charges" role="tab" id="charges-tab" data-toggle="tab" aria-controls="charges" aria-expanded="true">Add customer</a></li> 
          ...
          <? $this->load->view("includes/flashmessage");?>
               ...
               <br>
                  ...
                  <div role="tabpanel" class="tab-pane fade active in " id="charges" aria-labelledby="charges-tab"> 
                    <p>	  
                  <form data-toggle="validator" method="post" action="<?=base_url()?>re/reservation/update_customer_data" enctype="multipart/form-data">
...
<div class=" widget-shadow" data-example-id="basic-forms" style="min-height:400px;"> 
					...
					</select> </div><div id="plandata_charges">
