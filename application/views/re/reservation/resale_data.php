...
function load_amount(value)
{
 ...
 <? } else {?>
							...
							<div class="form-body  form-horizontal" >
									...
									<label class="col-sm-3 control-label">Non Refundable Amount</label>
										<div class="col-sm-3 has-feedback" id="paymentdateid"><input  type="text" class="form-control number-separator" id="non_refund"  value="<?=$resdata->non_refund ?>"   name="non_refund" onchange="change_refund_tot()"     data-error=""   required="required" >
										...
										<div class="col-sm-3 has-feedback" ><input  type="text" class="form-control number-separator" id="repay_total"  value="<?=$resdata->down_payment-$resdata->non_refund ?>"   name="repay_total"  onblur="check_refundtot()"    data-error=""   required="required" >
								       ...
								       <label class="col-sm-3 control-label">Request  Date</label>
										<div class="col-sm-3 has-feedback" id="paymentdateid"><input  type="text" class="form-control" id="settldate"  readonly="readonly"   name="settldate"   value="<?=date('Y-m-d')?>"  data-error="" required="required" >
										<span class="glyphicon form-control-feedback" aria-hidden="true"></span>
										<span class="help-block with-errors" ></span></div>
 ...
 <div class=" widget-shadow bs-example" data-example-id="contextual-table" >
                        ...
                        <table class="table"> <thead> <tr> <th>Payment Date</th><th>Payment Sequence </th><th style="text-align:right">Amount</th> <th style="text-align:right">Status </th></tr> </thead>
                      <? if($saledata){$c=0;
                        ...
                        <td style="text-align:right"><div id="checherflag">
