...
function load_charges(id)
{
 ...
 if(id!=""){
					...
					$( "#plandata_charges" ).load( "<?=base_url()?>re/reservation/get_chargelist/"+id );
 ...
 <form data-toggle="validator" method="post" action="<?=base_url()?>re/reservation/add_charges" enctype="multipart/form-data">
