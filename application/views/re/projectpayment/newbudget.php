...
function loadbudget(id)
{
 ...
 if(id!=""){
					...
					$( "#plandata_budget" ).load( "<?=base_url()?>re/projectpayments/get_budget/"+id );
...
function load_amount(value)
{
 ...
 <form data-toggle="validator" method="post" action="<?=base_url()?>re/projectpayments/add_newbudget" enctype="multipart/form-data">
