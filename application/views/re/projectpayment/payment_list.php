	...
	setTimeout(function(){ 
	  $("#prj_id").chosen({
		...
		$("#payee_name").chosen({
			...
			width:'100%',
	 		no_results_text: "Oops, nothing found!",
	 		placeholder_text_single: "Select a Payee"
    	});
	}, 500);
...
//alert(id);
		...
		$.ajax({
            ...
            data: {table: 're_prjacpaymentdata', id: id,fieldname:'id' },
...
function activateChosen(){
	$("#adv_id1").chosen({
		...
		width:'100%',
		no_results_text: "Oops, nothing found!",
		placeholder_text_single: "Select Advance"
	});
	...
	$("#invoice_id").chosen({
		...
		width:'100%',
		no_results_text: "Oops, nothing found!",
		placeholder_text_single: "Select Invoice"
	});
}
</script>
<style type="text/css">
 ...
 <div class="main-page">
  ...
  <div class="table">
      ...
      <div class="widget-shadow">
      		<form data-toggle="validator" method="post" action="<?=base_url()?>re/projectpayments/payment_search"  enctype="multipart/form-data">
                <div class="row">
          ...
          <a href="#budget" id="budget-tab" role="tab" data-toggle="tab" aria-controls="budget" aria-expanded="false">Project Budget</a></li> 
            <li role="presentation" >
          <a href="#block" id="block-tab" role="tab" data-toggle="tab" aria-controls="block" onClick="activateChosen();" aria-expanded="false">Add Payment</a></li> 
        </ul>	
           <div id="myTabContent" class="tab-content scrollbar1" style="padding:5px;">
               ...
               <? $this->load->view("includes/flashmessage");?>
                    ...
                    <div class=" widget-shadow bs-example" data-example-id="contextual-table" > 
                        ...
                        <table class="table"> <thead> <tr> <th>Project ID</th> <th>Project Name</th>  <th>Task Name</th><th>Voucher ID</th><th style="text-align:right;">Amount </th> <th style="text-align:center;">Payment Date</th><th>Status</th><th></th></tr> </thead>
                      <? if($datalist){$c=0;
               ...
               <br>
               <? $this->load->view("re/projectpayment/newbudget");?>
               </div>
             <div role="tabpanel" class="tab-pane fade " id="block" aria-labelledby="block-tab" >
               <br>
               <? $this->load->view("re/projectpayment/newpayment");?>
               </div>
...
<form name="deletekeyform">  <input name="deletekey" id="deletekey" value="0" type="hidden">
            ...
            $("#complexConfirm").confirm({
                ...
                confirm: function(button) {
					...
					var code=1
                    window.location="<?=base_url()?>re/projectpayments/delete/"+document.deletekeyform.deletekey.value;
                },
              ...
              $("#complexConfirm_confirm").confirm({
                ...
                confirm: function(button) {
                    ...
                    window.location="<?=base_url()?>re/projectpayments/confirm/"+document.deletekeyform.deletekey.value;
                },
                cancel: function(button) {
                    button.fadeOut(2000).fadeIn(2000);
                   // alert("You aborted the operation.");
