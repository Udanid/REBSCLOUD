...
function loadcurrent_block(id)
{
 if(id!=""){
					...
					$( "#blocklist" ).load( "<?=base_url()?>re/lotdata/edit_blocklist/"+id );
	 ...
	 if(id!="")
	 {
		 ...
		 var prj_id= document.getElementById("prj_id").value
    	  ...
    	  document.getElementById("fulldata").innerHTML='<img src="<?=base_url()?>media/images/loading.gif"  class="loadinggif">'; 
		   $( "#fulldata").load( "<?=base_url()?>re/lotdata/get_fulldata/"+id+"/"+prj_id );
	 }
}
</script>
          ...
          <ul id="myTabs" class="nav nav-tabs" role="tablist"> 
           ...
           <div id="myTabContent" class="tab-content scrollbar1" style="padding:5px;">
                ...
                <div role="tabpanel" class="tab-pane fade active in" id="profile" aria-labelledby="profile-tab"> 
                       ...
                       <form data-toggle="validator" method="post" action="<?=base_url()?>re/lotdata/edit_rslot" enctype="multipart/form-data">
                       <div class="row">
