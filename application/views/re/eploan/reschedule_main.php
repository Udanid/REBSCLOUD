 ...
 <div class="main-page">
  ...
  <div class="table">
      ...
      <div class="widget-shadow">
          ...
          <li role="presentation"><a href="#profile" role="tab" onClick="chosenActivate()" id="profile-tab" data-toggle="tab" aria-controls="profile" aria-expanded="true">Request Reschedule</a></li> 
          ...
          <? $this->load->view("includes/flashmessage");?>
               ...
               <br>
                   ...
                   <div class="tableFixHead"> 
                        <table class="table"> <thead> <tr class="active"> <th>Loan Code</th><th>Article Details</th> <th>Customer Name </th><th style="text-align:right;">New Capital</th><th style="text-align:right;">Arrears Interest</th><th style="text-align:right;">New Int</th><th style="text-align:center;">Apply By </th><th>Confirm By </th><th></th></tr> </thead>
                        <tbody>
                      <? if($datalist){$c=0;
                        ...
                        <td align="right"><?=number_format($row->new_cap,2)?></td>
                         <td align="right"><?=number_format($row->arrears_int,2)?></td> 
                         <td align="right"><?=number_format($row->new_totint,2)?></td>
                             <td align="center"><?=get_user_fullname($row->apply_by)?></td>
                ...
                <div role="tabpanel" class="tab-pane fade " id="profile" aria-labelledby="profile-tab"> 
                    <p>	 
                  <?  $this->load->view("re/eploan/reschedule_new"); ?>
                   </p> 
                </div>
...
<form name="deletekeyform">  <input name="deletekey" id="deletekey" value="0" type="hidden">
            ...
            $("#complexConfirm").confirm({
                ...
                confirm: function(button) {
					...
					var code=1
                    window.location="<?=base_url()?>re/eploan/delete_reschedule/"+document.deletekeyform.deletekey.value;
                },
			 ...
			 $("#complexConfirm_advdelete").confirm({
              ...
              $("#complexConfirm_confirm").confirm({
                ...
                confirm: function(button) {
                    ...
                    window.location="<?=base_url()?>re/eploan/confirm_reshedule/"+document.deletekeyform.deletekey.value;
                },
                cancel: function(button) {
                    button.fadeOut(2000).fadeIn(2000);
                   // alert("You aborted the operation.");
