...
<div id="page-wrapper">
 <div class="main-page">
  ...
  <div class="table">
      ...
      <h3 class="title1">Easy Payment Loan</h3>
     			
      <div class="widget-shadow">
          <ul id="myTabs" class="nav nav-tabs" role="tablist"> 
           <li role="presentation" class="active">
          <a href="#home" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="false">Loan List</a></li> 
        <!--  <li role="presentation"><a href="#profile" role="tab" id="profile-tab" data-toggle="tab" aria-controls="profile" aria-expanded="true">Loan Inquiry</a></li> 
 -->       
        </ul>	
          ...
          <? $this->load->view("includes/flashmessage");?>
               ...
               <br>
                   ...
                   <div class="tableFixHead"> 
                        <table class="table"> <thead> <tr class="active"> <th>Loan Code</th><th>Land Details</th> <th>Customer Name </th><th>Agreement Date</th><th>Down Payment</th><th>Purchase Type</th><th>Create By </th><th>Confirm By </th><th></th></tr> </thead>
                         <tbody>
                      <? if($datalist){$c=0;
                        ...
                        <td scope="row"><?=$row->unique_code?></td><td> <?=$row->project_name ?>&nbsp; <?=$row->lot_number ?>-<?=$row->plan_sqid ?></td> <td> <a  href="javascript:viewCustomer('<?=$row->cus_code?>')" title="View Customer Info"><?=$row->first_name ?> <?=$row->last_name ?></a></td> <td><?=$row->start_date?></td>
                        <td align="right"><?=number_format($row->down_payment,2)?></td> 
                        <td align="right"><?=get_actual_loantype($row->loan_code)?></td>
                      ...
                      <a  href="javascript:get_repayment_shedule('<?=$row->loan_code?>')" title="Repayment Schedule"><i class="fa fa-calendar nav_icon icon_green"></i></a>
                ...
                <div role="tabpanel" class="tab-pane fade " id="profile" aria-labelledby="profile-tab"> 
                    <p>	 
                  <? // $this->load->view("re/eploan/loan_inquary"); ?>
                   </p> 
                </div>
