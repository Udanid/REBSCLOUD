...
date=document.getElementById("request_date").value
 ...
 if(id!=""){
					...
					$( "#plandata" ).load( "<?=base_url()?>re/eploan/get_rebatedata/"+id+'/'+date);
 ...
 <form data-toggle="validator" method="post" action="<?=base_url()?>re/eploan/add_rebate" enctype="multipart/form-data">
