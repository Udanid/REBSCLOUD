...
//alert(id);
         ...
         <h4>Loan Details
                                 <span style="float:right"> <a href="javascript:load_printscrean1('<?=$details->loan_code?>')"> <i class="fa fa-print nav_icon"></i></a>
<a href="javascript:get_repayment_shedule('<?=$details->loan_code?>')" title="Repayment Schedule"><i class="fa fa-calendar nav_icon "></i></a> 
<a href="javascript:get_bloackdetails('<?=$details->prj_id?>','<?=$details->lot_id?>')" title="Block Detail"><i class="fa fa-sitemap nav_icon "></i></a>
<a href="javascript:get_followuphistory('<?=$details->cus_code?>')" title="Follow Up"><i class="fa fa-phone nav_icon "></i></a><a href="javascript:closepo()"><i class="fa fa-times-circle "></i></a>
</span></h4>
 ...
 ?>  
				...
				<?  }?>
                 <h3> </h3>
                        ...
                        <tbody> <tr> 
                        <th scope="row">Customer Name</th><td> <?=$details->first_name ?> &nbsp; <?=$details->last_name ?></td><th  align="right">NIC Number</th>
                       <td> <a href="javascript:get_customer_details('<?=$details->cus_code?>','<?=$details->loan_type?>')" title="Customer Data"><?=$details->id_number ?></a></td></td> 
...
<tr><th>Paid percentage </th><td> <div class="task-info">
                        ...
                        <tr class="warning"> 
                        <th scope="row">Arrears Rental</th><td> <?=number_format($arreascap+$arreasint,2)  ?> &nbsp; </td><th  align="right">Delay Interest</th><td><?=number_format(get_loan_date_di($details->loan_code,date('Y-m-d')),2)?></td> <th  align="right">Arrears Instalments</th><td><?=round(($arreascap+$arreasint)/$details->montly_rental,2) ?></td>
                         </tr> 
                          <tr class="warning"> 
                        <th scope="row">Arrears Capital</th><td> <?=number_format($arreascap,2)  ?> &nbsp; </td><th  align="right">Arrears Interest</th><td><?=number_format($arreasint,2)?></td><th  align="right">Total Arrears Amount</th><td><?=number_format($arreascap+$arreasint+get_loan_date_di($details->loan_code,date('Y-m-d')),2)  ?></td>
                         </tr> 
