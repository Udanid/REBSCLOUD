...
<table class="table"> <thead> <tr><th>Due Date</th> <th> Instalment</th> <th>Remart</th>  <th>Monthly  Rental</th><th>Rental Payment</th><th>DI Payment</th><th>Balance</th></tr> </thead>
                      <? if($dataset){$c=0;
					  $arrtot=0;
                          foreach($dataset as $row){
							   $arrtot= $arrtot+$row->tot_instalment;
