...
<div class="row">
	<div class="widget-shadow" data-example-id="basic-forms">
         ...
         <? if($advancefollowlist){?>
           <table class="table">
       <tr>
     <th colspan="4" class="info">Followup Details</th></tr>
     <tr><td colspan="4" height="10"></td></tr>
          <tbody style="font-size:12px">
   <tr class="active"><th>Date</th><th>Action</th><th>Customer Feedback</th><th>Reservation Code</th><th>Arrears</th><th>Sales Person</th></tr>
     <? foreach($advancefollowlist as $raw){?>
     <tr>
