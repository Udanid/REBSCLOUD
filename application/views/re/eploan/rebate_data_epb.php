...
function adjust_discount()
{
	...
	//credit_tot
		...
		var total=parseFloat(document.getElementById("balance_capital").value)+parseFloat(document.getElementById("delay_int").value)-parseFloat(new_discount)
			document.getElementById("act_total").value=total.toFixed(2).replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,");
		...
		//				   echo $creditint;
						   ...
						   ?>
                             ...
                             <input type="hidden" name="balance_capital" id="balance_capital" value="<?=$balanc?>"  >
                              <input type="hidden" name="balance_int" id="balance_int" value="0"  >
                               <input type="hidden"  name="delay_int" id="delay_int"value="<?=$delaintot?>" >
                                 <input type="hidden"  name="credit_cap" id="credit_cap"value="0" >
                                   <input type="hidden"  name="credit_int" id="credit_int"value="0" >
                                     <input type="hidden"  name="credit_tot" id="credit_tot"value="0" >
                                   <input type="hidden"  name="int_paidamount" id="int_paidamount" value="0" >
                                    <input type="hidden"  name="arrears_int" id="arrears_int" value="0" >
                            		<div class="form-group">
										...
										<div class="col-sm-3 has-feedback" id="paymentdateid"><input  type="text" class="form-control" id="total"    name="total"   value="<?=number_format($totamount,2) ?>"    data-error="" required="required" readonly>
                                       ...
                                       <div class="form-group">
                                         <label class="col-sm-3 control-label"></label>
                    										...
                    										<div class="col-sm-3"><input  type="hidden" class="form-control" name="nxtarrears_int_val" id="nxtarrears_int_val"  value="<?=number_format($cal_due_arreasint_todate,2)?>"      required readonly="readonly">
                                        </div>
                                        </div>
                                           <div id="loandetails1" >
                    ...
                    < ? }?>
                                     ...
                                     <div class="form-group ">
										...
										<div class="col-sm-3"><input  type="number" class="form-control" name="int_paidrate" id="int_paidrate" max="100"  required value="100" style="display:none">
                                     </div>
										...
										<div class="col-sm-3 has-feedback" id="paymentdateid"><input  type="text" class="form-control number-separator" id="new_discount"    name="new_discount"   value="0"    data-error=""  onchange="adjust_discount()" required="required"  step="0.01">
										<span class="glyphicon form-control-feedback" aria-hidden="true"></span>
										<span class="help-block with-errors" ></span></div>
                                     		</div>
                                            ...
                                            <div class="form-group ">
                                             <label class="col-sm-3 control-label">Actual Payable Amount</label>
										<div class="col-sm-3 has-feedback" id="paymentdateid"><input  type="text" class="form-control" id="act_total"    name="act_total"   value="<?=number_format($totamount,2) ?>"    data-error="" required="required" readonly>
										<span class="glyphicon form-control-feedback" aria-hidden="true"></span>
										<span class="help-block with-errors" ></span></div>
