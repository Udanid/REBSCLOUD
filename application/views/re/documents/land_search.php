...
function loadcurrent_land(id)
{
 ...
 if(id!=""){
					...
					$( "#landpanel" ).load( "<?=base_url()?>re/documents/land_docs/"+id );
 ...
 <form data-toggle="validator" method="post" action="<?=base_url()?>re/documents/update_landdoc" enctype="multipart/form-data">
