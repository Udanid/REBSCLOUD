                       ...
                       <input type="hidden" name="id" id="id" value="<?=$deed_data->id?>">
                         <input type="hidden" name="old_Affidavit" id="old_Affidavit" value="<?=$deed_data->Affidavit?>">
                          ...
                          <div class="form-group "><label class="col-sm-3 control-label">Outside Lawyer</label>
										<div class="col-sm-8   has-feedback "><input type="checkbox" value="YES" <? if($deed_data->outside_lawyer=='YES'){?> checked="checked"<? }?>  class="form-control"  id="outside_lawyer" name="outside_lawyer" />
