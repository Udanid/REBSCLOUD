                ...
                <div class="form-inline">
                  <div class="form-group"><label >2nd Introducer Name</label>
                    ...
                    <? }?>
										...
										<input type="text" class="form-control" value="<?=$details->intro_date?>" name="intro_date"  autocomplete="off" id="intro_date" placeholder="Introduced Date" required>
									</div></div>
                                     <div class="clearfix"> </div><br>
						...
						<div class="col-md-6 validation-grids validation-grids-right">
							<div class="widget-shadow" data-example-id="basic-forms">
								...
								<div class="form-body">
                                   ...
                                   <input  type="text"  pattern="[0-9]+([\.][0-9]{0,2})?"   value="<?=$details->perch_price?>" class="form-control number-separator"  onBlur="calculate_tot(this.value)"  id="perch_price" name="perch_price"  placeholder="Perch Price"   required>
...
<tr><td><div class="form-group has-feedback"><label >Postal Code</label>
										<input type="text" class="form-control" id="company_code" name="company_code" value="<?=$details->company_code?>"  placeholder="Postal Code" data-error=""  required>
										<span class="glyphicon form-control-feedback" aria-hidden="true"></span>
										<span class="help-block with-errors" ></span>
									</div></td></tr>
                        <tr>
