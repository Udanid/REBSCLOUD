...
jQuery(document).ready(function() {
 ...
 setTimeout(function(){
	...
	$("#town").chosen({
 	...
 	$("#town").chosen().change(function() {
    	var town = $(this).val();
		$.ajax({
			cache: false,
			type: 'POST',
			url: '<?php echo base_url().'re/land/get_postal_code';?>',
			data: {town: town},
		...
		$.ajax({
            ...
            success: function(data) {
				...
				else
				{
					...
					$( "#popupform" ).load( "<?=base_url()?>re/land/edit/"+id );
				}
            }
        });
}
...
{
	$('#popupform').delay(1).fadeIn(600);
	$( "#popupform" ).load( "<?=base_url()?>re/land/comments/"+id );
}
...
function view_confirm(id){
	$('#popupform').delay(1).fadeIn(600);
	$( "#popupform" ).load( "<?=base_url()?>re/land/view/"+id );
}
...
function loadcurrent_search_land(id)
{
  //alert(id)
 if(id!=""){
     ...
     $('#plandata').delay(1).fadeIn(600);
             ...
             $('#land_data_search').delay(1).fadeIn(600);
                  document.getElementById("land_data_search").innerHTML='<img src="<?=base_url()?>media/images/loading.gif"  class="loadinggif">';
          $( "#land_data_search" ).load( "<?=base_url()?>re/land/seach_land_data/"+id );
...
<?
if(!check_access('add_land'))$tab='list';
?>
      <h3 class="title1">Land Details</h3>

      <div class="widget-shadow">
          <ul id="myTabs" class="nav nav-tabs" role="tablist">
           <? if(check_access('add_land')){?>  <li role="presentation"    <? if($tab==''){?> class="active" <? }?>><a href="#profile" role="tab" id="profile-tab" data-toggle="tab" aria-controls="profile" aria-expanded="true">Add New land</a></li>
           ...
           <div id="myTabContent" class="tab-content scrollbar1" style="padding:5px;">
              ...
              <? if($this->session->flashdata('msg')){?>
               ...
               <div class="alert alert-danger" role="alert">
                    ...
                    <div class=" widget-shadow bs-example" data-example-id="contextual-table" >
                         <div class="form-body form-horizontal">
                          ...
                          <div class="col-sm-3 ">  <select class="form-control" placeholder="Qick Search.."  onchange="loadcurrent_search_land(this.value)" id="land_search" name="land_search" >
                    <option value=""></option>
                    <?   foreach($datalist as $row){?>
                    <option value="<?=$row->land_code?>"><?=$row->property_name?></option>
                    <? }?>

          </select> </div>
                          </div></div>
                          <div id="land_data_search">
               ...
               <div class="alert alert-danger" role="alert">
                       ...
                       <form data-toggle="validator" method="post" action="<?=base_url()?>re/land/add" enctype="multipart/form-data">
                        ...
                        <div class="row">
							...
							<div class="form-body">
								<div class="form-inline">
									<div class="form-group">
																		<select name="intro_code" id="intro_code" class="form-control" placeholder="Introducer">
								...
								<div class="form-inline">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="intro_date" id="intro_date" placeholder="Introduced Date" autocomplete="off">
									</div></div> <div class="clearfix"> </div><br>
                    ...
                    <button class="add_ol_subject_button btn btn-success" style="margin-top:-10px;">(+) Add </button></span>
							...
							<div class="form-body">
                                    <div class="form-group">
										<select name="district" id="district" class="form-control"  data-error=""  >
                    ...
                    <? }?>
                                    ...
                                    <select name="procouncil" id="procouncil" class="form-control"   data-error="" >
                    ...
                    <? }?>
                                    ...
                                    <select name="town" id="town" class="form-control"   data-error="" >
                    ...
                    <? }?>
 								...
 								<div class="form-group has-feedback">
										<input type="text" class="form-control" id="company_code" name="company_code"  placeholder="Postal Code" data-error=""  >
										<span class="glyphicon form-control-feedback" aria-hidden="true"></span>
										<span class="help-block with-errors" ></span>
									</div>
                                      <div class="form-group has-feedback">
								...
								<div class="form-inline">
                                   ...
                                   <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                    ...
                                    <div class="clearfix"> </div><div class="clearfix"> </div><br>
                                    	<div class="form-inline">
									<div class="form-group has-feedback" >
                                   <input  type="text"  pattern="[0-9]+([\.][0-9]{0,2})?"  class="form-control number-separator"  onBlur="calculate_tot(this.value)"  id="perch_price" name="perch_price"  placeholder="Perch Price"   required>
										  <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                    ...
                    <button class="add_al_subject_button btn btn-success" style="margin-top:-10px;">(+) Add </button></span></h4>
							...
							<div class="form-body">
                                    ...
                                    <div class="form-inline">
									<div class="form-group has-feedback" >
                                   <input type="text" class="form-control" id="plan_no" name="plan_no"  placeholder="Plan Number"   ><span class="glyphicon form-control-feedback" aria-hidden="true"></span>


										<input type="text" class="form-control" name="deed_no" id="deed_no"   placeholder="Deed Number" data-error="" ><span class="glyphicon form-control-feedback" aria-hidden="true"></span>

									</div></div><br>
                                         <div class="form-inline">
									<div class="form-group has-feedback" >
                                   <input type="text" class="form-control" id="drawn_by" name="drawn_by"  placeholder="Drawn By"   ><span class="glyphicon form-control-feedback" aria-hidden="true"></span>


										<input type="text" class="form-control" name="drawn_date" id="drawn_date"   placeholder="Drawn Date"  autocomplete="off" data-error="" ><span class="glyphicon form-control-feedback" aria-hidden="true"></span>

									</div></div><br>
                                       <div class="form-inline">
									<div class="form-group has-feedback" >
                                   <input type="text" class="form-control" id="attest_by" name="attest_by"  placeholder="Attest By"   ><span class="glyphicon form-control-feedback" aria-hidden="true"></span>


										<input type="text" class="form-control" name="attest_date" id="attest_date"   placeholder="Attest Date"  autocomplete="off" data-error="" ><span class="glyphicon form-control-feedback" aria-hidden="true"></span>
...
<form name="deletekeyform">  <input name="deletekey" id="deletekey" value="0" type="hidden">
            ...
            $("#complexConfirm").confirm({
                ...
                confirm: function(button) {
					...
					var code=1
                    window.location="<?=base_url()?>re/land/delete/"+document.deletekeyform.deletekey.value;
                },
              ...
              $("#complexConfirm_confirm").confirm({
                ...
                confirm: function(button) {
                    ...
                    window.location="<?=base_url()?>re/land/confirm/"+document.deletekeyform.deletekey.value;
                },
                cancel: function(button) {
                    button.fadeOut(2000).fadeIn(2000);
                   // alert("You aborted the operation.");
