...
function  calculate_tot(val)
{
	...
	var unselabletot=parseFloat(document.getElementById('road_ways').value)+parseFloat(document.getElementById('other_res').value)+parseFloat(document.getElementById('open_space').value);
		...
		document.getElementById('unselable_area').value=unselabletot;
 ...
 <div class="main-page">
  ...
  <div class="table">
      ...
      <div class="widget-shadow">
          ...
          <a href="#price" id="price-tab" role="tab" data-toggle="tab" aria-controls="price" aria-expanded="false">Perch Prices</a></li> 
               ...
               <div role="tabpanel" class="tab-pane fade <? if($this->session->flashdata('tab')=='value'){?> active in<? }?>" id="value" aria-labelledby="value-tab" >
                 <? $this->load->view("re/feasibility/value_items");?>
                  ...
                  <div role="tabpanel" class="tab-pane fade<? if($this->session->flashdata('tab')=='budget'){?> active in<? }?>" id="budget" aria-labelledby="budget-tab"> 
                    <p>	 <? $this->load->view("re/feasibility/project_budjet");?> </p> 
                </div>
