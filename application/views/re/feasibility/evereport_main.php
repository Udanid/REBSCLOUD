...
$projectcostfinance=$totdpcost-$costofcapital;//cost with taxes
    //Ticket No-2902 | Added By Uvini
    

		$totcost_with_finance=$totdpcost;//cost with taxes and finance cost
...
$reprofitafterfin= $profitbeforcost-$costofcapital;
 ...
 ?>
  ...
  <? if (check_access('check_report'))
		{?>
        <a href="<?=base_url()?>re/feasibility/checked/<?=$details->prj_id?>"><span class="label label-info">Checked</span></a>
  <? }?>
...
<div class="row">
   <div class="col-md-12   widget-shadow" data-example-id="basic-forms"> 
		<div class="form-title">
			<h4 style="background-color:none;">Overall Project (Feasibility Budget)
            </h4>
		</div>
        <div class="form-body">
<? 
...
$roi=($profitbeforcost-$costofcapital)/$totdpcost*100;
//echo $newprofitaf;
...
<div class="row">
  ...
  <div class="widget-shadow" data-example-id="basic-forms"> 
		<div class="form-title">
			<h4 style="background-color:none;">Return On Investment <span  style="float:right"><?=number_format($roi,2)?>%</span></h4>
		</div>
        <div class="table">
            ...
            $("#complexConfirm").confirm({
              ...
              $("#complexConfirm_confirm").confirm({
                ...
                confirm: function(button) {
                    ...
                    window.location="<?=base_url()?>re/feasibility/confirm/"+document.deletekeyform.deletekey.value;
                },
                cancel: function(button) {
                    button.fadeOut(2000).fadeIn(2000);
                   // alert("You aborted the operation.");
