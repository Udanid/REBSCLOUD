...
{
			window.open( "<?=base_url()?>re/feasibility/print_report/"+id);
	
}
function load_pdf(id)
{
			window.open( "<?=base_url()?>re/feasibility/load_pdf/"+id);
	
}
function load_excel(id)
{
			window.open( "<?=base_url()?>re/feasibility/load_excel/"+id);
      ...
      <div class="widget-shadow">
		...
		<h4 class="mytopic"> Project Name : <?=$details->project_name?>
        	<span  class="myright"><?=$details->branch_code?> - <?=$details->branch_name?></span>
             ...
             <a target="_blank" href="<?=base_url()?>re/feasibility/print_feasibility_report/<?=$this->encryption->encode($details->prj_id)?>">  <i class="fa fa-file-text-o nav_icon green-400"></i></a>
            <!-- <a href="javascript:load_pdf('<?=$this->encryption->encode($details->prj_id)?>')">  <i class="fa fa-print nav_icon"></i></a>-->
