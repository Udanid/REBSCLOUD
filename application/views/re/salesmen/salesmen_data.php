...
//alert(id);
	   ...
	   else
	   {
		$.ajax({
            cache: false,
            type: 'GET',
            url: '<?php echo base_url().'re/salesmen/check_thisid/';?>',
            ...
            success: function(data) {
				...
				else
				{
					...
					$("#datatable").load( "<?=base_url()?>re/salesmen/add/"+prj_id+"/"+officerid );
				}
            }
        });
	   }
...
//alert(id);
		...
		$.ajax({
            ...
            data: {table: 're_salesman', id: id,fieldname:'id' },
            success: function(data) {
                if (data) {
...
<form name="deletekeyform">  <input name="deletekey" id="deletekey" value="0" type="hidden">
            ...
            $("#complexConfirm").confirm({
                ...
                confirm: function(button) {
					...
					var code=1
                    window.location="<?=base_url()?>re/salesmen/delete/"+document.deletekeyform.deletekey.value;
                },
              ...
              $("#complexConfirm_confirm").confirm({
                ...
                confirm: function(button) {
                    ...
                    window.location="<?=base_url()?>re/salesmen/confirm/"+document.deletekeyform.deletekey.value;
                },
                cancel: function(button) {
                    button.fadeOut(2000).fadeIn(2000);
                   // alert("You aborted the operation.");
