...
<div class="table widget-shadow">
 <div class="row">
                     <form data-toggle="validator" method="post" action="<?=base_url()?>re/introducer/editdata" enctype="multipart/form-data">
                        <div class="row">
							...
							<div class="form-body">
								<div class="form-inline"> 
                                    ...
                                    <div class="form-group">
										<div class="radio">
											<label>
											  <input type="radio" name="idtype" value="NIC"   <? if($details->id_type=='NIC'){?> checked="checked"<? }?>>
											  NIC
											</label>
										</div>
										<div class="radio">
											<label>
											<input type="radio"  name="idtype" value="Passport"  <? if($details->id_type=='Passport'){?> checked="checked"<? }?> >
											Passport
											</label>
										</div>
									</div>
                                    <div class="form-group has-feedback">
										<input type="text" class="form-control"name="id_number" id="id_number"   value="<?=$details->id_number?>"  placeholder="NIC Passport Number"  	 data-error="Please Enter Valid NIC Number" onChange="check_is_exsit(this)" >
										<span class="glyphicon form-control-feedback" aria-hidden="true"></span>
