       ...
       <span style="float:right"> <a href="javascript:expoet_excel()"> <i class="fa fa-file-excel-o nav_icon"></i></a>
              ...
              <BR>
                 ...
                 <div class="tableFixHead">
                        <table class="table">  <thead> <tr class="active"> <th>Reservation Code</th><th>Branch Name</th><th>Project Name</th><th>Lot Number</th> <th>Customer Name </th><th>Down Payment</th><th>Repay Amount</th></tr> </thead><tbody>
                      <?  $prjpaid=0;$prjbmdp=0;
					 $brnpaid=0;$brnbmdp=0;
					  $prj_id=''; $brid='';
