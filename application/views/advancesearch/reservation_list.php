       ...
       <span style="float:right"> <a href="javascript:expoet_excel()"> <i class="fa fa-file-excel-o nav_icon"></i></a>
              ...
              <BR>
                 ...
                 <div class="tableFixHead">
                        <table class="table"> <thead> <tr class="active"> <th>Reservation Code</th><th>Branch Name</th><th>Project Name</th><th>Lot Number</th> <th>Customer Name </th><th>Reserve Date</th><th>Estimated Price</th><th>Discount</th><th>Sale Value</th><th>MDP</th><th>Paid Amount</th><th>BMDP</th></tr> </thead> <tbody>
                      ...
                      <?  $brnes=0;$brndis=0;$brnsale=0; $brnmdp=0;$brnpaid=0;$brnbmdp=0;
                       ...
                       <tr > 
                        ...
                        <td align="right"><?=number_format($row->min_down-$row->down_payment,2)?></td>
                         </tr> 
