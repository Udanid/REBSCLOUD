...
$b=$b.'
                        ...
                        <table  border="1" > <thead> <tr bgcolor="#d5dace"> <th>Reservation Code</th><th>Branch Name</th><th>Project Name</th><th>Lot Number</th><th>Extent of lots</th> <th>Customer Name </th><th>Reserve Date</th><th>Estimated Price</th><th>Discount</th><th>Sale Value</th><th>MDP</th><th>Paid Amount</th><th>Balance Amount</th></tr> </thead>';
                    $prjes=0;$prjdis=0;$prjsale=0; $prjmdp=0;$prjpaid=0;$prjbmdp=0;
                      ...
                      $b=$b.' <tr bgcolor="#b0d2fc" style="font-weight:bold">';
                       $b=$b.' <td scope="row" colspan="7">Project Total</td>';
                      ...
                      $prjes=0;$prjdis=0;$prjsale=0; $prjmdp=0;$prjpaid=0;$prjbmdp=0;
                       ...
                       $b=$b.' <td scope="row" colspan="7">Branch Total</td>';
                      ...
                      $b=$b.'  <td align="right">'.number_format($row->down_payment+$loancapital,2).'</td>';
