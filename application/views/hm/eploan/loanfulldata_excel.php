             ...
             $b=$b.'   </tr>';
				...
				$b=$b.'</table>';
				   ...
				   if($rebate)
					   ...
					   <tr   bgcolor="#cfd0d0"><th>Instalment</th><th>Rental</th><th>Due Date</th><th>Delay Interest</th><th> Paid Capital</th><th> Paid Interest</th><th>Balance Capital</th><th> Balance Interest</th><th>Payment Date</th><th>Receipt No </th></tr>';
                     $b=$b.'  <tr>';
                     $b=$b.'  <td>Early Settlment</td><td>-</td><td>-</td><td>-</td><td>'.number_format($rebate->balance_capital ,2).'</td>';
