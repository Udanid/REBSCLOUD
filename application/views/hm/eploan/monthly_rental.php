	 ...
	 if(id!="")
	 {
		var paydate=document.getElementById("paydate").value;
    	  ...
    	  document.getElementById("fulldata").innerHTML='<img src="<?=base_url()?>media/images/loading.gif"  class="loadinggif">'; 
		   $( "#fulldata").load( "<?=base_url()?>hm/eploan/get_rentalpaydata/"+id+"/"+paydate);
	 }
}
...
function call_delete_follow(id)
{
	...
	$.ajax({
            ...
            type: 'GET',
            url: '<?php echo base_url().'common/activeflag_cheker/';?>',
            data: {table: 'hm_epfollowups', id: id,fieldname:'id' },
            success: function(data) {
                if (data) {
					// alert(data);
					  document.getElementById("checkflagmessage").innerHTML=data; 
...
<div id="page-wrapper">
 <div class="main-page">
  ...
  <div class="table">
      ...
      <h3 class="title1">Rental Payments</h3>
           ...
           <div id="myTabContent" class="tab-content scrollbar1" style="padding:5px;">
            ...
            <? $this->load->view("includes/flashmessage");?>
                ...
                <div role="tabpanel" class="tab-pane fade <? if(!$this->session->flashdata('tab')){?>active in<? }?>" id="profile" aria-labelledby="profile-tab"> 
                       ...
                       <form data-toggle="validator" method="post" action="<?=base_url()?>hm/eploan/pay_rental" enctype="multipart/form-data">
                       <div class="row">
                    ...
                    <? }?>
										...
										<div class="col-sm-3 has-feedback" id="paymentdateid"><input  type="text" class="form-control" id="paydate"    name="paydate"  value="<?=date("Y-m-d")?>"   data-error="" required onChange="load_detailsagain()" >
                    ...
                    <?   $this->load->view("hm/eploan/payment_history"); ?>
                    </div>
                    ...
                    <? // $this->load->view("hm/eploan/followup_index"); ?>
                    </div>
...
<form name="deletekeyform">  <input name="deletekey" id="deletekey" value="0" type="hidden">
            ...
            $("#complexConfirm").confirm({
                ...
                confirm: function(button) {
					...
					var code=1
                    window.location="<?=base_url()?>hm/eploan/delete_feedback/"+document.deletekeyform.deletekey.value;
                },
