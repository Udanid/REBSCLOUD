...
<div class="row">
 ...
 <h4>Repayment Schedule of <?=$details->unique_code ?> <span  style="float:right; color:#FFF" ><a href="javascript:closepo()"><i class="fa fa-times-circle "></i></a><a href="javascript:load_printscrean1('<?=$details->loan_code ?>')"><i class="fa fa-print nav_icon"></i></a></span></h4>
