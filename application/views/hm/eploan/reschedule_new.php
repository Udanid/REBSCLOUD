...
function loan_fulldata(id)
{
 ...
 if(id!=""){
					...
					$( "#plandata" ).load( "<?=base_url()?>hm/eploan/get_reschdata/"+id );
 ...
 <form data-toggle="validator" method="post" action="<?=base_url()?>hm/eploan/add_reschedule" enctype="multipart/form-data">
