...
function loan_fulldata(id)
{
 ...
 if(id!=""){
					...
					$( "#plandata" ).load( "<?=base_url()?>hm/eploan/get_resaledata/"+id );
 ...
 <form data-toggle="validator" method="post" action="<?=base_url()?>hm/eploan/add_resale" enctype="multipart/form-data">
