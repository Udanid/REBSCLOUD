...
//alert(id);
		...
		$.ajax({
            ...
            data: {table: 'hm_introducerms', id: id,fieldname:'intro_code' },
            success: function(data) {
				...
				else
				{
					...
					$( "#popupform" ).load( "<?=base_url()?>hm/introducer/edit/"+id );
				}
            }
        });
}
           ...
           <div id="myTabContent" class="tab-content scrollbar1" style="padding:5px;">
              ...
              <? if($this->session->flashdata('msg')){?>
               ...
               <div class="alert alert-danger" role="alert">
                       ...
                       <form data-toggle="validator" method="post" action="<?=base_url()?>hm/introducer/add" enctype="multipart/form-data">
                        <div class="row">
...
<form name="deletekeyform">  <input name="deletekey" id="deletekey" value="0" type="hidden">
            ...
            $("#complexConfirm").confirm({
                ...
                confirm: function(button) {
					...
					var code=1
                    window.location="<?=base_url()?>hm/introducer/delete/"+document.deletekeyform.deletekey.value;
                },
              ...
              $("#complexConfirm_confirm").confirm({
                ...
                confirm: function(button) {
                    ...
                    window.location="<?=base_url()?>hm/introducer/confirm/"+document.deletekeyform.deletekey.value;
                },
                cancel: function(button) {
                    button.fadeOut(2000).fadeIn(2000);
                   // alert("You aborted the operation.");
