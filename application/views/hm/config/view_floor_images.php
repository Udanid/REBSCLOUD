...
<div class="col-md-6 validation-grids validation-grids-right">
               ...
               <?
                  ...
                  if($floorimgs){
                   ...
                   foreach($floorimgs as $flimg){
                    ...
                    <span id="oldfiles<?=$i?>"><a href="<?=base_url()?>uploads/floor_img/<?=$flimg->floor_image?>"><img src="<?=base_url()?>uploads/floor_img/thumbnail/<?=$flimg->floor_image?>" /></a></span>
           ...
           <!-- ...................................add multiple floor rooms......................................-->
              ...
              <div class="col-md-12" data-example-id="basic-forms">
               <h4>Floor Rooms:<span  style="float:right"></h4>
                 <?
                    if($floorroomslist){?>
                      <table class="table">
                        <tr>
