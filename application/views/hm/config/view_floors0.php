...
$('#formcount').val(1);
var ol_max_subjects = 100; //maximum input boxes allowed
  var ol_wrapper = $(".rooms_table"); //Fields wrapper
  var ol_add_button = $(".add_rooms_button"); //Add button ID

  var olCount = 1; //initlal text box count
  $(ol_add_button).click(function(e){ //on add input button click
    e.preventDefault();
    if(olCount < ol_max_subjects){
      var new_count=olCount+1;
      $(ol_wrapper).append('<tr><th>'+new_count+'</th><th>\
                    <select id="froomtypes" name="floorroom['+olCount+'][froomtypes]" class="form-control" required>\
                      ...
                      ?></select></th>\
                      <th><input type="text" name="floorroom['+olCount+'][ftotext]" id="ftotext" class="form-control" required>\
                      </th>\
                    <th><input type="text" name="floorroom['+olCount+'][fwidth]" id="fwidth" class="form-control" required>\
                    </th>\
                    <th><input type="text" name="floorroom['+olCount+'][fheight]" id="fheight" class="form-control" required>\
                    </th>\
                    <th><input type="text" name="floorroom['+olCount+'][flenght]" id="flenght" class="form-control" required>\
                    </th>\
                    <th><input type="text" name="floorroom['+olCount+'][fdoors]" id="fdoors" class="form-control" required>\
                    </th>\
                    <th><input type="text" name="floorroom['+olCount+'][fwindows]" id="fwindows" class="form-control" required>\
                    </th>\
                    <th><a href="#" class="remove_field btn btn-danger">Remove</a>\
                    </th>'); //add input box
...
<?=$this->session->flashdata('error')?>
                    ...
                    <div class=" widget-shadow bs-example" data-example-id="contextual-table" >
                        ...
                        <tbody> <tr class="<? echo ($c<0) ? 0 : ($c++ % 2 == 1) ? 'info' : ''; ?>">
                            <th scope="row"><?=$fl->floor_id?></th>
                            <td><?=$fl->design_name?></td>
                            <td><?=$fl->floor_name?></td>
                            <td><?=$fl->num_of_bedrooms?></td>
                            <td><?=$fl->num_of_bathrooms?></td>
                            <td><?=$fl->tot_ext?></td>
                            <td align="right"><div id="checherflag">
                        <? $chkimgexist=chkimgexist('hm_config_floorimg',$fl->floor_id,'floor_id');
                          if($chkimgexist){      ?>
...
<div class="col-md-12 ">
            ...
            <div class="form-title">
              ...
              <span  style="float:right">
                <button class="add_rooms_button btn btn-success" style="margin-top:-10px;">(+) Add </button></span></h4>
            </div>
            <table class="table rooms_table" border="1">
              <tr>
                <td>No</td>
                <td>Room Type</td>
                <td>Total Extend</td>
              ...
              <tr>
                <th>1</th>
                <th><select id="froomtypes" name="floorroom[0][froomtypes]" class="form-control" required>
                  <option value="">Select Room Type</option>
                  <?
                  if($roomtypelist)
                  {
                ...
                <th><input type="text" name="floorroom[0][ftotext]" id="ftotext" class="form-control" required></th>
                <th><input type="text" name="floorroom[0][fwidth]" id="fwidth" class="form-control" required></th>
                <th><input type="text" name="floorroom[0][fheight]" id="fheight" class="form-control" required></th>
                <th><input type="text" name="floorroom[0][flenght]" id="flenght" class="form-control" required></th>
                <th><input type="text" name="floorroom[0][fdoors]" id="fdoors" class="form-control" required></th>
                <th><input type="text" name="floorroom[0][fwindows]" id="fwindows" class="form-control" required></th>
              </tr>
            </table>
