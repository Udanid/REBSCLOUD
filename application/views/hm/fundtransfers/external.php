...
function load_external(id)
{
 ...
 if(id!=""){
					...
					$( "#totask_ex" ).load( "<?=base_url()?>hm/fundtransfers/get_tasklist/"+id );
 ...
 <form data-toggle="validator" method="post" action="<?=base_url()?>hm/fundtransfers/add_external" enctype="multipart/form-data">
