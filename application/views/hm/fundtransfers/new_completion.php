...
function load_external(id)
{
 ...
 if(id!=""){
					 ...
					 $('#plandata_ex').delay(1).fadeIn(600);
							...
							//	alert("<?=base_url()?>hm/fundtransfers/get_complete_tasklist/"+id )
					$( "#plandata_ex" ).load( "<?=base_url()?>hm/fundtransfers/get_complete_tasklist/"+id );
 ...
 <form data-toggle="validator" method="post" action="<?=base_url()?>hm/fundtransfers/add_completion" enctype="multipart/form-data">
