...
<div class="row">
   ...
   <div class="form-title">
       ...
       <a href="javascript:load_printscrean2('<?=$branchid?>','02','<?=$fromdate?>','<?=$todate?>')"> <i class="fa fa-file-excel-o nav_icon"></i></a>
       <? }else{?>
          <a href="javascript:load_printscrean1('<?=$branchid?>','02','<?=$month?>')"><i class="fa fa-file-excel-o nav_icon"></i></a>
     ...
     <div class="table-responsive bs-example widget-shadow"   style="max-height:300px; overflow:scroll" >
      ...
      <table class="table table-bordered"><tr class="success"><th  rowspan="2">Project Name</th><th  rowspan="2">Loan Code</th><th rowspan="2" >Lot Number</th><th rowspan="2" >Monthly rental</th>
