 ...
 $b='';
  ...
  $b=$b.' 
     ...
     <th>No</th><th>Officer Name</th><th>Project</th><th>Target</th><th>Actual</th><th>Variance</th>
   </tr>';
       ...
       $fulltot=0; $Currentofficercode=''; $otarget=0; $oactual=0; $tottarget=0; $totactual=0; $totcode=''; $branch_code='';$brtarget=0; $bractual=0;
	    ...
	    if($prjlist){foreach($prjlist  as $prraw){
          ...
          $b=$b.' <tr  bgcolor="#daf3ab" style="font-weight:bold"><td colspan="3">Total</td>';
         ...
         $b=$b.'   <tr  bgcolor="#f7c4f0" style="font-weight:bold"><td colspan="3">'.get_branch_name($branch_code).'Branch Total</td>
    ...
    $b=$b.'<tr><td></td><td></td><td>'.$prraw->project_name.'</td><td align="right">'.number_format($target[$prraw->prj_id],2).'</td><td align="right">'.number_format($actual,2).'</td> <td align="right">'.number_format($target[$prraw->prj_id]-$actual,2).'</td></tr>';
