...
function load_fulldetails()
{
	...
	// alert(month)
	if(month!='')
	 { //alert("<?=base_url()?>hm/report/arrears_data/"+month+'/'+branchid+'/'+year)
			 $('#fulldata').delay(1).fadeIn(600);
    		  document.getElementById("fulldata").innerHTML='<img src="<?=base_url()?>media/images/loading.gif"  class="loadinggif">'; 
		 	  $( "#fulldata").load( "<?=base_url()?>hm/report/arrears_data/"+month+'/'+branchid+'/'+year);
    ...
    else if(todate!='')
            {
			 ...
			 $('#fulldata').delay(1).fadeIn(600);
    		  document.getElementById("fulldata").innerHTML='<img src="<?=base_url()?>media/images/loading.gif"  class="loadinggif">'; 
		 	  $( "#fulldata").load( "<?=base_url()?>hm/report/arrears_data_date/"+todate+'/'+branchid);
            
            }
	  else
	  { 
		   document.getElementById("checkflagmessage").innerHTML='Please Select Month or Date to generate report'; 
		   $('#flagchertbtn').click(); 
