...
function load_fulldetails()
{
	...
	if(month!='')
	{
	  if(collection=='01')
	  {
			...
			//alert( "<?=base_url()?>hm/summeryreport/collection_summery/"+year+'/'+branchid+'/'+month);
				  $( "#fulldata").load( "<?=base_url()?>hm/summeryreport/collection_summery/"+year+'/'+branchid+'/'+month);
	  ...
	  else if(collection=='02')
	  {
		   $('#fulldata').delay(1).fadeIn(600);
    		  document.getElementById("fulldata").innerHTML='<img src="<?=base_url()?>media/images/loading.gif"  class="loadinggif">'; 				
			// alert( "<?=base_url()?>hm/summeryreport/balance_summery/"+year+'/'+branchid+'/'+month);
				  $( "#fulldata").load( "<?=base_url()?>hm/summeryreport/balance_summery/"+year+'/'+branchid+'/'+month);
	  }
	  else
	  { 
