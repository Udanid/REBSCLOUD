		 ...
		 prj_id=0;
		   if (fromdate!='' & todate!=''){
    		  ...
    		  document.getElementById("fulldata").innerHTML='<img src="<?=base_url()?>media/images/loading.gif"  class="loadinggif">'; 				
		 	  ...
		 	  $( "#fulldata").load( "<?=base_url()?>hm/report_daterange/get_profits_all/"+branchid+'/'+prj_id+'/'+fromdate+'/'+todate);
			  }
			  else if(month!='')
			  {
				   $('#fulldata').delay(1).fadeIn(600);
    		  document.getElementById("fulldata").innerHTML='<img src="<?=base_url()?>media/images/loading.gif"  class="loadinggif">'; 				
			   $( "#fulldata").load( "<?=base_url()?>hm/report/get_profits_all/"+branchid+'/'+prj_id+'/'+month);
			  }
			  else{
