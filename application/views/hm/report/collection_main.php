		  ...
		  if(collection=='01' || collection=='02' ||  collection=='03' ||  collection=='04')
			{
				 if(prj_id!="")
				 {
					 ...
					 $('#fulldata').delay(1).fadeIn(600);
					  document.getElementById("fulldata").innerHTML='<img src="<?=base_url()?>media/images/loading.gif"  class="loadinggif">'; 				if(fromdate!='' & todate!='')
					  {
					  $( "#fulldata").load( "<?=base_url()?>hm/report_daterange/get_collection/"+prj_id+'/'+collection+'/'+fromdate+'/'+todate);
					  }
					  else
					  {
						  $( "#fulldata").load( "<?=base_url()?>hm/report/get_collection/"+prj_id+'/'+collection+'/'+month);
					  }
				...
				// alert(collection)
				  $('#fulldata').delay(1).fadeIn(600);
					  document.getElementById("fulldata").innerHTML='<img src="<?=base_url()?>media/images/loading.gif"  class="loadinggif">'; 				
						if(fromdate!='' & todate!='')
					  {
						 // alert("<?=base_url()?>hm/report_daterange/get_collection_all/"+branchid+'/'+collection+'/'+fromdate+'/'+todate);
					  $( "#fulldata").load( "<?=base_url()?>hm/report_daterange/get_collection_all/"+branchid+'/'+collection+'/'+fromdate+'/'+todate);
					  }
					  else
					  {
						   $( "#fulldata").load( "<?=base_url()?>hm/report/get_collection_all/"+branchid+'/'+collection+'/'+month);
					  }
			  ...
			  if(fromdate!='' & todate!='')
				  {
					    ...
					    $( "#fulldata").load( "<?=base_url()?>hm/report_daterange/collection_details/"+branchid+'/'+collection+'/'+fromdate+'/'+todate+'/'+prj_id);
