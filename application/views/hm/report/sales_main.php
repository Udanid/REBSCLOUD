		...
		{ 
			 $('#fulldata').delay(1).fadeIn(600);
    		  document.getElementById("fulldata").innerHTML='<img src="<?=base_url()?>media/images/loading.gif"  class="loadinggif">'; 
				  ...
				  if(month!="")
				  $( "#fulldata").load( "<?=base_url()?>hm/report/get_forcast_report/"+branchid+'/'+month+'/'+year);
				  else
				  {
		 ...
		 if(code=='02'){
			// var prj_id= document.getElementById("prj_id").value;
    		  ...
    		  document.getElementById("fulldata").innerHTML='<img src="<?=base_url()?>media/images/loading.gif"  class="loadinggif">'; 
			   ...
			   if(fromdate!='' & todate!='')
			  {
		 	  $( "#fulldata").load( "<?=base_url()?>hm/report_daterange/get_posummery/"+branchid+'/'+fromdate+'/'+todate);
			  }
			  else
			  {
				  if(month!="")
					$( "#fulldata").load( "<?=base_url()?>hm/report/get_posummery/"+branchid+'/'+month+'/'+year);
			   else
				  {
