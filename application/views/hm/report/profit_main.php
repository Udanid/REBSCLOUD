	 ...
	 if(prj_id!="")
	 {
		 ...
		 {//
    		  ...
    		  document.getElementById("fulldata").innerHTML='<img src="<?=base_url()?>media/images/loading.gif"  class="loadinggif">'; 
		 	  $( "#fulldata").load( "<?=base_url()?>hm/report/get_profit_month_project/"+branchid+'/'+prj_id+'/'+month);
	 	}
		else if (fromdate!='' & todate!='')
		{// alert('block_val')
			 $('#fulldata').delay(1).fadeIn(600);
    		  document.getElementById("fulldata").innerHTML='<img src="<?=base_url()?>media/images/loading.gif"  class="loadinggif">'; 
		 	  $( "#fulldata").load( "<?=base_url()?>hm/report_daterange/get_profit_month_project/"+branchid+'/'+prj_id+'/'+fromdate+'/'+todate);
		}
		 else
		 {
	 		 ...
	 		 $('#fulldata').delay(1).fadeIn(600);
    		  document.getElementById("fulldata").innerHTML='<img src="<?=base_url()?>media/images/loading.gif"  class="loadinggif">'; 
		 	  $( "#fulldata").load( "<?=base_url()?>hm/report/get_profit/"+branchid+'/'+prj_id);
		 }
	 }
	 else
	 {
		 prj_id=0;
		  $('#fulldata').delay(1).fadeIn(600);
    		  document.getElementById("fulldata").innerHTML='<img src="<?=base_url()?>media/images/loading.gif"  class="loadinggif">'; 				
			  if (fromdate!='' & todate!=''){
		 	  $( "#fulldata").load( "<?=base_url()?>hm/report_daterange/get_profit_all/"+branchid+'/'+prj_id+'/'+fromdate+'/'+todate);
			  }
			  else
			   $( "#fulldata").load( "<?=base_url()?>hm/report/get_profit_all/"+branchid+'/'+prj_id+'/'+month);
