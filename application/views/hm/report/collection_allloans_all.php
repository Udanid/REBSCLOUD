...
<div class="row">
   ...
   <div class="form-title">
     ...
     <input type="hidden" id="rptdate" value="<?=$todate?>">
       ...
       <table  class="table table-bordered table2excel" style="max-height:200px; overflow:scroll"><tr class="success">
			...
			$flag=true; 
				...
				if($raw->loan_code)
				{
					...
					if($raw->discounted_price!=$prevpayment[$raw->res_code]){
						...
						$lastpaydate=hm_get_last_payment_date($raw->res_code);
