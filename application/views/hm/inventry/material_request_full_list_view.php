...
function find_key_related_data(searchvalue){
   ...
   $('#metrequestlist').html('');
   $('#metrequestlist').load("<?=base_url()?>hm/hm_inventry/get_data_by_keyword/"+keyvalue+"/2");
 ...
 <div class="main-page">
  ...
  <div class="table">
      ...
      <div class="widget-shadow">
          ...
          <li role="presentation" class="active"><a href="<?=base_url()?>hm/hm_inventry/show_all_po_request" id="profile-tab" role="tab" aria-controls="profile" aria-expanded="false">Meterial Request List</a></li>
...
<script>
 ...
 /* $('input.value').keyup(function() {
      ...
      var searchval = jQuery('input.searchname').val();
      
      get_rows_by_keysearch(searchval);
  });

  function get_rows_by_keysearch(searchval){
    console.log(searchval)
    //ajax code for append data..
    $.ajax({
                cache: false,
                type: 'GET',
                url: '<?php echo base_url()?>hm/Hm_inventry/get_data_by_keyword',
