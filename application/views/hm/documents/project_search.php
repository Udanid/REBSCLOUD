...
function loadcurrent_project(id)
{
 ...
 if(id!=""){
					...
					$( "#projectpanel" ).load( "<?=base_url()?>hm/documents/project_docs/"+id );
 ...
 <form data-toggle="validator" method="post" action="<?=base_url()?>hm/documents/update_projectdocs" enctype="multipart/form-data">
