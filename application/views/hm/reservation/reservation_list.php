...
jQuery(document).ready(function() {
  $("#res_code").focus(function() {
	 ...
	 $("#res_code_set_shedu").focus(function() {
	  $("#res_code_set_shedu").chosen({
     allow_single_deselect : true
    });
	});
...
<div id="page-wrapper">
 <div class="main-page">
  ...
  <div class="table">
      ...
      <h3 class="title1">Agreement Creation</h3>
 ...
 -->      <!--   <a href="#home" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="false">Reservation List</a></li> 
      ...
      -->     <li role="presentation" class="active"><a href="#settlment" role="tab" id="settlment-tab" data-toggle="tab" aria-controls="settlment" aria-expanded="true">Agreement Creation</a></li> 
             <li role="presentation"><a href="#charges" role="tab" id="charges-tab" data-toggle="tab" aria-controls="charges" aria-expanded="true">Agreement Creation With Shedule</a></li> 
          ...
          <? $this->load->view("includes/flashmessage");?>
               ...
               <br>
                ...
                <div role="tabpanel" class="tab-pane fade active in " id="settlment" aria-labelledby="settlment-tab"> 
                    <p>	  
                  ...
                  <div role="tabpanel" class="tab-pane fade " id="charges" aria-labelledby="charges-tab"> 
                    <p>	  
                  <? $this->load->view("hm/reservation/advance_settlements_shedule"); ?>
                   </p> 
                </div>
            </div>
         </div>
