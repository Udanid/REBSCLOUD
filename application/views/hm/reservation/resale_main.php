...
function check_activeflag(id,code)
{
		...
		$.ajax({
            ...
            data: {table: 'hm_adresale', id: id,fieldname:'resale_code' },
            success: function(data) {
				...
				else
				{
					...
					$( "#popupform" ).load( "<?=base_url()?>hm/reservation/edit_resale/"+code+"/"+id );
				}
            }
        });
}
  ...
  <div class="table">
      ...
      <div class="widget-shadow">
          ...
          <a href="#home" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="false">Resale List</a></li> 
             ...
             <li role="presentation"    <? if($tab==''){?> class="active" <? }?>><a href="#profile" role="tab" id="profile-tab" data-toggle="tab" aria-controls="profile" aria-expanded="true">Resale</a></li> 
               ...
               <br>
                    ...
                    <div class=" widget-shadow bs-example" data-example-id="contextual-table" > 
                      ...
                      <? if($datalist){$c=0;
                        ...
                        <th scope="row"><?=$row->res_code?></th><td> <?=$row->project_name ?></td><td> <?=$row->lot_number ?>-<?=$row->plan_sqid ?></td> <td><?=$row->first_name ?> <?=$row->last_name ?></td> 
                ...
                <div role="tabpanel" class="tab-pane fade   <? if($tab==''){?> active in <? }?>" id="profile" aria-labelledby="profile-tab"> 
                    <p>	  
                  <? $this->load->view("hm/reservation/new_resale"); ?>
                   </p> 
                </div>
...
<form name="deletekeyform">  <input name="deletekey" id="deletekey" value="0" type="hidden">
            ...
            $("#complexConfirm").confirm({
                ...
                confirm: function(button) {
					...
					var code=1
                    window.location="<?=base_url()?>hm/reservation/delete_resale/"+document.deletekeyform.deletekey.value;
                },
			 ...
			 $("#complexConfirm_advdelete").confirm({
              ...
              $("#complexConfirm_confirm").confirm({
                ...
                confirm: function(button) {
                    ...
                    window.location="<?=base_url()?>hm/reservation/confirm_resale/"+document.deletekeyform.deletekey.value;
                },
                cancel: function(button) {
                    button.fadeOut(2000).fadeIn(2000);
                   // alert("You aborted the operation.");
