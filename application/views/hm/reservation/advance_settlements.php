...
function load_settlment(id)
{
 ...
 if(id!=""){
					...
					$( "#plandata_settlment" ).load( "<?=base_url()?>hm/reservation/get_settlments/"+id );
...
function load_amount(value)
{
 ...
 <form data-toggle="validator" method="post" action="<?=base_url()?>hm/reservation/add_settlement" enctype="multipart/form-data">
