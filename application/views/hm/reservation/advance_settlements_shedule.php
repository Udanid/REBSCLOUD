...
function load_settlment_shedu(id)
{
 ...
 if(id!=""){
					 ...
					 $('#plandata_settlment_shedu').delay(1).fadeIn(600);
	 			    document.getElementById("plandata_settlment").innerHTML='<img src="<?=base_url()?>media/images/loading.gif"  class="loadinggif">'; 
					$( "#plandata_settlment_shedu" ).load( "<?=base_url()?>hm/reservation/get_settlments_shedu/"+id );
...
function load_amount(value)
{
 ...
 <form data-toggle="validator" method="post" action="<?=base_url()?>hm/reservation/add_settlement_shedule" enctype="multipart/form-data">
...
<div class=" widget-shadow" data-example-id="basic-forms" style="min-height:400px;"> 
                          ...
                          <div class="col-sm-3 ">  <select class="form-control" placeholder="Qick Search.."   onchange="load_settlment_shedu(this.value)" id="res_code_set_shedu" name="res_code_set_shedu" >
                    ...
                    <? }?>
                          ...
                          <div id="plandata_settlment_shedu" style="display:none">
