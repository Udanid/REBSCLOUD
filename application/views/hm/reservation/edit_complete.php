...
<form data-toggle="validator" method="post" action="<?=base_url()?>hm/reservation/editdata_compete" enctype="multipart/form-data">
             ...
             <?    foreach($saletype as $row){?>
                    ...
                    <? }?></select>
                                     ...
                                     <label class="col-sm-3 control-label">Repayment Period</label>
										<div class="col-sm-3"><input type="number" step="1" name="period" value="<?=$period?>" id="period" class="form-control" onblur=" instalment_cal()" required="required"/>
                    ...
                    <? }?>
									...
									<label class="col-sm-3 control-label">Monthly Instalment</label>
										<div class="col-sm-3 has-feedback" id="paymentdateid"><input  type="text" class="form-control" id="instalments"    name="instalments" value="<?=number_format($instalment,2)?>"     data-error="" readonly="readonly"   required="required" >
