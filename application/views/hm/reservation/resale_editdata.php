...
function change_int(obj)
{
	...
	else
	{
		...
		document.getElementById("intrefund").value=0.00;
						...
						<form data-toggle="validator" method="post" action="<?=base_url()?>hm/reservation/editdata_resale" enctype="multipart/form-data">
         ...
         <div class="form-title">
							...
							<div class="form-body  form-horizontal" >
									...
									<label class="col-sm-3 control-label">Non Refundable Amount</label>
										<div class="col-sm-3 has-feedback" id="paymentdateid"><input  type="text" class="form-control" id="non_refund"  value="<?=number_format($resdata->non_refund,2) ?>"   name="non_refund"     data-error=""   required="required" >
										<span class="glyphicon form-control-feedback" aria-hidden="true"></span>
										<span class="help-block with-errors" ></span></div>
                                        <label class="col-sm-3 control-label">Refund Amount</label>
										<div class="col-sm-3 has-feedback" ><input  type="text" class="form-control" id="repay_total"  value="<?=$relsaledata->repay_total ?>"   name="repay_total"     data-error=""   required="required" >
										<span class="glyphicon form-control-feedback" aria-hidden="true"></span>
										<span class="help-block with-errors" ></span></div>
