...
function load_charges(id)
{
 ...
 if(id!=""){
					...
					$( "#plandata_charges" ).load( "<?=base_url()?>hm/reservation/get_customer_list/"+id );
          ...
          <? $this->load->view("includes/flashmessage");?>
               ...
               <br>
                  ...
                  <div role="tabpanel" class="tab-pane fade active in " id="charges" aria-labelledby="charges-tab"> 
                    <p>	  
                  <form data-toggle="validator" method="post" action="<?=base_url()?>hm/reservation/update_customer_data" enctype="multipart/form-data">
