...
function loadcurrent_officer(id)
{
 ...
 if(id!=""){
					...
					$( "#officerlist" ).load( "<?=base_url()?>hm/sales/get_po/"+id );
      ...
      <div class="widget-shadow">
          ...
          <? $this->load->view("includes/flashmessage");?>
                ...
                <div role="tabpanel" class="tab-pane fade active in " id="profile" aria-labelledby="profile-tab"> 
                  ...
                  <form data-toggle="validator" method="post" action="<?=base_url()?>hm/sales/edit_po" enctype="multipart/form-data">
 
                   <div class="form-body form-horizontal">
                      <? if($prjlist){?>
                          <div class="form-group">
                          <div class="col-sm-3 ">  <select class="form-control" placeholder="Qick Search.." onChange="loadcurrent_officer(this.value)"    id="prj_id" name="prj_id"  required>
