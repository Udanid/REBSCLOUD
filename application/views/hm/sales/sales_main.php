...
<div id="page-wrapper">
 <div class="main-page">
  ...
  <div class="table">
      ...
      <h3 class="title1">Sales Forecast</h3>
     			
      <div class="widget-shadow">
          <ul id="myTabs" class="nav nav-tabs" role="tablist"> 
           <li role="presentation" class="active"><a href="#profile" role="tab" id="profile-tab" data-toggle="tab" aria-controls="profile" aria-expanded="true">Sales Target</a></li> 
           <li role="presentation" ><a href="#printed" role="tab" id="printed-tab" data-toggle="tab" aria-controls="printed" aria-expanded="true">Sales Forecast</a></li> 
