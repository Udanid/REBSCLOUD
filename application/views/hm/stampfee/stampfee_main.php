	 ...
	 {$('#deedlist').delay(1).fadeOut(600);
		 var prj_id= document.getElementById("prj_id").value
    	  ...
    	  document.getElementById("fulldata").innerHTML='<img src="<?=base_url()?>media/images/loading.gif"  class="loadinggif">'; 
		   $( "#fulldata").load( "<?=base_url()?>hm/stampfee/get_fulldata/"+id+"/"+prj_id );
	 }
}
...
<div id="page-wrapper">
 <div class="main-page">
  ...
  <div class="table">
      ...
      <h3 class="title1">Stamp Fee Requset</h3>
                ...
                <div role="tabpanel" class="tab-pane fade  <? if($this->session->userdata('usertype')=='Legal Officer'){?>active in<? }?> " id="list" aria-labelledby="list-tab"> 
                    <p>	
                      ...
                      <div class="form-title">
                            ...
                            <br> <form data-toggle="validator" method="post" action="<?=base_url()?>hm/stampfee/approved_request" enctype="multipart/form-data">
  
                   <table class="table"> <thead> <tr> <th>ID</th> <th>Customer Name</th> <th>Project Details </th> 
                   <th>Stamp Fee</th><th>Request Amount</th> <th>Request Date</th><th>Status</th><th></th><th>Select To Approve</th></tr> </thead>
                 ...
                 <div role="tabpanel" class="tab-pane fade  " id="listpaid" aria-labelledby="listpaid-tab"> 
                   ...
                   <table class="table"> <thead> <tr> <th>ID</th> <th>Customer Name</th> <th>Project Details </th> 
                   <th>Stamp Fee</th><th>Request Amount</th> <th>Request Date</th> <th>Request By</th><th>Status</th><th>Voucher/Cheque No</th><th> Approve By</th></tr> </thead>
