...
function loadcurrent_block(id)
{
 if(id!=""){
	 document.getElementById("fulldata").innerHTML='';
					...
					$( "#blocklist" ).load( "<?=base_url()?>hm/deedtransfer/get_blocklist/"+id );
	 ...
	 {$('#deedlist').delay(1).fadeOut(600);
		 var prj_id= document.getElementById("prj_id").value
    	  ...
    	  document.getElementById("fulldata").innerHTML='<img src="<?=base_url()?>media/images/loading.gif"  class="loadinggif">'; 
		   $( "#fulldata").load( "<?=base_url()?>hm/deedtransfer/get_fulldata/"+id+"/"+prj_id );
	 }
}
function load_fulldetails_popup(prj_id,lot_id)
{
		...
		// var prj_id= document.getElementById("prj_id").value
					  ...
					  $( "#popupform").load( "<?=base_url()?>hm/deedtransfer/get_fulldata_popup/"+lot_id+"/"+prj_id );
  ...
  <div class="table">
      ...
      <div class="widget-shadow">
          <ul id="myTabs" class="nav nav-tabs" role="tablist"> 
           ...
           <li role="presentation" ><a href="#profile" role="tab" id="profile-tab" data-toggle="tab" aria-controls="profile" aria-expanded="true">Search Deed</a></li> 
