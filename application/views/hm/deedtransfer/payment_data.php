    ...
    $( "#deed_date" ).datepicker({dateFormat: 'yy-mm-dd'});
	 $( "#landr_date" ).datepicker({dateFormat: 'yy-mm-dd'});
	  $( "#rcv_date" ).datepicker({dateFormat: 'yy-mm-dd'});
	   $( "#handover_date" ).datepicker({dateFormat: 'yy-mm-dd'});
   ...
   <form data-toggle="validator" method="post" action="<?=base_url()?>hm/deedtransfer/update_deeddata" enctype="multipart/form-data">
                       ...
                       <input type="hidden" name="id" id="id" value="<?=$deed_data->id?>">
                         ...
                         <div class="form-group "><label class="col-sm-3 control-label">Attest By</label>
										<div class="col-sm-8   has-feedback "><input type="text" class="form-control"   id="attest_by"  value="<?=$deed_data->attest_by?>" name="attest_by"   data-error=" Please fill this Value"  placeholder="Attest By"   required>
                                       <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
										<span class="help-block with-errors" ></span>
                                       </div></div>
										...
										<span class="help-block with-errors" ></span>
                                         ...
                                         <label class="col-sm-3 control-label" >Customer Handover Date</label>
                                        <div class="col-sm-3  has-feedback "><input type="text" class="form-control" id="handover_date"  value="<?=$deed_data->handover_date?>"  name="handover_date"  data-error=""    placeholder="Customer Handover Date"   >
										<span class="glyphicon form-control-feedback" aria-hidden="true"></span>
										<span class="help-block with-errors" ></span>
                                        </div></div>
                                        <div class="clearfix"> </div>
                                       <? if($this->session->userdata('userid')==$deed_data->legal_officer){?>
