...
<div id="page-wrapper">
 <div class="main-page">
  ...
  <div class="table">
      ...
      <h3 class="title1">Other Charges</h3>
     			
      <div class="widget-shadow">
          <ul id="myTabs" class="nav nav-tabs" role="tablist"> 
           <li role="presentation" class="active"><a href="#profile" role="tab" id="profile-tab" data-toggle="tab" aria-controls="profile" aria-expanded="true">Other Charges</a></li> 
          ...
          <? $this->load->view("includes/flashmessage");?>
                ...
                <div role="tabpanel" class="tab-pane fade active in " id="profile" aria-labelledby="profile-tab"> 
                    <p>	  
                  <? $this->load->view("hm/cashier/charge_list"); ?>
                   </p> 
                </div>
            ...
            $("#complexConfirm").confirm({
			 ...
			 $("#complexConfirm_advdelete").confirm({
                ...
                confirm: function(button) {
                    button.fadeOut(2000).fadeIn(2000);
					var code=1
                    window.location="<?=base_url()?>hm/cashier/delete_charge/"+document.deletekeyform.deletekey.value;
                },
                cancel: function(button) {
                    button.fadeOut(2000).fadeIn(2000);
                   // alert("You aborted the operation.");
