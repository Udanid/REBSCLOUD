...
function  calculate_tot(val)
{
	...
	document.getElementById('unselable_area').value=unselabletot.toFixed(2);
		...
		document.getElementById('other_resP').value=road_waysP.toFixed(2);
		document.getElementById('open_spaceP').value=road_waysP.toFixed(2);
		//alert(seleble);
  ...
  <div class="table">
      ...
      <div class="widget-shadow">
          <ul id="myTabs" class="nav nav-tabs" role="tablist">
           ...
           <? if(check_access('add_project')){?> <li role="presentation" <? if($tab==''){?> class="active" <? }?>><a href="#profile" role="tab" id="profile-tab" data-toggle="tab" aria-controls="profile" aria-expanded="true">Add New Project</a></li>
              ...
              <? if($this->session->flashdata('msg')){?>
               ...
               <div class="alert alert-danger" role="alert">
                    ...
                    <div class=" widget-shadow bs-example" data-example-id="contextual-table" >
                        ...
                        <table class="table"> <thead> <tr> <th>Project ID</th> <th>Project Name</th>  <th>Property Name</th><th>Project Officer </th> <th>Status</th><th></th></tr> </thead>
                      <? if($datalist){$c=0;
                        ...
                        <td align="right"><div id="checherflag">
                           ...
                           <a  href="<?=base_url()?>hm/feasibility/showall/<?=$this->encryption->encode($row->prj_id)?>" title="Feacibility Data"  ><i class="fa fa-list nav_icon icon_green"></i></a>
               ...
               <div class="alert alert-danger" role="alert">
                       ...
                       <form data-toggle="validator"  method="post" action="<?=base_url()?>hm/project/add" enctype="multipart/form-data">
            ...
            $("#complexConfirm").confirm({
              ...
              $("#complexConfirm_confirm").confirm({
                ...
                confirm: function(button) {
                    ...
                    window.location="<?=base_url()?>hm/project/confirm/"+document.deletekeyform.deletekey.value;
                },
                cancel: function(button) {
                    button.fadeOut(2000).fadeIn(2000);
                   // alert("You aborted the operation.");
