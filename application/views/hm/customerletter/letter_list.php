...
<div class=" widget-shadow" data-example-id="basic-forms" style="min-height:400px;"> 
    ...
    <div class="form-title">
		<h4><?=$type_name?>
					 ...
					 <table class="table"> <thead> <tr> <th>Customer Name</th> <th>Reservation Code</th> <th>Loan Number</th> <th>Project and Lot</th>  <th>Letter Create Date </th> <th>Amount</th><th></th></tr> </thead>
                      <? if($datalist){$c=0;
                        ...
                        <a  href="javascript:load_printscrean1('<?=$row->id?>','<?=$type_id?>')" title="Print"><i class="fa fa-print nav_icon"></i></a>
                               </div></td>
                         </tr> 
