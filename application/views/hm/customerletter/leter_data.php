...
<div id="page-wrapper">
 <div class="main-page">
  ...
  <div class="table">
      ...
      <h3 class="title1">Customer Letters</h3>
     			
      <div class="widget-shadow">
          <ul id="myTabs" class="nav nav-tabs" role="tablist"> 
           <li role="presentation" class="active"><a href="#profile" role="tab" id="profile-tab" data-toggle="tab" aria-controls="profile" aria-expanded="true">Letter List</a></li> 
           <li role="presentation" ><a href="#printed" role="tab" id="printed-tab" data-toggle="tab" aria-controls="printed" aria-expanded="true">Printed List</a></li> 
          ...
          <? $this->load->view("includes/flashmessage");?>
                ...
                <div role="tabpanel" class="tab-pane fade active in " id="profile" aria-labelledby="profile-tab"> 
                    <p>	  
                  <? $this->load->view("hm/customerletter/letter_search"); ?>
                   </p> 
                </div>
                <div role="tabpanel" class="tab-pane fade " id="printed" aria-labelledby="printed-tab"> 
                    <p>	  
                  <?  $this->load->view("hm/customerletter/printed_letter"); ?>
                   </p> 
                </div>
            </div>
         </div>
