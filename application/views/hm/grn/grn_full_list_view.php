...
<head>
    ...
    $(document).ready(function(){
		...
		$("#searchkey").keyup(function(event) { 
		   ...
		   $('#grntotallist').html('');
		   console.log("<?=base_url()?>hm/hm_grn/get_data_by_keyword/"+keyvalue+"/2")
		   $('#grntotallist').load("<?=base_url()?>hm/hm_grn/get_data_by_keyword/"+keyvalue+"/2");
		...
		<div class="table">
			...
			<div class="widget-shadow">
				<ul id="myTabs" class="nav nav-tabs" role="tablist">
		          ...
		          <li role="presentation" class="active"><a href="<?=base_url()?>hm/hm_grn/grn_full_list" id="profile-tab" role="tab" aria-controls="profile" aria-expanded="false">GRN List</a></li>
				</ul>
                          ...
                          <table class="table" id="" width="90%">
                          	<thead>
                          	  <tr>
                          		...
                          		<th>confirmed Date & confirmed By</th>
                          		<th>Status</th>
                          		<th></th>
                          	  </tr>
                          	</thead>
                          	<tbody id="grntotallist">
                          		<?
                          		$i2=1;
