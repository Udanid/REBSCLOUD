 ...
 <div class="main-page">
  ...
  <div class="table">
      ...
      <div class="widget-shadow">
          ...
          <a href="#block" id="block-tab" role="tab" data-toggle="tab" aria-controls="block" aria-expanded="false">Add Block Out Plan</a></li> 
        </ul>	
           <div id="myTabContent" class="tab-content scrollbar1" style="padding:5px;">
             ...
             <div role="tabpanel" class="tab-pane fade " id="block" aria-labelledby="block-tab" >
               <br>
               <? $this->load->view("hm/lotdata/newlotplan");?>
               </div>
