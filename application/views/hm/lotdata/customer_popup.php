   ...
   <tbody style="font-size:12px">
    <th>Customer Name</th><td><?=$cusdata->title?> <?=$cusdata->first_name?> <?=$cusdata->last_name?></td></tr>
       ...
       <tr> <th>Address</th><td><?=$cusdata->address1?>, <?=$cusdata->address2?>, <?=$cusdata->address3?></td></tr>
		...
		<div id="nicimg"><!-- update by nadee ticket 1064 -->
			<? $img_val=0;
			...
			<?}?>
				...
				<?}?>
				<? if(($cusdata->id_copy_front!="" && file_exists("./uploads/customer_ids/".$cusdata->id_copy_front)) || ($cusdata->id_copy_back!="" && file_exists("./uploads/customer_ids/".$cusdata->id_copy_back)))
				{
					?>
