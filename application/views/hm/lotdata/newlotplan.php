...
if(count>=1)
{
	...
	code=code+'</div></td>';
	code=code+' <td> <div class="form-group has-feedback" ><input type="number" step="0.01"  class="form-control" name="price'+i+'" id="price'+i+'" onblur="calculate_salestot('+i+')"  value=""required><span class="glyphicon form-control-feedback" aria-hidden="true"></span>';
	code=code+'	<span class="help-block with-errors" ></span>';
	code=code+'</div></td>'
...
function loadcurrent_block(id)
{
 ...
 if(id!=""){
	 ...
	 $.ajax({
            ...
            data: {table: 'hm_prjacblockplane', id: id,fieldname:'prj_id' },
            success: function(data) {
				...
				else
				{
					...
					$( "#lotinfomation" ).load( "<?=base_url()?>hm/lotdata/pending_lots/"+id );
						$( "#laodfinancost" ).load( "<?=base_url()?>hm/lotdata/thisfinance_cost/"+id );
				}
            }
        });
 ...
 <form data-toggle="validator" method="post" action="<?=base_url()?>hm/lotdata/add" enctype="multipart/form-data">
                          ...
                          <div id="plandata" style="display:none">
							...
							<div class="form-body form-horizontal" >
									...
									<label class="col-sm-3 control-label">Drawn Date</label>
										<div class="col-sm-3 has-feedback"><input  type="text" class="form-control" id="drown_date"    name="drown_date"     data-error=""   >
										<span class="glyphicon form-control-feedback" aria-hidden="true"></span>
										<span class="help-block with-errors" ></span></div>
									</div>
                                    ...
                                    <div class="col-sm-3 has-feedback"><div id="laodfinancost"><input  type="number" step="0.01" class="form-control" id="finance_cost"    name="finance_cost"     data-error=""   ></div>
										<span class="glyphicon form-control-feedback" aria-hidden="true"></span>
										<span class="help-block with-errors" ></span></div>
