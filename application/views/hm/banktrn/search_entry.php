...
function load_excel(id)
{
 ...
 <h4>Bank Transfer List<span  style="float:right; color:#FFF" ><a href="javascript:closepo()"><i class="fa fa-times-circle "></i></a></span>
  <span style="float:right"> <a href="javascript:load_printscrean1('<?=$entry_id?>')"> <i class="fa fa-print nav_icon"></i></a>
       <!--    <a href="javascript:load_excel('< ?=$entry_id?>')"> <i class="fa fa-file-excel-o nav_icon"></i></a>
-->
</span> 
 </h4>
<br />
