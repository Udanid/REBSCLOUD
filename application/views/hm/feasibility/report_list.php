           ...
           <div id="myTabContent" class="tab-content scrollbar1" style="padding:5px;">
               ...
               <br>
                    ...
                    <div class=" widget-shadow bs-example" data-example-id="contextual-table" > 
                        ...
                        <table class="table"> <thead> <tr> <th>Project ID</th> <th>Project Name</th>  <th>Last Genarate</th><th>Project Officer </th> <th>Status</th><th></th></tr> </thead>
                      <? if($datalist){$c=0;
                        ...
                        <td align="right"><div id="checherflag">
                           ...
                           <a  href="<?=base_url()?>hm/feasibility/evaluation_report/<?=$this->encryption->encode($row->prj_id)?>" title="Evaluation Report"  ><i class="fa fa-bar-chart nav_icon icon_green"></i></a>
