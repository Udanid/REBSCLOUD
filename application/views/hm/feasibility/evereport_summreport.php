   ...
   <div class="col-md-6 validation-grids  widget-shadow" data-example-id="basic-forms">
    ...
    <div class="col-md-8 validation-grids validation-grids-right widget-shadow" data-example-id="basic-forms">
        ...
        <table class="table table-bordered" >
          ...
          <tr  class="active"><td ><strong>Total OR Sales</strong></td><td></td><td align="right"><?=number_format($totalsales,2)?></td><td></td></tr>
    ...
    $totalunitboq = $totalunitboq->totalconstruction;
		...
		$totcost_with_finance=$totdpcost-$marketing_commision+$vat+$yearvalue[1]['salestax']+$nbt+$totalunitboq;?>
          ...
          <tr><td>Project Cost</td><td></td><td align="right"><?=number_format($projectcost,2)?></td></tr>
           <tr><td>Development Cost</td><td></td><td align="right"><?=number_format($dpcost_only,2)?></td></tr>
           <tr><td>Construction Cost</td><td></td><td align="right"><?=number_format($totalunitboq,2)?></td></tr>
            <tr><td>Vat</td><td></td><td align="right"><?=number_format($vat,2)?></td></tr>
           <tr><td>LA Tax</td><td></td><td align="right"><?=number_format($yearvalue[1]['salestax'],2)?></td></tr>
            <tr><td>NBT</td><td></td><td align="right"><?=number_format($nbt,2)?></td></tr>
