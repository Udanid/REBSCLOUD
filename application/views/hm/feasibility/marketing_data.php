...
<form data-toggle="validator"  method="post" action="<?=base_url()?>hm/feasibility/add_marketdata" enctype="multipart/form-data">
...
<div class="col-md-6 validation-grids widget-shadow" data-example-id="basic-forms"> 
   ...
   <div class="form-body"> 
	...
	<div class="form-body  form-horizontal"> 
      ...
      <div class="form-group" style="float:left"><label class="col-sm-3 control-label">Land Bank</label>
										...
										<span class="glyphicon form-control-feedback" aria-hidden="true"></span>
										<span class="help-block with-errors" ></span></div></div>
                                         <div class="form-group" style="float:left"><label class="col-sm-3 control-label">Branch Rate</label>
