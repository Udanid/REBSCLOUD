...
<table class="table gridexample" id="boqtbls" > <thead id="thheader"> <tr >
                          ...
                          <? if($matdata[$value->id]){
                            $v=1;
                            foreach ($matdata[$value->id] as $matkey => $matvalue) {
                             ?>
                          ...
                          foreach($sub_cat_data_boq as $row){
                            ...
                            <? if($datalist[$row->boqsubcat_id]){ $n=0;
                              ...
                              <tr class="edrows<?=$c?>">
                                ...
                                <input type="hidden" name="prj_id" value="<?=$value->prj_id?>">
                                  ...
                                  <th></th>
                                   ...
                                   <? if($matdata[$value->id]){
                                     ...
                                     <th>
                                       ...
                                       <input type="text" style="width:50px; padding:3px;" class="form-control" name="<?=$value->id?><?=$matvalue->mat_id?>amt" value="<?=$matvalue->value?>">
                                     </th>
                                     <?
                                    }
                                  }else{
