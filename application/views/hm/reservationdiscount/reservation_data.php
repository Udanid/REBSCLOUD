...
function repay_cal(obj)
{
	...
	/*if(obj<=60 & obj>0)
	{ 
		 newdicountedprice=sellingprice-(parseFloat(sellingprice)*parseFloat(newdiscount)/100);
	}
	else
	{*/
             ...
             <input type="hidden" class="form-control"   id="paid_amount"  value="<?=$resdata->down_payment?>" name="paid_amount"  readonly="readonly" required>
							...
							<div class="form-body  form-horizontal" >
                               <div class="form-group  "><label class="col-sm-3 control-label">Block Value</label>
										...
										<div class="col-sm-3" id="subtaskdata"><input type="text" class="form-control" id="block_cost"  name="block_cost"  data-error=""   readonly="readonly" value="<?=number_format($lotdata->costof_sale) ?>" required>
										</div></div>
                                    <div class="form-group  "><label class="col-sm-3 control-label">Current Selling Price</label>
										...
										<div class="col-sm-3" id="subtaskdata"><input type="text" class="form-control" id="cur_discount"  name="cur_discount"  data-error=""   readonly="readonly" value="<?=number_format($resdata->discount) ?>" required>
										</div></div>
										...
										<div class="col-sm-3" id="subtaskdata"><input type="text" class="form-control" id="pay_tot"  name="pay_tot"  data-error=""   readonly="readonly" value="<?=number_format($resdata->down_payment) ?>" required>
										</div></div>
                                     <div class="form-group  ">
                                         <label class="col-sm-3 control-label" >New Discount</label>
										<div class="col-sm-3" id="subtaskdata"><input type="number" step="0.01" class="form-control" name="new_discount" id="new_discount"value=""  onblur="repay_cal(this.value)"  >
