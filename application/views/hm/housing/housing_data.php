...
function loadcurrent_block(id)
{
	if(id!=""){
		...
		$( "#blocklist" ).load( "<?=base_url()?>hm/hm_housing/get_blocklist/"+id );
 	}
 	else
 	{
...
function load_fulldetails(val){
	$('#tasklist').html('');
	$('#designlist').delay(1).fadeIn(600);
	document.getElementById("designlist").innerHTML='<img src="<?=base_url()?>media/images/loading.gif"  class="loadinggif">'; 
	$( "#designlist" ).load( "<?=base_url()?>hm/hm_housing/get_designlist/"+val);
}

function load_tasklist(id){
	...
	$( "#tasklist" ).load( "<?=base_url()?>hm/hm_housing/get_tasklist/"+id+"/"+lot_id);	
}
...
<div id="page-wrapper">
 <div class="main-page">
  <div class="table">
      <h3 class="title1">Housing Details</h3>

      <div class="widget-shadow">
          <ul id="myTabs" class="nav nav-tabs" role="tablist">
            <li role="presentation"    <? if($tab==''){?> class="active" <? }?>><a href="#profile" role="tab" id="profile-tab" data-toggle="tab" aria-controls="profile" aria-expanded="true">Add New Housing</a></li>
          ...
          <a href="#home" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="false">Housing List</a></li>
           ...
           <div id="myTabContent" class="tab-content scrollbar1" style="padding:5px;">
              ...
              <?php $this->load->view("includes/flashmessage");?>
                ...
                <?php $this->load->view("includes/flashmessage");?>
                    <?
                    echo form_open('hm/hm_housing/add','name="myform" id="myform" onsubmit="return myValidator()"');
                    ?>
                        <div class="row">
                                        ...
                                        <table class="table" >
                                            <tr>
                                                <td>
                                                    <div class="form-group">
                                                        <div class="col-sm-3">
                                                            <select class="form-control" name="project" id="project" onchange="loadcurrent_block(this.value)">
                                                                <option value=""></option>
                                                                <? if($prjlist){foreach($prjlist as $raw){ ?>
                                                                    <option value="<?=$raw->prj_id?>"><?=$raw->project_name?></option>
                                                                <? }}?>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-sm-3 " id="blocklist">   
                                                        </div>
                                                        
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="col-sm-3 " id="designlist">   
                                                        </div>
                                             ...
                                             <tr>
                                             	<td>
                                                	<div class="form-group">
                                                        <div class="col-sm-12" id="tasklist">   
                                                        </div>
