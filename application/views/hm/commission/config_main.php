	 ...
	 {$('#deedlist').delay(1).fadeOut(600);
		 var year= document.getElementById("year_cat").value
    	  ...
    	  document.getElementById("catogory_list").innerHTML='<img src="<?=base_url()?>media/images/loading.gif"  class="loadinggif">'; 
		   $( "#catogory_list").load( "<?=base_url()?>hm/commission/get_categodtylist/"+id+"/"+year );
	 }
}
          ...
          <? $this->load->view("includes/flashmessage");?>
                ...
                <div role="tabpanel" class="tab-pane fade " id="profile" aria-labelledby="profile-tab"> 
                    <p>	
                      ...
                      <form data-toggle="validator" method="post" action="<?=base_url()?>hm/commission/add_range" enctype="multipart/form-data">
                ...
                <div role="tabpanel" class="tab-pane fade  active in " id="list" aria-labelledby="list-tab"> 
                    <p>	
                        <div class="row">
						<div class=" widget-shadow" data-example-id="basic-forms"> 
                      <form data-toggle="validator" method="post" action="<?=base_url()?>hm/commission/add_rate" enctype="multipart/form-data">
...
<form name="deletekeyform">  <input name="deletekey" id="deletekey" value="0" type="hidden">
            ...
            $("#complexConfirm").confirm({
                ...
                confirm: function(button) {
					...
					var code=1
                    window.location="<?=base_url()?>hm/commission/delete_range/"+document.deletekeyform.deletekey.value;
                },
