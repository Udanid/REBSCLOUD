...
function load_commisssiondata()
{
	...
	//	 alert( "<?=base_url()?>hm/commission/get_commisiondata/"+id+"/"+year)
    	  document.getElementById("com_data").innerHTML='<img src="<?=base_url()?>media/images/loading.gif"  class="loadinggif">'; 
		   $( "#com_data").load( "<?=base_url()?>hm/commission/get_commisiondata/"+id+"/"+year );
	 }
}
          ...
          <? $this->load->view("includes/flashmessage");?>
                ...
                <div role="tabpanel" class="tab-pane fade active in" id="profile" aria-labelledby="profile-tab"> 
                    <p>	
                      ...
                      <form data-toggle="validator" method="post" action="<?=base_url()?>hm/commission/generate_commission" enctype="multipart/form-data">
...
<form name="deletekeyform">  <input name="deletekey" id="deletekey" value="0" type="hidden">
            ...
            $("#complexConfirm").confirm({
                ...
                confirm: function(button) {
					...
					var code=1
                    window.location="<?=base_url()?>hm/commission/delete_commission/"+document.deletekeyform.deletekey.value;
                },
			 ...
			 $("#complexConfirm_advdelete").confirm({
              ...
              $("#complexConfirm_confirm").confirm({
                ...
                confirm: function(button) {
                    ...
                    window.location="<?=base_url()?>hm/commission/confirm_commission/"+document.deletekeyform.deletekey.value;
                },
                cancel: function(button) {
                    button.fadeOut(2000).fadeIn(2000);
                   // alert("You aborted the operation.");
