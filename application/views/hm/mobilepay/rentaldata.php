            ...
            <? $this->load->view("includes/flashmessage");?>
                ...
                <div role="tabpanel" class="tab-pane fade <? if(!$this->session->flashdata('tab')){?>active in<? }?>" id="profile" aria-labelledby="profile-tab"> 
                    ...
                    <option value="<?=$loan_code?>" ><?=$loan_code?></option>
										...
										<div class="col-sm-3 has-feedback" id="paymentdateid"><input  type="text" class="form-control" id="paydate"    name="paydate" value="<?=$paydate?>"    data-error="" required="required"  onChange="load_detailsagain()" >
