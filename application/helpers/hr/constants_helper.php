...
if(!function_exists('bloodGroup')){
  function bloodGroup(){
    $blood_group = array("A RhD positive (A+)",
                         "A RhD negative (A-)",
                         "B RhD positive (B+)",
                         "B RhD negative (B-)",
                         "O RhD positive (O+)",
...
if(!function_exists('title')){
  function title(){
    $emp_title = array("Mr", "Mrs", "Ms", "Miss", "Dr.", "Prof.", "Rev", "Father", "Sister");
    return $emp_title;
  }
}
...
if(!function_exists('province')){
  function province(){
    $emp_province = array("Central", "Eastern", "North Central", "Northern", "North Western", "Sabaragamuwa", "Southern", "Uva", "Western");
    return $emp_province;
  }
}
?>
