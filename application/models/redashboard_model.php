...
class Redashboard_model extends CI_Model {
	...
	function get_profittransfer_data_period($prj_id,$fromdate,$todate) { //get all stock
		$this->db->select('re_resevation.*,cm_customerms.id_number,cm_customerms.mobile,cm_customerms.first_name,cm_customerms.last_name,re_prjaclotdata.lot_number,re_prjaclotdata.plan_sqid');
