...
<div class="sticky-header header-section ">
			<div class="header-left">
				...
				<div class="search-box">
					<form class="input">
                    <select class="sb-search-input input__field--madoka" placeholder="Qick Search.."  id="input-31" name="input-31"   onChange="loadsearch(this.value)">
			...
			<div class="header-right">
				<div class="profile_details_left"><!--notifications of menu start -->
                    ...
                    <li class="dropdown head-dpdn">
                          ...
                          <li class="dropdown head-dpdn">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-bell"></i><span class="badge blue"><?=count($notification)?></span></a>
							<ul class="dropdown-menu drp-mnu">
                            <li>
									<div class="notification_header">
										<h3>You have <?=count($notification)+$letternotifi?> <?=$noticename?> to confirm</h3>
									</div>
								</li>
                            <? for($i=0; $i<count($notification); $i++){?>
								
								<li><a href="javascript:loadpoform('<?=$notification[$i]['id']?>')">
									
								   <div class="notification_desc">
									<p><?=$notification[$i]['id']?> &nbsp;<?=$notification[$i]['name']?></p>
