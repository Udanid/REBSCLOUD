...
<body class="cbp-spmenu-push">
                       ...
                       <? if (check_mainmenu('Cashier')){?>  <li>
							...
							<ul class="nav nav-second-level collapse">
                             <li>
								...
								<li>
									<a href="<?=base_url()?>accounts/mobilepay/">Mobile App  Payments</a>
								</li>
                      ...
                      <? if (check_mainmenu('Receipts')){?>   <li>
                         ...
                         <? if (check_mainmenu('Receipts')){?>   <li>
							...
							<ul class="nav nav-second-level collapse">
								...
								<li>
									<a href="<?=base_url()?>accounts/cashadvance/settlement/">External Settlements</a>
								</li>
                         ...
                         <? if (check_mainmenu('Receipts')){?>   <li>
							<a href="#"><i class="fa fa-file-text-o nav_icon"></i>Invoice<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level collapse">
								<li>
									<a href="<?=base_url()?>accounts/invoice/">New invoice</a>
								</li>
                                <li>
									<a href="<?=base_url()?>accounts/invoice/add_payment">Invocie Payments</a>
								</li>
                                <li>
									<a href="<?=base_url()?>accounts/invoice/reports">Reports</a>
								</li>
 ...
 <? if (check_submenu('Fuel Allowance Payment')){ ?>  <li>
                  <a href="<?php echo base_url();?>hr/employee/fuel_allowance_payment">Fuel Allowance Payment</a>
                </li><? }?>
                        ...
                        <? if (check_mainmenu('Fixed Asset')){?> 	<li class="">
							...
							<ul class="nav nav-second-level collapse">
								...
								<li>
									<a href="<?=base_url()?>accounts/Fixedasset/disposal">Fixed Assets Disposal</a>
								</li>
								<li>
									<a href="<?=base_url()?>accounts/Fixedasset/transfers">Transfer Fixed Asset</a>
								</li>
								<li>
									<a href="<?=base_url()?>accounts/Fixedasset/register">Fixed Asset Register</a>
								</li>
						...
						<? if (check_mainmenu('Payments')){?>
							<li class="">
								...
								<ul class="nav nav-second-level collapse">
									...
									<li>
										<a href="<?=base_url()?>accounts/loan/report">External Loan Report</a>
									</li>
									<li>
										<a href="<?=base_url()?>accounts/Institute">New Institute</a>
									</li>
                      ...
                      <? if (check_mainmenu('Journal')){?>   <li>
						...
						<? if (check_mainmenu('ACC Reports')){?> <li>
                            ...
                            <ul class="nav nav-second-level collapse">
                                ...
                                <li>
									<a href="<?=base_url()?>accounts/report/reconciliationReport">Bank Reconciliation</a>
								</li>
                                </ul>
						</li><? }?>
					</ul>
